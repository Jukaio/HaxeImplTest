...
@:noCopy @:noEquals @:uextern @:ustruct extern class FMovieSceneEditorData {
  ...
  /**
    Deprecated
  **/
  @:deprecated @:uproperty public var MarkedFrames_DEPRECATED : unreal.TSet<unreal.FFrameNumber>;
  ...
  **/
  @:uproperty public var PinnedNodes : unreal.TArray<unreal.FString>;
  
  /**
    Map of node path -> expansion state.
  **/
  @:uproperty public var ExpansionStates : unreal.TMap<unreal.FString, unreal.moviescene.FMovieSceneExpansionState>;
