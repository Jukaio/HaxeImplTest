...
@:uextern @:uclass extern class UAssetManagerSettings extends unreal.developersettings.UDeveloperSettings {
  
  /**
    The metadata tags to be transferred to the Asset Registry.
  **/
  @:uproperty public var MetaDataTagsForAssetRegistry : unreal.TSet<unreal.FName>;
