...
@:uextern @:uclass extern class UGeometryCacheComponent extends unreal.UMeshComponent {
  ...
  **/
  @:uproperty private var MotionVectorScale : unreal.Float32;
  ...
  **/
  @:ufunction(BlueprintCallable) @:thisConst @:final public function IsExtrapolatingFrames() : Bool;
  
  /**
    Set whether this GeometryCache is extrapolating frames.
  **/
  @:ufunction(BlueprintCallable) @:final public function SetExtrapolateFrames(bNewExtrapolating : Bool) : Void;
  ...
  **/
  @:ufunction(BlueprintCallable) @:thisConst @:final public function GetMotionVectorScale() : unreal.Float32;
  
  /**
    Set new motion vector scale.
  **/
  @:ufunction(BlueprintCallable) @:final public function SetMotionVectorScale(NewMotionVectorScale : unreal.Float32) : Void;
