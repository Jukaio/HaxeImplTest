...
@:uextern @:uclass extern class USkinnedMeshComponent extends unreal.UMeshComponent implements unreal.ILODSyncInterface {
  @:uproperty private var CachedWorldToLocalTransform : unreal.FMatrix;
  
  /**
    Bounds cached, so they're computed just once.
  **/
  @:uproperty private var CachedWorldSpaceBounds : unreal.FBoxSphereBounds;
  ...
  **/
  ...
  @:uproperty public var VertexOffsetUsage : unreal.TArray<unreal.FVertexOffsetUsage>;
  ...
  **/
  @:uproperty public var SkinCacheUsage : unreal.TArray<unreal.ESkinCacheUsage>;
  ...
  **/
  @:ufunction(BlueprintCallable) @:thisConst @:final public function GetForcedLOD() : unreal.Int32;
  ...
  **/
  @:ufunction(BlueprintCallable) @:thisConst @:final public function GetTwistAndSwingAngleOfDeltaRotationFromRefPose(BoneName : unreal.FName, OutTwistAngle : unreal.Float32, OutSwingAngle : unreal.Float32) : Bool;
  ...
  **/
  @:ufunction(BlueprintCallable) @:final public function SetSkinWeightProfile(InProfileName : unreal.FName) : Bool;
  
  /**
    Clear the Skin Weight Profile from this component, in case it is set
  **/
  @:ufunction(BlueprintCallable) @:final public function ClearSkinWeightProfile() : Void;
  
  /**
    Unload a Skin Weight Profile's skin weight buffer (if created)
  **/
  @:ufunction(BlueprintCallable) @:final public function UnloadSkinWeightProfile(InProfileName : unreal.FName) : Void;
  
  /**
    Return the name of the Skin Weight Profile that is currently set otherwise returns 'None'
  **/
  @:ufunction(BlueprintCallable) @:thisConst @:final public function GetCurrentSkinWeightProfileName() : unreal.FName;
  
  /**
    Check whether or not a Skin Weight Profile is currently set
  **/
  @:ufunction(BlueprintCallable) @:thisConst @:final public function IsUsingSkinWeightProfile() : Bool;
  @:ufunction(BlueprintCallable) @:thisConst @:final public function GetVertexOffsetUsage(LODIndex : unreal.Int32) : unreal.Int32;
  @:ufunction(BlueprintCallable) @:final public function SetVertexOffsetUsage(LODIndex : unreal.Int32, Usage : unreal.Int32) : Void;
  @:ufunction(BlueprintCallable) @:final public function SetPreSkinningOffsets(LODIndex : unreal.Int32, Offsets : unreal.TArray<unreal.FVector>) : Void;
  @:ufunction(BlueprintCallable) @:final public function SetPostSkinningOffsets(LODIndex : unreal.Int32, Offsets : unreal.TArray<unreal.FVector>) : Void;
  ...
  **/
  @:ufunction(BlueprintCallable) @:final public function ShowMaterialSection(MaterialID : unreal.Int32, SectionIndex : unreal.Int32, bShow : Bool, LODIndex : unreal.Int32) : Void;
  ...
  **/
  ...
  // LODSyncInterface interface implementation
