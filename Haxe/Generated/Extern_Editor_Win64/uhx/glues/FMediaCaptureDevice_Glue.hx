...
package uhx.glues;
@:unrealGlue extern class FMediaCaptureDevice_Glue {
public static function get_Url(self:unreal.VariantPtr):unreal.VariantPtr;
public static function set_Url(self:unreal.VariantPtr, value:unreal.VariantPtr):Void;
