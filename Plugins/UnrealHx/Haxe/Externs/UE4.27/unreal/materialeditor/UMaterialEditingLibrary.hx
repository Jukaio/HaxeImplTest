...
@:uextern @:uclass extern class UMaterialEditingLibrary extends unreal.UBlueprintFunctionLibrary {
  ...
  **/
  @:ufunction(BlueprintCallable) static public function HasMaterialUsage(Material : unreal.UMaterial, Usage : unreal.EMaterialUsage) : Bool;
  ...
  **/
  @:ufunction(BlueprintCallable) static public function GetMaterialDefaultScalarParameterValue(Material : unreal.UMaterial, ParameterName : unreal.FName) : unreal.Float32;
  
  /**
    Get the default texture parameter value from a Material
  **/
  @:ufunction(BlueprintCallable) static public function GetMaterialDefaultTextureParameterValue(Material : unreal.UMaterial, ParameterName : unreal.FName) : unreal.UTexture;
  
  /**
    Get the default vector parameter value from a Material
  **/
  @:ufunction(BlueprintCallable) static public function GetMaterialDefaultVectorParameterValue(Material : unreal.UMaterial, ParameterName : unreal.FName) : unreal.FLinearColor;
  
  /**
    Get the default static switch parameter value from a Material
  **/
  @:ufunction(BlueprintCallable) static public function GetMaterialDefaultStaticSwitchParameterValue(Material : unreal.UMaterial, ParameterName : unreal.FName) : Bool;
  
  /**
    Get the set of selected nodes from an active material editor
  **/
  @:ufunction(BlueprintCallable) static public function GetMaterialSelectedNodes(Material : unreal.UMaterial) : unreal.TSet<unreal.UObject>;
  
  /**
    Get the node providing the output for a given material property from an active material editor
  **/
  @:ufunction(BlueprintCallable) static public function GetMaterialPropertyInputNode(Material : unreal.UMaterial, Property : unreal.EMaterialProperty) : unreal.UMaterialExpression;
  
  /**
    Get the set of nodes acting as inputs to a node from an active material editor
  **/
  @:ufunction(BlueprintCallable) static public function GetInputsForMaterialExpression(Material : unreal.UMaterial, MaterialExpression : unreal.UMaterialExpression) : unreal.TArray<unreal.UMaterialExpression>;
  
  /**
    Get the list of textures used by a material
  **/
  @:ufunction(BlueprintCallable) static public function GetUsedTextures(Material : unreal.UMaterial) : unreal.TArray<unreal.UTexture>;
  ...
  **/
  @:ufunction(BlueprintCallable) static public function GetMaterialInstanceStaticSwitchParameterValue(Instance : unreal.UMaterialInstanceConstant, ParameterName : unreal.FName) : Bool;
  ...
  **/
  @:ufunction(BlueprintCallable) static public function GetChildInstances(Parent : unreal.UMaterialInterface, ChildInstances : unreal.PRef<unreal.TArray<unreal.FAssetData>>) : Void;
  
  /**
    Gets all scalar parameter names
  **/
  @:ufunction(BlueprintCallable) static public function GetScalarParameterNames(Material : unreal.UMaterialInterface, ParameterNames : unreal.PRef<unreal.TArray<unreal.FName>>) : Void;
  
  /**
    Gets all vector parameter names
  **/
  @:ufunction(BlueprintCallable) static public function GetVectorParameterNames(Material : unreal.UMaterialInterface, ParameterNames : unreal.PRef<unreal.TArray<unreal.FName>>) : Void;
  
  /**
    Gets all texture parameter names
  **/
  @:ufunction(BlueprintCallable) static public function GetTextureParameterNames(Material : unreal.UMaterialInterface, ParameterNames : unreal.PRef<unreal.TArray<unreal.FName>>) : Void;
  
  /**
    Gets all static switch parameter names
  **/
  @:ufunction(BlueprintCallable) static public function GetStaticSwitchParameterNames(Material : unreal.UMaterialInterface, ParameterNames : unreal.PRef<unreal.TArray<unreal.FName>>) : Void;
  ...
  **/
  @:ufunction(BlueprintCallable) static public function GetScalarParameterSource(Material : unreal.UMaterialInterface, ParameterName : unreal.Const<unreal.FName>, ParameterSource : unreal.PRef<unreal.FSoftObjectPath>) : Bool;
  ...
  /**
    ...
    @return Whether or not the parameter was found in this material
  **/
  @:ufunction(BlueprintCallable) static public function GetVectorParameterSource(Material : unreal.UMaterialInterface, ParameterName : unreal.Const<unreal.FName>, ParameterSource : unreal.PRef<unreal.FSoftObjectPath>) : Bool;
  ...
  /**
    ...
    @return Whether or not the parameter was found in this material
  **/
  @:ufunction(BlueprintCallable) static public function GetTextureParameterSource(Material : unreal.UMaterialInterface, ParameterName : unreal.Const<unreal.FName>, ParameterSource : unreal.PRef<unreal.FSoftObjectPath>) : Bool;
  ...
  /**
    ...
    @return Whether or not the parameter was found in this material
  **/
  @:ufunction(BlueprintCallable) static public function GetStaticSwitchParameterSource(Material : unreal.UMaterialInterface, ParameterName : unreal.Const<unreal.FName>, ParameterSource : unreal.PRef<unreal.FSoftObjectPath>) : Bool;
  
  /**
    Returns statistics about the given material
  **/
  @:ufunction(BlueprintCallable) static public function GetStatistics(Material : unreal.UMaterialInterface) : unreal.materialeditor.FMaterialStatistics;
