...
@:uextern @:uclass extern class UMediaTexture extends unreal.UTexture {
  ...
  **/
  @:uproperty public var CurrentOrientation : unreal.mediaassets.MediaTextureOrientation;
  
  /**
    Current aspect ratio
  **/
  @:uproperty public var CurrentAspectRatio : unreal.Float32;
  @:uproperty public var OutputFormat : unreal.mediaassets.MediaTextureOutputFormat;
  
  /**
    Enable new style output (default = false).
  **/
  @:uproperty public var NewStyleOutput : Bool;
  
  /**
    The number of mips to use (default = 1).
  **/
  @:uproperty public var NumMips : unreal.UInt8;
  
  /**
    Basic enablement for mip generation (default = false).
  **/
  @:uproperty public var EnableGenMips : Bool;
  ...
  **/
  @:ufunction(BlueprintCallable) @:thisConst @:final public function GetTextureNumMips() : unreal.Int32;
