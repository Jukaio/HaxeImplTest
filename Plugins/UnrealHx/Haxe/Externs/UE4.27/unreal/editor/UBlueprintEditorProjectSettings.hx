...
@:uextern @:uclass extern class UBlueprintEditorProjectSettings extends unreal.developersettings.UDeveloperSettings {
  
  /**
    Default view mode to use for child actor components in a Blueprint actor's component tree hierarchy (experimental).
  **/
  @:uproperty public var DefaultChildActorTreeViewMode : unreal.EChildActorComponentTreeViewVisualizationMode;
  ...
  **/
  @:uproperty public var bEnableChildActorExpansionInTreeView : Bool;
