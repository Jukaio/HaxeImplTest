...
@:uextern @:ustruct extern class FSteamVRInputBindingInfo {
  @:uproperty public var SlotName : unreal.FName;
  @:uproperty public var ModeName : unreal.FName;
  @:uproperty public var InputPathName : unreal.FName;
  @:uproperty public var DevicePathName : unreal.FName;
