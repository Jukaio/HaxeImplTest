...
package uhx.glues;
@:unrealGlue extern class FGizmoFloatParameterChange_Glue {
public static function get_CurrentValue(self:unreal.VariantPtr):cpp.Float32;
public static function set_CurrentValue(self:unreal.VariantPtr, value:cpp.Float32):Void;
public static function get_InitialValue(self:unreal.VariantPtr):cpp.Float32;
public static function set_InitialValue(self:unreal.VariantPtr, value:cpp.Float32):Void;
