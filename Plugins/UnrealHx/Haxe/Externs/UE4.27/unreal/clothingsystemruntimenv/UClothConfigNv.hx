...
@:uextern @:uclass extern class UClothConfigNv extends unreal.clothingsystemruntimecommon.UClothConfigCommon {
  @:deprecated @:uproperty public var ShearConstraintConfig_DEPRECATED : unreal.clothingsystemruntimecommon.FClothConstraintSetup_Legacy;
  @:deprecated @:uproperty public var BendConstraintConfig_DEPRECATED : unreal.clothingsystemruntimecommon.FClothConstraintSetup_Legacy;
  @:deprecated @:uproperty public var HorizontalConstraintConfig_DEPRECATED : unreal.clothingsystemruntimecommon.FClothConstraintSetup_Legacy;
  @:deprecated @:uproperty public var VerticalConstraintConfig_DEPRECATED : unreal.clothingsystemruntimecommon.FClothConstraintSetup_Legacy;
  
  /**
    Deprecated properties using old legacy structure and enum that couldn't be redirected
  **/
  @:deprecated @:uproperty public var WindMethod_DEPRECATED : unreal.clothingsystemruntimecommon.EClothingWindMethod_Legacy;
  ...
  **/
  @:uproperty public var ShearConstraint : unreal.clothingsystemruntimenv.FClothConstraintSetupNv;
  
  /**
    Constraint data for bend constraints
  **/
  @:uproperty public var BendConstraint : unreal.clothingsystemruntimenv.FClothConstraintSetupNv;
  
  /**
    Constraint data for horizontal constraints
  **/
  @:uproperty public var HorizontalConstraint : unreal.clothingsystemruntimenv.FClothConstraintSetupNv;
  
  /**
    Constraint data for vertical constraints
  **/
  @:uproperty public var VerticalConstraint : unreal.clothingsystemruntimenv.FClothConstraintSetupNv;
  ...
  **/
  @:uproperty public var ClothingWindMethod : unreal.clothingsystemruntimenv.EClothingWindMethodNv;
