...
package uhx.glues;
@:unrealGlue extern class FInstanceRadialDamageSignature_Glue {
public static function create():unreal.VariantPtr;
public static function createNew():unreal.VariantPtr;
public static function Broadcast(self:unreal.VariantPtr, arg_0:unreal.VariantPtr, arg_1:unreal.VariantPtr, arg_2:unreal.UIntPtr, arg_3:unreal.VariantPtr, arg_4:cpp.Float32, arg_5:unreal.UIntPtr, arg_6:unreal.UIntPtr):Void;
