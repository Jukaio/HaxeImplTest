...
@:uextern @:uclass extern class UMaterialExpressionCustom extends unreal.UMaterialExpression {
  @:uproperty public var IncludeFilePaths : unreal.TArray<unreal.FString>;
  @:uproperty public var AdditionalDefines : unreal.TArray<unreal.FCustomDefine>;
  @:uproperty public var AdditionalOutputs : unreal.TArray<unreal.FCustomOutput>;
