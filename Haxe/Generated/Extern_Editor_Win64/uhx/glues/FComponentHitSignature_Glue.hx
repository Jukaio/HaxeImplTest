...
package uhx.glues;
@:unrealGlue extern class FComponentHitSignature_Glue {
public static function create():unreal.VariantPtr;
public static function createNew():unreal.VariantPtr;
public static function Broadcast(self:unreal.VariantPtr, arg_0:unreal.UIntPtr, arg_1:unreal.UIntPtr, arg_2:unreal.UIntPtr, arg_3:unreal.VariantPtr, arg_4:unreal.VariantPtr):Void;
