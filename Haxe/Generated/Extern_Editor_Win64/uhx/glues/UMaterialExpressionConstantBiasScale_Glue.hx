...
package uhx.glues;
@:unrealGlue extern class UMaterialExpressionConstantBiasScale_Glue {
...
public static function get_Bias(self:unreal.UIntPtr):cpp.Float32;
public static function set_Bias(self:unreal.UIntPtr, value:cpp.Float32):Void;
