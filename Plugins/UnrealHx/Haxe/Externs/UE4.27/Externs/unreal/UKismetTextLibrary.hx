...
@:uextern @:uclass extern class UKismetTextLibrary extends unreal.UBlueprintFunctionLibrary {
  ...
  **/
  ...
  /**
    Converts a passed in integer to text based on formatting options
  **/
  @:ufunction(BlueprintCallable) static public function Conv_Int64ToText(Value : unreal.Int64, bAlwaysSign : Bool = false, bUseGrouping : Bool = true, MinimumIntegralDigits : unreal.Int32 = 1, MaximumIntegralDigits : unreal.Int32 = 324) : unreal.FText;
