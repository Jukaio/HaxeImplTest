...
@:uextern @:uclass extern class UPrimitiveComponent extends unreal.USceneComponent implements unreal.INavRelevantInterface {
  ...
  **/
  @:uproperty public var VirtualTextureMinCoverage : unreal.Int8;
  ...
  **/
  @:uproperty public var VirtualTextureCullMips : unreal.Int8;
  
  /**
    Bias to the LOD selected for rendering to runtime virtual textures.
  **/
  @:uproperty public var VirtualTextureLodBias : unreal.Int8;
  ...
  **/
  @:uproperty public var TranslucencySortDistanceOffset : unreal.Float32;
  ...
  **/
  ...
  @:uproperty public var HitProxyPriority : unreal.EHitProxyPriority;
  ...
  **/
  @:uproperty public var bHiddenInSceneCapture : Bool;
  
  /**
    When true, will only be visible in Scene Capture
  **/
  @:uproperty public var bVisibleInSceneCaptureOnly : Bool;
  ...
  **/
  @:uproperty public var bFillCollisionUnderneathForNavmesh : Bool;
  ...
  **/
  @:uproperty public var bExcludeFromLightAttachmentGroup : Bool;
  ...
  **/
  ...
  /**
    ...
    This flag is only used if CastShadow is true.
  **/
  @:uproperty public var bCastContactShadow : Bool;
  ...
  **/
  @:uproperty public var bRenderInDepthPass : Bool;
  ...
  **/
  @:uproperty public var bVisibleInRealTimeSkyCaptures : Bool;
  ...
  **/
  @:uproperty public var bBatchImpostersAsInstances : Bool;
  ...
  **/
  ...
  @:ufunction(BlueprintCallable) @:final public function SetLightingChannels(bChannel0 : Bool, bChannel1 : Bool, bChannel2 : Bool) : Void;
  ...
  **/
  @:ufunction(BlueprintCallable) @:final public function SetCustomPrimitiveDataFloat(DataIndex : unreal.Int32, Value : unreal.Float32) : Void;
  ...
  **/
  @:ufunction(BlueprintCallable) @:final public function SetCustomPrimitiveDataVector2(DataIndex : unreal.Int32, Value : unreal.FVector2D) : Void;
  ...
  **/
  @:ufunction(BlueprintCallable) @:final public function SetCustomPrimitiveDataVector3(DataIndex : unreal.Int32, Value : unreal.FVector) : Void;
  ...
  **/
  @:ufunction(BlueprintCallable) @:final public function SetCustomPrimitiveDataVector4(DataIndex : unreal.Int32, Value : unreal.FVector4) : Void;
  
  /**
    Set default custom primitive data at index DataIndex, and marks the render state dirty
  **/
  @:ufunction(BlueprintCallable) @:final public function SetDefaultCustomPrimitiveDataFloat(DataIndex : unreal.Int32, Value : unreal.Float32) : Void;
  ...
  **/
  @:ufunction(BlueprintCallable) @:final public function SetDefaultCustomPrimitiveDataVector2(DataIndex : unreal.Int32, Value : unreal.FVector2D) : Void;
  ...
  **/
  @:ufunction(BlueprintCallable) @:final public function SetDefaultCustomPrimitiveDataVector3(DataIndex : unreal.Int32, Value : unreal.FVector) : Void;
  ...
  **/
  @:ufunction(BlueprintCallable) @:final public function SetDefaultCustomPrimitiveDataVector4(DataIndex : unreal.Int32, Value : unreal.FVector4) : Void;
  ...
  **/
  ...
  /**
    ...
    @param bVelChange    If true, the Strength is taken as a change in velocity instead of an impulse (ie. mass will have no effect).
  **/
  @:ufunction(BlueprintCallable) public function AddRadialImpulse(Origin : unreal.FVector, Radius : unreal.Float32, Strength : unreal.Float32, Falloff : unreal.physicscore.ERadialImpulseFalloff, bVelChange : Bool = false) : Void;
  ...
  **/
  @:ufunction(BlueprintCallable) public function AddRadialForce(Origin : unreal.FVector, Radius : unreal.Float32, Strength : unreal.Float32, Falloff : unreal.physicscore.ERadialImpulseFalloff, bAccelChange : Bool = false) : Void;
  ...
  **/
  @:ufunction(BlueprintCallable) @:final public function SetCastHiddenShadow(NewCastHiddenShadow : Bool) : Void;
  
  /**
    Changes the value of CastInsetShadow.
  **/
  @:ufunction(BlueprintCallable) @:final public function SetCastInsetShadow(bInCastInsetShadow : Bool) : Void;
  
  /**
    Changes the value of LightAttachmentsAsGroup.
  **/
  @:ufunction(BlueprintCallable) @:final public function SetLightAttachmentsAsGroup(bInLightAttachmentsAsGroup : Bool) : Void;
  
  /**
    Changes the value of ExcludeFromLightAttachmentGroup.
  **/
  @:ufunction(BlueprintCallable) @:final public function SetExcludeFromLightAttachmentGroup(bInExcludeFromLightAttachmentGroup : Bool) : Void;
  ...
  **/
  @:ufunction(BlueprintCallable) @:final public function SetTranslucencySortDistanceOffset(NewTranslucencySortDistanceOffset : unreal.Float32) : Void;
  ...
  **/
  @:ufunction(BlueprintCallable) public function SetCollisionProfileName(InCollisionProfileName : unreal.FName, bUpdateOverlaps : Bool = true) : Void;
  ...
  **/
  @:ufunction(BlueprintCallable) @:final public function SetVisibleInSceneCaptureOnly(bValue : Bool) : Void;
  
  /**
    Sets bHideInSceneCapture property and marks the render state dirty.
  **/
  @:ufunction(BlueprintCallable) @:final public function SetHiddenInSceneCapture(bValue : Bool) : Void;
  ...
  **/
  @:ufunction(BlueprintCallable) public function SetPhysMaterialOverride(NewPhysMaterial : unreal.physicscore.UPhysicalMaterial) : Void;
