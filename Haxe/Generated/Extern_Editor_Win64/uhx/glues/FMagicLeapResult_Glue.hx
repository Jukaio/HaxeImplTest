...
package uhx.glues;
@:unrealGlue extern class FMagicLeapResult_Glue {
public static function get_AdditionalInfo(self:unreal.VariantPtr):unreal.VariantPtr;
public static function set_AdditionalInfo(self:unreal.VariantPtr, value:unreal.VariantPtr):Void;
