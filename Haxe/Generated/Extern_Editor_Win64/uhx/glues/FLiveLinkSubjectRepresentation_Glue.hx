...
package uhx.glues;
@:unrealGlue extern class FLiveLinkSubjectRepresentation_Glue {
...
public static function get_Subject(self:unreal.VariantPtr):unreal.VariantPtr;
public static function set_Subject(self:unreal.VariantPtr, value:unreal.VariantPtr):Void;
