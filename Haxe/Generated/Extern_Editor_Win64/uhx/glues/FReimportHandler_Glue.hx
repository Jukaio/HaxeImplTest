...
package uhx.glues;
@:unrealGlue extern class FReimportHandler_Glue {
public static function create():unreal.VariantPtr;
public static function createNew():unreal.VariantPtr;
public static function CanReimport(self:unreal.VariantPtr, obj:unreal.UIntPtr, outFilenames:unreal.VariantPtr):Bool;
public static function SetReimportPaths(self:unreal.VariantPtr, obk:unreal.UIntPtr, newReimportPaths:unreal.VariantPtr):Void;
