...
@:uextern @:uclass extern class UAnimSequence extends unreal.UAnimSequenceBase {
  ...
  **/
  @:uproperty public var RetargetSourceAssetReferencePose : unreal.TArray<unreal.FTransform>;
  ...
  **/
  @:uproperty public var CompressionErrorThresholdScale : unreal.Float32;
  ...
  **/
  ...
  #end // WITH_EDITORONLY_DATA
  #if WITH_EDITOR
  @:ufunction(BlueprintCallable) @:final public function AddBoneFloatCustomAttribute(BoneName : unreal.Const<unreal.PRef<unreal.FName>>, AttributeName : unreal.Const<unreal.PRef<unreal.FName>>, TimeKeys : unreal.Const<unreal.PRef<unreal.TArray<unreal.Float32>>>, ValueKeys : unreal.Const<unreal.PRef<unreal.TArray<unreal.Float32>>>) : Void;
  @:ufunction(BlueprintCallable) @:final public function AddBoneIntegerCustomAttribute(BoneName : unreal.Const<unreal.PRef<unreal.FName>>, AttributeName : unreal.Const<unreal.PRef<unreal.FName>>, TimeKeys : unreal.Const<unreal.PRef<unreal.TArray<unreal.Float32>>>, ValueKeys : unreal.Const<unreal.PRef<unreal.TArray<unreal.Int32>>>) : Void;
  @:ufunction(BlueprintCallable) @:final public function AddBoneStringCustomAttribute(BoneName : unreal.Const<unreal.PRef<unreal.FName>>, AttributeName : unreal.Const<unreal.PRef<unreal.FName>>, TimeKeys : unreal.Const<unreal.PRef<unreal.TArray<unreal.Float32>>>, ValueKeys : unreal.Const<unreal.PRef<unreal.TArray<unreal.FString>>>) : Void;
  @:ufunction(BlueprintCallable) @:final public function RemoveCustomAttribute(BoneName : unreal.Const<unreal.PRef<unreal.FName>>, AttributeName : unreal.Const<unreal.PRef<unreal.FName>>) : Void;
  @:ufunction(BlueprintCallable) @:final public function RemoveAllCustomAttributesForBone(BoneName : unreal.Const<unreal.PRef<unreal.FName>>) : Void;
  @:ufunction(BlueprintCallable) @:final public function RemoveAllCustomAttributes() : Void;
  #end // WITH_EDITOR
