...
package uhx.glues;
@:unrealGlue extern class FMagicLeapPlaneBoundaries_Glue {
public static function get_Boundaries(self:unreal.VariantPtr):unreal.VariantPtr;
public static function set_Boundaries(self:unreal.VariantPtr, value:unreal.VariantPtr):Void;
