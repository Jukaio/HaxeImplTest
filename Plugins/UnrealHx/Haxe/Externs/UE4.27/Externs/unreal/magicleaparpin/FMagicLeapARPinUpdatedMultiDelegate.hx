...
typedef FMagicLeapARPinUpdatedMultiDelegate = unreal.DynamicMulticastDelegate<FMagicLeapARPinUpdatedMultiDelegate, unreal.Const<unreal.PRef<unreal.TArray<unreal.FGuid>>>->unreal.Const<unreal.PRef<unreal.TArray<unreal.FGuid>>>->unreal.Const<unreal.PRef<unreal.TArray<unreal.FGuid>>>->Void>;