...
package uhx.glues;
@:unrealGlue extern class UBasicOverlays_Glue {
...
public static function get_Overlays(self:unreal.UIntPtr):unreal.VariantPtr;
public static function set_Overlays(self:unreal.UIntPtr, value:unreal.VariantPtr):Void;
