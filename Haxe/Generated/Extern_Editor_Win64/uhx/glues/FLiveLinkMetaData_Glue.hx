...
package uhx.glues;
@:unrealGlue extern class FLiveLinkMetaData_Glue {
public static function get_SceneTime(self:unreal.VariantPtr):unreal.VariantPtr;
public static function set_SceneTime(self:unreal.VariantPtr, value:unreal.VariantPtr):Void;
