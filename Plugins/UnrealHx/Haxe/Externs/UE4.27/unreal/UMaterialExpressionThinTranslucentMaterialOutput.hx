...
@:uextern @:uclass extern class UMaterialExpressionThinTranslucentMaterialOutput extends unreal.UMaterialExpressionCustomOutput {
  
  /**
    Input for the transmittance color for a view perpendicular to the surface. Valid range is [0,1].
  **/
  @:uproperty public var TransmittanceColor : unreal.FExpressionInput;
