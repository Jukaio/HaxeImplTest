...
@:uextern @:uclass extern class AActor extends unreal.UObject {
  ...
  **/
  @:uproperty private var ActorGuid : unreal.FGuid;
  ...
  **/
  @:uproperty private var UpdateOverlapsMethodDuringLevelStreaming : unreal.EActorUpdateOverlapsMethod;
  ...
  **/
  ...
  @:ufunction(BlueprintCallable) @:final public function SetAutoDestroyWhenFinished(bVal : Bool) : Void;
  ...
  **/
  @:ufunction(BlueprintCallable) @:thisConst @:final public function GetTransform() : unreal.Const<unreal.PRef<unreal.FTransform>>;
  ...
  **/
  @:ufunction(BlueprintCallable) @:thisConst @:final public function GetActorBounds(bOnlyCollidingComponents : Bool, Origin : unreal.PRef<unreal.FVector>, BoxExtent : unreal.PRef<unreal.FVector>, bIncludeFromChildActors : Bool = false) : Void;
  ...
  **/
  @:ufunction(BlueprintCallable) @:thisConst @:final public function GetSquaredHorizontalDistanceTo(OtherActor : unreal.Const<unreal.AActor>) : unreal.Float32;
  ...
  **/
  @:ufunction(BlueprintCallable) @:final public function K2_AddActorWorldTransformKeepScale(DeltaTransform : unreal.Const<unreal.PRef<unreal.FTransform>>, bSweep : Bool, SweepHitResult : unreal.PRef<unreal.FHitResult>, bTeleport : Bool) : Void;
  ...
  **/
  @:ufunction(BlueprintCallable) @:final public function AddComponent(TemplateName : unreal.FName, bManualAttachment : Bool, RelativeTransform : unreal.Const<unreal.PRef<unreal.FTransform>>, ComponentTemplateContext : unreal.Const<unreal.UObject>, bDeferredFinish : Bool = false) : unreal.UActorComponent;
  ...
  /**
    ...
    @param bDeferredFinish                               Whether or not to immediately complete the creation and registration process for this component. Will be false if there are expose on spawn properties being set
  **/
  @:ufunction(BlueprintCallable) @:final public function AddComponentByClass(Class : unreal.TSubclassOf<unreal.UActorComponent>, bManualAttachment : Bool, RelativeTransform : unreal.Const<unreal.PRef<unreal.FTransform>>, bDeferredFinish : Bool) : unreal.UActorComponent;
  ...
  /**
    ...
    @param RelativeTransform                             The relative transform between the new component and its attach parent (automatic only)
  **/
  @:ufunction(BlueprintCallable) @:final public function FinishAddComponent(Component : unreal.UActorComponent, bManualAttachment : Bool, RelativeTransform : unreal.Const<unreal.PRef<unreal.FTransform>>) : Void;
  ...
  **/
  @:ufunction(BlueprintCallable) @:thisConst @:final public function GetGameTimeSinceCreation() : unreal.Float32;
  ...
  **/
  @:ufunction(BlueprintImplementableEvent) private function ReceiveEndPlay(EndPlayReason : unreal.EEndPlayReason) : Void;
  ...
  **/
  @:ufunction(BlueprintCallable) @:thisConst @:final public function GetAttachedActors(OutActors : unreal.PRef<unreal.TArray<unreal.AActor>>, bResetArray : Bool = true) : Void;
  ...
  **/
  @:ufunction(BlueprintCallable) @:thisConst @:final public function K2_GetComponentsByClass(@:bpopt("ActorComponent") ComponentClass : unreal.TSubclassOf<unreal.UActorComponent>) : unreal.TArray<unreal.UActorComponent>;
  ...
  **/
  @:ufunction(BlueprintCallable) @:thisConst @:final public function GetComponentsByInterface(Interface : unreal.TSubclassOf<unreal.IInterface>) : unreal.TArray<unreal.UActorComponent>;
