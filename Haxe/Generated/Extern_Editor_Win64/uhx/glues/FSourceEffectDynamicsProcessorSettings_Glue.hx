...
package uhx.glues;
@:unrealGlue extern class FSourceEffectDynamicsProcessorSettings_Glue {
...
public static function get_bStereoLinked(self:unreal.VariantPtr):Bool;
public static function set_bStereoLinked(self:unreal.VariantPtr, value:Bool):Void;
