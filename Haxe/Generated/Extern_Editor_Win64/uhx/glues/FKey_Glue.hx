...
package uhx.glues;
@:unrealGlue extern class FKey_Glue {
public static function create():unreal.VariantPtr;
public static function createByName(InName:unreal.VariantPtr):unreal.VariantPtr;
public static function GetDisplayName(self:unreal.VariantPtr):unreal.VariantPtr;
public static function GetFName(self:unreal.VariantPtr):unreal.VariantPtr;
public static function IsGamepadKey(self:unreal.VariantPtr):Bool;
public static function ToString(self:unreal.VariantPtr):unreal.VariantPtr;
public static function IsFloatAxis(self:unreal.VariantPtr):Bool;
public static function IsVectorAxis(self:unreal.VariantPtr):Bool;
public static function IsModifierKey(self:unreal.VariantPtr):Bool;
