...
package uhx.glues;
@:unrealGlue extern class FMagicLeapPersistentPlanesResultDelegateMulti_Glue {
public static function create():unreal.VariantPtr;
public static function createNew():unreal.VariantPtr;
public static function Broadcast(self:unreal.VariantPtr, arg_0:Bool, arg_1:unreal.VariantPtr, arg_2:Int, arg_3:unreal.VariantPtr, arg_4:unreal.VariantPtr, arg_5:unreal.VariantPtr, arg_6:unreal.VariantPtr):Void;
