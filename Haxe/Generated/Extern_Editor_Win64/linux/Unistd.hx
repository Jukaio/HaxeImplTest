...
@:static
@:uextern
@:ueGluePath("uhx.glues.Unistd_Glue")
#if (cppia && !LIVE_RELOAD_BUILD && !macro) @:build(uhx.compiletime.types.CompiledMetaCheck.build("linux.Unistd")) #end
@:forward(dispose,isDisposed) abstract Unistd#if macro (Dynamic) #else (unreal.Struct) to unreal.Struct to unreal.Struct to unreal.VariantPtr #end {
  #if !macro 
  inline public static function fromPointer(ptr:unreal.VariantPtr):linux.Unistd {
    return cast ptr;
  }
  @:deprecated("This type does not support copy constructors") private function copy():linux.Unistd {
    return throw "The type linux.Unistd does not support copy constructors";
  }
  @:deprecated("This type does not support copy constructors") private function copyNew():unreal.POwnedPtr<linux.Unistd> {
    return throw "The type linux.Unistd does not support copy constructors";
  }
  /**
  ...
  **/
  ...
  @:glueHeaderCode("static unreal::IntPtr read(int fd, unreal::UIntPtr buf, unreal::UIntPtr count);")
  @:glueCppCode("unreal::IntPtr uhx::glues::Unistd_Glue_obj::read(int fd, unreal::UIntPtr buf, unreal::UIntPtr count) {\n\t\tunreal::IntPtr uhx_gc_free_ret ;\n\t{\n\t\tAutoHaxeBlocking uhx_auto_gc_blocking;\n\t\tuhx_gc_free_ret = ::read(fd, ( (void *) (buf) ), count);\n\t}\n\treturn uhx_gc_free_ret;\n}")
  ...
  public static function read(fd : Int, buf : unreal.AnyPtr, count : unreal.UIntPtr) : unreal.IntPtr {
    ...
    var uhx_arg_1:unreal.AnyPtr = buf;
    var uhx_arg_2:unreal.UIntPtr = count;
    return uhx.glues.Unistd_Glue.read(uhx_arg_0, uhx_arg_1, uhx_arg_2);
  ...
  **/
  ...
  @:glueHeaderCode("static int close(int fd);")
  @:glueCppCode("int uhx::glues::Unistd_Glue_obj::close(int fd) {\n\t\tint32 uhx_gc_free_ret ;\n\t{\n\t\tAutoHaxeBlocking uhx_auto_gc_blocking;\n\t\tuhx_gc_free_ret = ::close(fd);\n\t}\n\treturn uhx_gc_free_ret;\n}")
  #if (!UHX_DISPLAY && cppia && !LIVE_RELOAD_BUILD)
  ...
  public static function close(fd : Int) : Int {
    ...
    #else
    var uhx_arg_0:Int = fd;
    return uhx.glues.Unistd_Glue.close(uhx_arg_0);
  ...
  **/
  ...
  @:glueCppIncludes("uhx/AutoHaxeBlocking.h")
  @:glueHeaderIncludes("<hxcpp.h>")
  @:glueHeaderCode("static int nice(int incr);")
  @:glueCppCode("int uhx::glues::Unistd_Glue_obj::nice(int incr) {\n\t\tint32 uhx_gc_free_ret ;\n\t{\n\t\tAutoHaxeBlocking uhx_auto_gc_blocking;\n\t\tuhx_gc_free_ret = ::nice(incr);\n\t}\n\treturn uhx_gc_free_ret;\n}")
  #if (!UHX_DISPLAY && cppia && !LIVE_RELOAD_BUILD)
  @:deprecated("UHXERR: The field nice was not compiled into the latest C++ compilation. Please perform a full C++ compilation.")
  #end
  @:ublocking
  @:global
  public static function nice(incr : Int) : Int {
    #if cppia
    throw "The function nice was not compiled into Unreal.hx. C++ recompilation is needed";
    #else
    var uhx_arg_0:Int = incr;
    return uhx.glues.Unistd_Glue.nice(uhx_arg_0);
