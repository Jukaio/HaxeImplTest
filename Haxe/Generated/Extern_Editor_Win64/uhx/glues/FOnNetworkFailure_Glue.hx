...
package uhx.glues;
@:unrealGlue extern class FOnNetworkFailure_Glue {
...
public static function Broadcast(self:unreal.VariantPtr, arg_0:unreal.UIntPtr, arg_1:unreal.UIntPtr, arg_2:Int, arg_3:unreal.VariantPtr):Void;
