...
package uhx.glues;
@:unrealGlue extern class FLiveLinkTransformBlueprintData_Glue {
public static function get_FrameData(self:unreal.VariantPtr):unreal.VariantPtr;
public static function set_FrameData(self:unreal.VariantPtr, value:unreal.VariantPtr):Void;
public static function get_StaticData(self:unreal.VariantPtr):unreal.VariantPtr;
public static function set_StaticData(self:unreal.VariantPtr, value:unreal.VariantPtr):Void;
