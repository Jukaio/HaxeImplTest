...
package uhx.glues;
@:unrealGlue extern class FOnPlayerTalkingStateChangedDelegate_Glue {
...
public static function Execute(self:unreal.VariantPtr, arg_0:unreal.VariantPtr, arg_1:Bool):Void;
public static function ExecuteIfBound(self:unreal.VariantPtr, arg_0:unreal.VariantPtr, arg_1:Bool):Void;
