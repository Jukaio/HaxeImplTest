...
package uhx.glues;
@:unrealGlue extern class FOnMeshTrackerUpdated_Glue {
public static function create():unreal.VariantPtr;
public static function createNew():unreal.VariantPtr;
public static function Broadcast(self:unreal.VariantPtr, arg_0:unreal.VariantPtr, arg_1:unreal.VariantPtr, arg_2:unreal.VariantPtr, arg_3:unreal.VariantPtr, arg_4:unreal.VariantPtr):Void;
