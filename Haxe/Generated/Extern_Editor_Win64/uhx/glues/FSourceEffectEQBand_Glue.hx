...
package uhx.glues;
@:unrealGlue extern class FSourceEffectEQBand_Glue {
...
public static function get_Bandwidth(self:unreal.VariantPtr):cpp.Float32;
public static function set_Bandwidth(self:unreal.VariantPtr, value:cpp.Float32):Void;
