...
@:uextern @:uclass extern class USceneComponent extends unreal.UActorComponent {
  ...
  **/
  @:ufunction(BlueprintCallable) @:final public function SetRelativeScale3D(NewScale3D : unreal.FVector) : Void;
  ...
  **/
  ...
  /**
    ...
    @param bTeleport                     Whether we teleport the physics state (if physics collision is enabled for this object).
                                                         ...
                                                         If CCD is on and not teleporting, this will affect objects along the entire sweep volume.
  **/
  @:ufunction(BlueprintCallable) @:final public function K2_AddWorldTransformKeepScale(DeltaTransform : unreal.Const<unreal.PRef<unreal.FTransform>>, bSweep : Bool, SweepHitResult : unreal.PRef<unreal.FHitResult>, bTeleport : Bool) : Void;
