...
@:uextern @:ustruct extern class FFOscillator {
  ...
  **/
  @:uproperty public var Waveform : unreal.gameplaycameras.EOscillatorWaveform;
  
  /**
    Defines how to begin (either at zero, or at a randomized value.
  **/
  @:uproperty public var InitialOffset : unreal.gameplaycameras.EInitialOscillatorOffset;
