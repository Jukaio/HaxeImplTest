...
package uhx.glues;
@:unrealGlue extern class FLiveLinkTime_Glue {
...
public static function get_WorldTime(self:unreal.VariantPtr):Float;
public static function set_WorldTime(self:unreal.VariantPtr, value:Float):Void;
