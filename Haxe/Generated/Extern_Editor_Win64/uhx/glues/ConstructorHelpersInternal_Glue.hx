...
package uhx.glues;
@:unrealGlue extern class ConstructorHelpersInternal_Glue {
public static function FindLoadObject(PathName:unreal.VariantPtr):unreal.UIntPtr;
public static function FindLoadObjectPackage(PathName:unreal.VariantPtr):unreal.UIntPtr;
public static function FindOrLoadClass(PathName:unreal.VariantPtr, BaseClass:unreal.UIntPtr):unreal.UIntPtr;
