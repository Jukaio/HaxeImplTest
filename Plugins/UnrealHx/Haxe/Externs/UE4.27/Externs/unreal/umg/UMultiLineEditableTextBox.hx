...
@:uextern @:uclass extern class UMultiLineEditableTextBox extends unreal.umg.UTextLayoutWidget {
  ...
  **/
  ...
  /**
    The text style
  **/
  @:uproperty(BlueprintSetter=SetTextStyle) public var TextStyle : unreal.slatecore.FTextBlockStyle;
  ...
  **/
  ...
  @:ufunction(BlueprintCallable) @:final public function SetTextStyle(InTextStyle : unreal.Const<unreal.PRef<unreal.slatecore.FTextBlockStyle>>) : Void;
