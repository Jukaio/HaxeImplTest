...
package uhx.glues;
@:unrealGlue extern class FOnGetUserPrivilegeCompleteDelegate_Glue {
...
public static function Execute(self:unreal.VariantPtr, arg_0:unreal.VariantPtr, arg_1:Int, arg_2:cpp.UInt32):Void;
public static function ExecuteIfBound(self:unreal.VariantPtr, arg_0:unreal.VariantPtr, arg_1:Int, arg_2:cpp.UInt32):Void;
