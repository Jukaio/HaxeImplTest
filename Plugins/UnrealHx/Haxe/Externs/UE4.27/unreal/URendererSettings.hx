...
@:uextern @:uclass extern class URendererSettings extends unreal.developersettings.UDeveloperSettings {
  ...
  **/
  @:uproperty public var MobilePlanarReflectionMode : unreal.EMobilePlanarReflectionMode;
  ...
  **/
  @:uproperty public var MaxSkinBones : unreal.FPerPlatformInt;
  ...
  **/
  @:uproperty public var UnlimitedBonInfluencesThreshold : unreal.Int32;
  
  /**
    If enabled, a new mesh imported will use unlimited bone buffer instead of fixed MaxBoneInfluences for rendering.
  **/
  @:uproperty public var bUseUnlimitedBoneInfluences : Bool;
  ...
  **/
  @:uproperty public var bMobileAmbientOcclusion : Bool;
  
  /**
    Whether to allow the usage and compilation of Light Propagation Volumes.
  **/
  @:uproperty public var bLPV : Bool;
  ...
  **/
  @:uproperty public var bSupport16BitBoneIndex : Bool;
  ...
  **/
  @:uproperty public var bMobileAllowMovableSpotlightShadows : Bool;
  ...
  **/
  @:uproperty public var DefaultSkinCacheBehavior : unreal.ESkinCacheDefaultBehavior;
  ...
  **/
  @:uproperty public var bSupportSkyAtmosphereAffectsHeightFog : Bool;
  ...
  **/
  @:uproperty public var bSupportSkyAtmosphere : Bool;
  ...
  **/
  @:uproperty public var bEnableRayTracingTextureLOD : Bool;
  ...
  **/
  @:uproperty public var bMeshStreaming : Bool;
  ...
  **/
  @:uproperty public var bMobilePostProcessing : Bool;
  ...
  **/
  @:uproperty public var bVertexDeformationOutputsVelocity : Bool;
  ...
  **/
  @:uproperty public var bSSGI : Bool;
  ...
  **/
  @:uproperty public var bEnablePreExposureOnlyInTheEditor : Bool;
  ...
  **/
  @:uproperty public var DefaultFeatureAutoExposureBias : unreal.Float32;
  ...
  **/
  @:uproperty public var HMDFixedFoveationLevel : unreal.EFixedFoveationLevels;
  ...
  **/
  @:uproperty public var bReflectionCaptureCompression : Bool;
  ...
  **/
  @:uproperty public var bVirtualTextureEnableCompressCrunch : Bool;
  
  /**
    Use zlib to compress virtual textures. Changing this setting requires restarting the editor.
  **/
  @:uproperty public var bVirtualTextureEnableCompressZlib : Bool;
  ...
  **/
  @:uproperty public var VirtualTextureFeedbackFactor : unreal.FakeUInt32;
  ...
  **/
  @:uproperty public var VirtualTextureTileBorderSize : unreal.FakeUInt32;
  ...
  **/
  @:uproperty public var VirtualTextureTileSize : unreal.FakeUInt32;
  ...
  **/
  @:uproperty public var bVirtualTexturedLightmaps : Bool;
  ...
  **/
  @:uproperty public var bVirtualTextureEnableAutoImport : Bool;
  ...
  **/
  @:uproperty public var bVirtualTextures : Bool;
  ...
  **/
  @:uproperty public var bMobileVirtualTextures : Bool;
