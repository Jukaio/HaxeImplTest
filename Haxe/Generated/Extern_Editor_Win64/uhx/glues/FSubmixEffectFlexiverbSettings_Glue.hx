...
package uhx.glues;
@:unrealGlue extern class FSubmixEffectFlexiverbSettings_Glue {
public static function get_Complexity(self:unreal.VariantPtr):Int;
public static function set_Complexity(self:unreal.VariantPtr, value:Int):Void;
public static function get_RoomDampening(self:unreal.VariantPtr):cpp.Float32;
public static function set_RoomDampening(self:unreal.VariantPtr, value:cpp.Float32):Void;
...
public static function get_PreDelay(self:unreal.VariantPtr):cpp.Float32;
public static function set_PreDelay(self:unreal.VariantPtr, value:cpp.Float32):Void;
