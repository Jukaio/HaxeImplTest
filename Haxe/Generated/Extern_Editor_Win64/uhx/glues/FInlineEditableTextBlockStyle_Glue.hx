...
package uhx.glues;
@:unrealGlue extern class FInlineEditableTextBlockStyle_Glue {
...
public static function get_EditableTextBoxStyle(self:unreal.VariantPtr):unreal.VariantPtr;
public static function set_EditableTextBoxStyle(self:unreal.VariantPtr, value:unreal.VariantPtr):Void;
