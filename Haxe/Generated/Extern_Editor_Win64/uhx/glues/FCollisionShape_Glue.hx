...
package uhx.glues;
@:unrealGlue extern class FCollisionShape_Glue {
public static function MakeBox(BoxHalfExtent:unreal.VariantPtr):unreal.VariantPtr;
public static function MakeSphere(SphereRadius:cpp.Float32):unreal.VariantPtr;
public static function MakeCapsule(CapsuleRadius:cpp.Float32, CapsuleHalfHeight:cpp.Float32):unreal.VariantPtr;
