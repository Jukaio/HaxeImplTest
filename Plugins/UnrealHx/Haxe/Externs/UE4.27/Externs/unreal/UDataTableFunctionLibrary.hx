...
@:uextern @:uclass extern class UDataTableFunctionLibrary extends unreal.UBlueprintFunctionLibrary {
  ...
  **/
  ...
  /**
    ...
    @return      True if the operation succeeds, check the log for errors if it didn't succeed.
  **/
  @:ufunction(BlueprintCallable) static public function FillDataTableFromJSONFile(DataTable : unreal.UDataTable, JSONFilePath : unreal.FString, @:opt("None") ImportRowStruct : unreal.UScriptStruct) : Bool;
  #end // WITH_EDITOR
