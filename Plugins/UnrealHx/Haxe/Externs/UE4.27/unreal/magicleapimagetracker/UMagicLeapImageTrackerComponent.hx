...
@:uextern @:uclass extern class UMagicLeapImageTrackerComponent extends unreal.USceneComponent {
  ...
  **/
  @:uproperty public var OnImageTargetUnreliableTracking : unreal.magicleapimagetracker.FMagicLeapImageTargetUnreliableTrackingMulti;
  
  /**
    Activated the target image becomes invisible to the camera
  **/
  @:uproperty public var OnImageTargetLost : unreal.magicleapimagetracker.FMagicLeapImageTargetLostMulti;
  
  /**
    Activated when the target image becomes visible to the camera
  **/
  @:uproperty public var OnImageTargetFound : unreal.magicleapimagetracker.FMagicLeapImageTargetFoundMulti;
  
  /**
    Activated when the target image fails to be set.
  **/
  @:uproperty public var OnSetImageTargetFailed : unreal.magicleapimagetracker.FMagicLeapSetImageTargetFailedMulti;
  
  /**
    Activated when the target image is successfully set.
  **/
  @:uproperty public var OnSetImageTargetSucceeded : unreal.magicleapimagetracker.FMagicLeapSetImageTargetSucceededMulti;
  @:uproperty public var AxisOrientation : unreal.magicleapimagetracker.EMagicLeapImageTargetOrientation;
  ...
  **/
  @:ufunction(BlueprintCallable) @:final public function RemoveTargetAsync() : Bool;
