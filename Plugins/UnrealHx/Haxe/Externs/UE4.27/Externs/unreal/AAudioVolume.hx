...
@:uextern @:uclass extern class AAudioVolume extends unreal.AVolume {
  ...
  @:ufunction(BlueprintCallable) @:final public function SetSubmixSendSettings(NewSubmixSendSettings : unreal.Const<unreal.PRef<unreal.TArray<unreal.FAudioVolumeSubmixSendSettings>>>) : Void;
  @:ufunction(BlueprintCallable) @:final public function SetSubmixOverrideSettings(NewSubmixOverrideSettings : unreal.Const<unreal.PRef<unreal.TArray<unreal.FAudioVolumeSubmixOverrideSettings>>>) : Void;
