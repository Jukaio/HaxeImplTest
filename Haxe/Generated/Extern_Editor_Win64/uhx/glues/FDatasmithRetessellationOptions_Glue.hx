...
package uhx.glues;
@:unrealGlue extern class FDatasmithRetessellationOptions_Glue {
public static function get_RetessellationRule(self:unreal.VariantPtr):Int;
public static function set_RetessellationRule(self:unreal.VariantPtr, value:Int):Void;
