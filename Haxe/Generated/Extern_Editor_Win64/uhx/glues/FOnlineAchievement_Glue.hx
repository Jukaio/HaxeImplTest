...
package uhx.glues;
@:unrealGlue extern class FOnlineAchievement_Glue {
...
public static function get_Progress(self:unreal.VariantPtr):cpp.Float32;
public static function set_Progress(self:unreal.VariantPtr, value:cpp.Float32):Void;
