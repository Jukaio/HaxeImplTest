...
package uhx.glues;
@:unrealGlue extern class FAITeamStimulusEvent_Glue {
public static function get_Enemy(self:unreal.VariantPtr):unreal.UIntPtr;
public static function set_Enemy(self:unreal.VariantPtr, value:unreal.UIntPtr):Void;
