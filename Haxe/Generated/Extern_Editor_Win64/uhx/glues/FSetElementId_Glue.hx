...
package uhx.glues;
@:unrealGlue extern class FSetElementId_Glue {
public static function glueNew():unreal.VariantPtr;
public static function FromInteger(Integer:Int):unreal.VariantPtr;
public static function IsValidId(self:unreal.VariantPtr):Bool;
public static function AsInteger(self:unreal.VariantPtr):Int;
