...
@:uextern @:ustruct extern class FSoundAttenuationPluginSettings {
  ...
  **/
  @:uproperty public var ReverbPluginSettingsArray : unreal.TArray<unreal.audioextensions.UReverbPluginSourceSettingsBase>;
  ...
  **/
  @:uproperty public var OcclusionPluginSettingsArray : unreal.TArray<unreal.audioextensions.UOcclusionPluginSourceSettingsBase>;
  ...
  **/
  @:uproperty public var SpatializationPluginSettingsArray : unreal.TArray<unreal.audioextensions.USpatializationPluginSourceSettingsBase>;
