...
public class HaxeModuleRules : BaseModuleRules {
  ...
  public static HaxeCompilationInfo setupHaxeTarget(ModuleRules rules, bool forceHaxeCompilation, bool manualDependencies, HaxeConfigOptions options) {
    ...
    if(rules.Target.Platform == UnrealTargetPlatform.Win64 || rules.Target.Platform == UnrealTargetPlatform.Win32) {
...
public class HaxeCompilationInfo {
  ...
  private void init() {
    ...
    if(rules.Target.Platform == UnrealTargetPlatform.Win64 
      || rules.Target.Platform == UnrealTargetPlatform.Win32
      || rules.Target.Platform == UnrealTargetPlatform.XboxOne) {
