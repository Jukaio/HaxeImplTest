...
package uhx.glues;
@:unrealGlue extern class FTwistConstraint_Glue {
public static function get_TwistMotion(self:unreal.VariantPtr):Int;
public static function set_TwistMotion(self:unreal.VariantPtr, value:Int):Void;
public static function get_TwistLimitDegrees(self:unreal.VariantPtr):cpp.Float32;
public static function set_TwistLimitDegrees(self:unreal.VariantPtr, value:cpp.Float32):Void;
