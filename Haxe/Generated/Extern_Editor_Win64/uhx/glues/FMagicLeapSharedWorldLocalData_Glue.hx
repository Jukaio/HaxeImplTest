...
package uhx.glues;
@:unrealGlue extern class FMagicLeapSharedWorldLocalData_Glue {
public static function get_LocalPins(self:unreal.VariantPtr):unreal.VariantPtr;
public static function set_LocalPins(self:unreal.VariantPtr, value:unreal.VariantPtr):Void;
