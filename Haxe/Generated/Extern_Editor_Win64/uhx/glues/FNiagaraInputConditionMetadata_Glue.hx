...
package uhx.glues;
@:unrealGlue extern class FNiagaraInputConditionMetadata_Glue {
public static function get_TargetValues(self:unreal.VariantPtr):unreal.VariantPtr;
public static function set_TargetValues(self:unreal.VariantPtr, value:unreal.VariantPtr):Void;
public static function get_InputName(self:unreal.VariantPtr):unreal.VariantPtr;
public static function set_InputName(self:unreal.VariantPtr, value:unreal.VariantPtr):Void;
