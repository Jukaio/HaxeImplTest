...
@:uextern @:uclass extern class UEditorPerformanceSettings extends unreal.developersettings.UDeveloperSettings {
  ...
  **/
  @:uproperty public var bEnableScalabilityWarningIndicator : Bool;
  ...
  **/
  @:uproperty public var bDisableRealtimeViewportsInRemoteSessions : Bool;
