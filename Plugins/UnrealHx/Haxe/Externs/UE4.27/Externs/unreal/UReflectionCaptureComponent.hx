...
@:uextern @:uclass extern class UReflectionCaptureComponent extends unreal.USceneComponent {
  ...
  **/
  @:uproperty public var MaxValueRGBM : unreal.Float32;
  
  /**
    Indicates if we want to manually modify the MaxRGBM value.
  **/
  @:uproperty public var bModifyMaxValueRGBM : Bool;
  ...
  **/
  @:uproperty public var MobileReflectionCompression : unreal.EMobileReflectionCompression;
