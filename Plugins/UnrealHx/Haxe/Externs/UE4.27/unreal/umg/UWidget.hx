...
@:uextern @:uclass extern class UWidget extends unreal.umg.UVisual {
  ...
  **/
  @:uproperty public var bOverrideAccessibleDefaults : Bool;
  ...
  **/
  ...
  @:ufunction(BlueprintCallable) @:final public function SetRenderTransformAngle(Angle : unreal.Float32) : Void;
  @:ufunction(BlueprintCallable) @:thisConst @:final public function GetRenderTransformAngle() : unreal.Float32;
  ...
  **/
  @:ufunction(BlueprintCallable) @:final public function SetFocus() : Void;
  ...
  **/
  ...
  /**
    ...
    @param Rule The rule to use when navigation is taking place
  **/
  @:ufunction(BlueprintCallable) @:final public function SetNavigationRuleBase(Direction : unreal.slatecore.EUINavigation, Rule : unreal.slatecore.EUINavigationRule) : Void;
  ...
  **/
  @:ufunction(BlueprintCallable) @:final public function SetNavigationRuleExplicit(Direction : unreal.slatecore.EUINavigation, InWidget : unreal.umg.UWidget) : Void;
  ...
  **/
  @:ufunction(BlueprintCallable) @:final public function SetNavigationRuleCustom(Direction : unreal.slatecore.EUINavigation, InCustomDelegate : unreal.umg.FCustomWidgetNavigationDelegate) : Void;
  ...
  /**
    ...
    @param InCustomDelegate Custom Delegate that will be called
  **/
  @:ufunction(BlueprintCallable) @:final public function SetNavigationRuleCustomBoundary(Direction : unreal.slatecore.EUINavigation, InCustomDelegate : unreal.umg.FCustomWidgetNavigationDelegate) : Void;
  ...
  **/
  ...
  @:ufunction(BlueprintCallable) @:thisConst @:final public function GetTickSpaceGeometry() : unreal.Const<unreal.PRef<unreal.slatecore.FGeometry>>;
  @:ufunction(BlueprintCallable) @:thisConst @:final public function GetPaintSpaceGeometry() : unreal.Const<unreal.PRef<unreal.slatecore.FGeometry>>;
  ...
  **/
  @:ufunction(BlueprintCallable) @:thisConst @:final public function GetAccessibleText() : unreal.FText;
  ...
  /**
    ...
    accessibility is dsabled or the underlying accessible widget is invalid.
  **/
  @:ufunction(BlueprintCallable) @:thisConst @:final public function GetAccessibleSummaryText() : unreal.FText;
