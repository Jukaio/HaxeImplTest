...
package uhx.glues;
@:unrealGlue extern class FCameraShakeStartParams_Glue {
public static function get_bIsRestarting(self:unreal.VariantPtr):Bool;
public static function set_bIsRestarting(self:unreal.VariantPtr, value:Bool):Void;
