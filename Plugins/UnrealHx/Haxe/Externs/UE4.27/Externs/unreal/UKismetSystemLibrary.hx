...
@:uextern @:uclass extern class UKismetSystemLibrary extends unreal.UBlueprintFunctionLibrary {
  ...
  **/
  @:ufunction(BlueprintCallable) static public function GetSystemPath(Object : unreal.Const<unreal.UObject>) : unreal.FString;
  ...
  **/
  @:ufunction(BlueprintCallable) static public function GetPlatformUserDir() : unreal.FString;
  @:ufunction(BlueprintCallable) static public function DoesImplementInterface(TestObject : unreal.Const<unreal.UObject>, Interface : unreal.TSubclassOf<unreal.IInterface>) : Bool;
  ...
  **/
  @:ufunction(BlueprintCallable) static public function GetGameTimeInSeconds(WorldContextObject : unreal.Const<unreal.UObject>) : unreal.Float32;
  
  /**
    Returns the value of GFrameCounter, a running count of the number of frames that have occurred.
  **/
  @:ufunction(BlueprintCallable) static public function GetFrameCount() : unreal.Int64;
  
  /**
    Returns whether the world this object is in is the host or not
  **/
  @:ufunction(BlueprintCallable) static public function IsServer(WorldContextObject : unreal.Const<unreal.UObject>) : Bool;
  
  /**
    Returns whether this is running on a dedicated server
  **/
  @:ufunction(BlueprintCallable) static public function IsDedicatedServer(WorldContextObject : unreal.Const<unreal.UObject>) : Bool;
  
  /**
    Returns whether this game instance is stand alone (no networking).
  **/
  @:ufunction(BlueprintCallable) static public function IsStandalone(WorldContextObject : unreal.Const<unreal.UObject>) : Bool;
  
  /**
    Returns whether we're currently running in split screen (more than one local player).
  **/
  @:ufunction(BlueprintCallable) static public function IsSplitScreen(WorldContextObject : unreal.Const<unreal.UObject>) : Bool;
  ...
  **/
  @:ufunction(BlueprintCallable) static public function PrintString(WorldContextObject : unreal.Const<unreal.UObject>, @:opt("Hello") InString : unreal.FString, bPrintToScreen : Bool = true, bPrintToLog : Bool = true, @:opt("(R=0.000000,G=0.660000,B=1.000000,A=1.000000)") TextColor : unreal.FLinearColor, Duration : unreal.Float32 = 2.000000) : Void;
  ...
  /**
    ...
    @param       Duration                The display duration (if Print to Screen is True). Using negative number will result in loading the duration time from the config.
  **/
  @:ufunction(BlueprintCallable) static public function PrintText(WorldContextObject : unreal.Const<unreal.UObject>, @:opt("INVTEXT(\"Hello\")") InText : unreal.Const<unreal.FText>, bPrintToScreen : Bool = true, bPrintToLog : Bool = true, @:opt("(R=0.000000,G=0.660000,B=1.000000,A=1.000000)") TextColor : unreal.FLinearColor, Duration : unreal.Float32 = 2.000000) : Void;
  ...
  **/
  @:ufunction(BlueprintCallable) static public function ExecuteConsoleCommand(WorldContextObject : unreal.Const<unreal.UObject>, Command : unreal.FString, @:opt("None") SpecificPlayer : unreal.APlayerController) : Void;
  ...
  **/
  @:ufunction(BlueprintCallable) static public function QuitGame(WorldContextObject : unreal.Const<unreal.UObject>, SpecificPlayer : unreal.APlayerController, QuitPreference : unreal.EQuitPreference, bIgnorePlatformRestrictions : Bool) : Void;
  #if WITH_EDITOR
  
  /**
    Exit the editor
  **/
  @:ufunction(BlueprintCallable) static public function QuitEditor() : Void;
  #end // WITH_EDITOR
  ...
  **/
  @:ufunction(BlueprintCallable) static public function Delay(WorldContextObject : unreal.Const<unreal.UObject>, @:bpopt("0.2") Duration : unreal.Float32, @:bpopt("LatentInfo") LatentInfo : unreal.FLatentActionInfo) : Void;
  ...
  /**
    ...
    @param LatentInfo    The latent action.
  **/
  @:ufunction(BlueprintCallable) static public function RetriggerableDelay(WorldContextObject : unreal.Const<unreal.UObject>, @:bpopt("0.2") Duration : unreal.Float32, @:bpopt("LatentInfo") LatentInfo : unreal.FLatentActionInfo) : Void;
  ...
  **/
  @:ufunction(BlueprintCallable) static public function K2_SetTimerDelegate(Delegate : unreal.FTimerDynamicDelegate, Time : unreal.Float32, bLooping : Bool, InitialStartDelay : unreal.Float32 = 0.000000, InitialStartDelayVariance : unreal.Float32 = 0.000000) : unreal.FTimerHandle;
  ...
  **/
  @:ufunction(BlueprintCallable) static public function K2_ClearTimerHandle(WorldContextObject : unreal.Const<unreal.UObject>, Handle : unreal.FTimerHandle) : Void;
  
  /**
    Clears a set timer.
    @param Handle                The handle of the timer to clear.
  **/
  @:ufunction(BlueprintCallable) static public function K2_ClearAndInvalidateTimerHandle(WorldContextObject : unreal.Const<unreal.UObject>, Handle : unreal.PRef<unreal.FTimerHandle>) : Void;
  
  /**
    Pauses a set timer at its current elapsed time.
    @param Handle                The handle of the timer to pause.
  **/
  @:ufunction(BlueprintCallable) static public function K2_PauseTimerHandle(WorldContextObject : unreal.Const<unreal.UObject>, Handle : unreal.FTimerHandle) : Void;
  
  /**
    Resumes a paused timer from its current elapsed time.
    @param Handle                The handle of the timer to unpause.
  **/
  @:ufunction(BlueprintCallable) static public function K2_UnPauseTimerHandle(WorldContextObject : unreal.Const<unreal.UObject>, Handle : unreal.FTimerHandle) : Void;
  ...
  /**
    ...
    @return                              True if the timer exists and is active.
  **/
  @:ufunction(BlueprintCallable) static public function K2_IsTimerActiveHandle(WorldContextObject : unreal.Const<unreal.UObject>, Handle : unreal.FTimerHandle) : Bool;
  ...
  /**
    ...
    @return                              True if the timer exists and is paused.
  **/
  @:ufunction(BlueprintCallable) static public function K2_IsTimerPausedHandle(WorldContextObject : unreal.Const<unreal.UObject>, Handle : unreal.FTimerHandle) : Bool;
  ...
  /**
    ...
    @return                              True if the timer exists.
  **/
  @:ufunction(BlueprintCallable) static public function K2_TimerExistsHandle(WorldContextObject : unreal.Const<unreal.UObject>, Handle : unreal.FTimerHandle) : Bool;
  ...
  /**
    ...
    @return                              How long has elapsed since the current iteration of the timer began.
  **/
  @:ufunction(BlueprintCallable) static public function K2_GetTimerElapsedTimeHandle(WorldContextObject : unreal.Const<unreal.UObject>, Handle : unreal.FTimerHandle) : unreal.Float32;
  ...
  /**
    ...
    @return                              How long is remaining in the current iteration of the timer.
  **/
  @:ufunction(BlueprintCallable) static public function K2_GetTimerRemainingTimeHandle(WorldContextObject : unreal.Const<unreal.UObject>, Handle : unreal.FTimerHandle) : unreal.Float32;
  ...
  /**
    ...
    @return                                                      The timer handle to pass to other timer functions to manipulate this timer.
  **/
  @:ufunction(BlueprintCallable) static public function K2_SetTimer(Object : unreal.UObject, FunctionName : unreal.FString, Time : unreal.Float32, bLooping : Bool, InitialStartDelay : unreal.Float32 = 0.000000, InitialStartDelayVariance : unreal.Float32 = 0.000000) : unreal.FTimerHandle;
  ...
  **/
  @:ufunction(BlueprintCallable) static public function SetColorPropertyByName(Object : unreal.UObject, PropertyName : unreal.FName, Value : unreal.Const<unreal.PRef<unreal.FColor>>) : Void;
  ...
  **/
  @:ufunction(BlueprintCallable) static public function LineTraceSingle(WorldContextObject : unreal.Const<unreal.UObject>, Start : unreal.Const<unreal.FVector>, End : unreal.Const<unreal.FVector>, TraceChannel : unreal.ETraceTypeQuery, bTraceComplex : Bool, ActorsToIgnore : unreal.Const<unreal.PRef<unreal.TArray<unreal.AActor>>>, DrawDebugType : unreal.EDrawDebugTrace, OutHit : unreal.PRef<unreal.FHitResult>, @:bpopt("true") bIgnoreSelf : Bool, @:opt("(R=1.000000,G=0.000000,B=0.000000,A=1.000000)") TraceColor : unreal.FLinearColor, @:opt("(R=0.000000,G=1.000000,B=0.000000,A=1.000000)") TraceHitColor : unreal.FLinearColor, DrawTime : unreal.Float32 = 5.000000) : Bool;
  ...
  **/
  @:ufunction(BlueprintCallable) static public function LineTraceMulti(WorldContextObject : unreal.Const<unreal.UObject>, Start : unreal.Const<unreal.FVector>, End : unreal.Const<unreal.FVector>, TraceChannel : unreal.ETraceTypeQuery, bTraceComplex : Bool, ActorsToIgnore : unreal.Const<unreal.PRef<unreal.TArray<unreal.AActor>>>, DrawDebugType : unreal.EDrawDebugTrace, OutHits : unreal.PRef<unreal.TArray<unreal.FHitResult>>, @:bpopt("true") bIgnoreSelf : Bool, @:opt("(R=1.000000,G=0.000000,B=0.000000,A=1.000000)") TraceColor : unreal.FLinearColor, @:opt("(R=0.000000,G=1.000000,B=0.000000,A=1.000000)") TraceHitColor : unreal.FLinearColor, DrawTime : unreal.Float32 = 5.000000) : Bool;
  ...
  /**
    ...
    @return                              True if there was a hit, false otherwise.
  **/
  @:ufunction(BlueprintCallable) static public function SphereTraceSingle(WorldContextObject : unreal.Const<unreal.UObject>, Start : unreal.Const<unreal.FVector>, End : unreal.Const<unreal.FVector>, Radius : unreal.Float32, TraceChannel : unreal.ETraceTypeQuery, bTraceComplex : Bool, ActorsToIgnore : unreal.Const<unreal.PRef<unreal.TArray<unreal.AActor>>>, DrawDebugType : unreal.EDrawDebugTrace, OutHit : unreal.PRef<unreal.FHitResult>, @:bpopt("true") bIgnoreSelf : Bool, @:opt("(R=1.000000,G=0.000000,B=0.000000,A=1.000000)") TraceColor : unreal.FLinearColor, @:opt("(R=0.000000,G=1.000000,B=0.000000,A=1.000000)") TraceHitColor : unreal.FLinearColor, DrawTime : unreal.Float32 = 5.000000) : Bool;
  ...
  /**
    ...
    @return                              True if there was a blocking hit, false otherwise.
  **/
  @:ufunction(BlueprintCallable) static public function SphereTraceMulti(WorldContextObject : unreal.Const<unreal.UObject>, Start : unreal.Const<unreal.FVector>, End : unreal.Const<unreal.FVector>, Radius : unreal.Float32, TraceChannel : unreal.ETraceTypeQuery, bTraceComplex : Bool, ActorsToIgnore : unreal.Const<unreal.PRef<unreal.TArray<unreal.AActor>>>, DrawDebugType : unreal.EDrawDebugTrace, OutHits : unreal.PRef<unreal.TArray<unreal.FHitResult>>, @:bpopt("true") bIgnoreSelf : Bool, @:opt("(R=1.000000,G=0.000000,B=0.000000,A=1.000000)") TraceColor : unreal.FLinearColor, @:opt("(R=0.000000,G=1.000000,B=0.000000,A=1.000000)") TraceHitColor : unreal.FLinearColor, DrawTime : unreal.Float32 = 5.000000) : Bool;
  ...
  /**
    ...
    @return                               True if there was a hit, false otherwise.
  **/
  @:ufunction(BlueprintCallable) static public function BoxTraceSingle(WorldContextObject : unreal.Const<unreal.UObject>, Start : unreal.Const<unreal.FVector>, End : unreal.Const<unreal.FVector>, HalfSize : unreal.Const<unreal.FVector>, Orientation : unreal.Const<unreal.FRotator>, TraceChannel : unreal.ETraceTypeQuery, bTraceComplex : Bool, ActorsToIgnore : unreal.Const<unreal.PRef<unreal.TArray<unreal.AActor>>>, DrawDebugType : unreal.EDrawDebugTrace, OutHit : unreal.PRef<unreal.FHitResult>, @:bpopt("true") bIgnoreSelf : Bool, @:opt("(R=1.000000,G=0.000000,B=0.000000,A=1.000000)") TraceColor : unreal.FLinearColor, @:opt("(R=0.000000,G=1.000000,B=0.000000,A=1.000000)") TraceHitColor : unreal.FLinearColor, DrawTime : unreal.Float32 = 5.000000) : Bool;
  ...
  /**
    ...
    @return                               True if there was a blocking hit, false otherwise.
  **/
  @:ufunction(BlueprintCallable) static public function BoxTraceMulti(WorldContextObject : unreal.Const<unreal.UObject>, Start : unreal.Const<unreal.FVector>, End : unreal.Const<unreal.FVector>, HalfSize : unreal.FVector, Orientation : unreal.Const<unreal.FRotator>, TraceChannel : unreal.ETraceTypeQuery, bTraceComplex : Bool, ActorsToIgnore : unreal.Const<unreal.PRef<unreal.TArray<unreal.AActor>>>, DrawDebugType : unreal.EDrawDebugTrace, OutHits : unreal.PRef<unreal.TArray<unreal.FHitResult>>, @:bpopt("true") bIgnoreSelf : Bool, @:opt("(R=1.000000,G=0.000000,B=0.000000,A=1.000000)") TraceColor : unreal.FLinearColor, @:opt("(R=0.000000,G=1.000000,B=0.000000,A=1.000000)") TraceHitColor : unreal.FLinearColor, DrawTime : unreal.Float32 = 5.000000) : Bool;
  ...
  /**
    ...
    @return                              True if there was a hit, false otherwise.
  **/
  @:ufunction(BlueprintCallable) static public function CapsuleTraceSingle(WorldContextObject : unreal.Const<unreal.UObject>, Start : unreal.Const<unreal.FVector>, End : unreal.Const<unreal.FVector>, Radius : unreal.Float32, HalfHeight : unreal.Float32, TraceChannel : unreal.ETraceTypeQuery, bTraceComplex : Bool, ActorsToIgnore : unreal.Const<unreal.PRef<unreal.TArray<unreal.AActor>>>, DrawDebugType : unreal.EDrawDebugTrace, OutHit : unreal.PRef<unreal.FHitResult>, @:bpopt("true") bIgnoreSelf : Bool, @:opt("(R=1.000000,G=0.000000,B=0.000000,A=1.000000)") TraceColor : unreal.FLinearColor, @:opt("(R=0.000000,G=1.000000,B=0.000000,A=1.000000)") TraceHitColor : unreal.FLinearColor, DrawTime : unreal.Float32 = 5.000000) : Bool;
  ...
  /**
    ...
    @return                              True if there was a blocking hit, false otherwise.
  **/
  @:ufunction(BlueprintCallable) static public function CapsuleTraceMulti(WorldContextObject : unreal.Const<unreal.UObject>, Start : unreal.Const<unreal.FVector>, End : unreal.Const<unreal.FVector>, Radius : unreal.Float32, HalfHeight : unreal.Float32, TraceChannel : unreal.ETraceTypeQuery, bTraceComplex : Bool, ActorsToIgnore : unreal.Const<unreal.PRef<unreal.TArray<unreal.AActor>>>, DrawDebugType : unreal.EDrawDebugTrace, OutHits : unreal.PRef<unreal.TArray<unreal.FHitResult>>, @:bpopt("true") bIgnoreSelf : Bool, @:opt("(R=1.000000,G=0.000000,B=0.000000,A=1.000000)") TraceColor : unreal.FLinearColor, @:opt("(R=0.000000,G=1.000000,B=0.000000,A=1.000000)") TraceHitColor : unreal.FLinearColor, DrawTime : unreal.Float32 = 5.000000) : Bool;
  ...
  /**
    ...
    @return                               True if there was a hit, false otherwise.
  **/
  @:ufunction(BlueprintCallable) static public function LineTraceSingleByProfile(WorldContextObject : unreal.Const<unreal.UObject>, Start : unreal.Const<unreal.FVector>, End : unreal.Const<unreal.FVector>, ProfileName : unreal.FName, bTraceComplex : Bool, ActorsToIgnore : unreal.Const<unreal.PRef<unreal.TArray<unreal.AActor>>>, DrawDebugType : unreal.EDrawDebugTrace, OutHit : unreal.PRef<unreal.FHitResult>, @:bpopt("true") bIgnoreSelf : Bool, @:opt("(R=1.000000,G=0.000000,B=0.000000,A=1.000000)") TraceColor : unreal.FLinearColor, @:opt("(R=0.000000,G=1.000000,B=0.000000,A=1.000000)") TraceHitColor : unreal.FLinearColor, DrawTime : unreal.Float32 = 5.000000) : Bool;
  ...
  /**
    ...
    @return                               True if there was a blocking hit, false otherwise.
  **/
  @:ufunction(BlueprintCallable) static public function LineTraceMultiByProfile(WorldContextObject : unreal.Const<unreal.UObject>, Start : unreal.Const<unreal.FVector>, End : unreal.Const<unreal.FVector>, ProfileName : unreal.FName, bTraceComplex : Bool, ActorsToIgnore : unreal.Const<unreal.PRef<unreal.TArray<unreal.AActor>>>, DrawDebugType : unreal.EDrawDebugTrace, OutHits : unreal.PRef<unreal.TArray<unreal.FHitResult>>, @:bpopt("true") bIgnoreSelf : Bool, @:opt("(R=1.000000,G=0.000000,B=0.000000,A=1.000000)") TraceColor : unreal.FLinearColor, @:opt("(R=0.000000,G=1.000000,B=0.000000,A=1.000000)") TraceHitColor : unreal.FLinearColor, DrawTime : unreal.Float32 = 5.000000) : Bool;
  ...
  /**
    ...
    @return                               True if there was a hit, false otherwise.
  **/
  @:ufunction(BlueprintCallable) static public function SphereTraceSingleByProfile(WorldContextObject : unreal.Const<unreal.UObject>, Start : unreal.Const<unreal.FVector>, End : unreal.Const<unreal.FVector>, Radius : unreal.Float32, ProfileName : unreal.FName, bTraceComplex : Bool, ActorsToIgnore : unreal.Const<unreal.PRef<unreal.TArray<unreal.AActor>>>, DrawDebugType : unreal.EDrawDebugTrace, OutHit : unreal.PRef<unreal.FHitResult>, @:bpopt("true") bIgnoreSelf : Bool, @:opt("(R=1.000000,G=0.000000,B=0.000000,A=1.000000)") TraceColor : unreal.FLinearColor, @:opt("(R=0.000000,G=1.000000,B=0.000000,A=1.000000)") TraceHitColor : unreal.FLinearColor, DrawTime : unreal.Float32 = 5.000000) : Bool;
  ...
  /**
    ...
    @return                               True if there was a blocking hit, false otherwise.
  **/
  @:ufunction(BlueprintCallable) static public function SphereTraceMultiByProfile(WorldContextObject : unreal.Const<unreal.UObject>, Start : unreal.Const<unreal.FVector>, End : unreal.Const<unreal.FVector>, Radius : unreal.Float32, ProfileName : unreal.FName, bTraceComplex : Bool, ActorsToIgnore : unreal.Const<unreal.PRef<unreal.TArray<unreal.AActor>>>, DrawDebugType : unreal.EDrawDebugTrace, OutHits : unreal.PRef<unreal.TArray<unreal.FHitResult>>, @:bpopt("true") bIgnoreSelf : Bool, @:opt("(R=1.000000,G=0.000000,B=0.000000,A=1.000000)") TraceColor : unreal.FLinearColor, @:opt("(R=0.000000,G=1.000000,B=0.000000,A=1.000000)") TraceHitColor : unreal.FLinearColor, DrawTime : unreal.Float32 = 5.000000) : Bool;
  ...
  /**
    ...
    @return                               True if there was a hit, false otherwise.
  **/
  @:ufunction(BlueprintCallable) static public function BoxTraceSingleByProfile(WorldContextObject : unreal.Const<unreal.UObject>, Start : unreal.Const<unreal.FVector>, End : unreal.Const<unreal.FVector>, HalfSize : unreal.Const<unreal.FVector>, Orientation : unreal.Const<unreal.FRotator>, ProfileName : unreal.FName, bTraceComplex : Bool, ActorsToIgnore : unreal.Const<unreal.PRef<unreal.TArray<unreal.AActor>>>, DrawDebugType : unreal.EDrawDebugTrace, OutHit : unreal.PRef<unreal.FHitResult>, @:bpopt("true") bIgnoreSelf : Bool, @:opt("(R=1.000000,G=0.000000,B=0.000000,A=1.000000)") TraceColor : unreal.FLinearColor, @:opt("(R=0.000000,G=1.000000,B=0.000000,A=1.000000)") TraceHitColor : unreal.FLinearColor, DrawTime : unreal.Float32 = 5.000000) : Bool;
  ...
  /**
    ...
    @return                               True if there was a blocking hit, false otherwise.
  **/
  @:ufunction(BlueprintCallable) static public function BoxTraceMultiByProfile(WorldContextObject : unreal.Const<unreal.UObject>, Start : unreal.Const<unreal.FVector>, End : unreal.Const<unreal.FVector>, HalfSize : unreal.FVector, Orientation : unreal.Const<unreal.FRotator>, ProfileName : unreal.FName, bTraceComplex : Bool, ActorsToIgnore : unreal.Const<unreal.PRef<unreal.TArray<unreal.AActor>>>, DrawDebugType : unreal.EDrawDebugTrace, OutHits : unreal.PRef<unreal.TArray<unreal.FHitResult>>, @:bpopt("true") bIgnoreSelf : Bool, @:opt("(R=1.000000,G=0.000000,B=0.000000,A=1.000000)") TraceColor : unreal.FLinearColor, @:opt("(R=0.000000,G=1.000000,B=0.000000,A=1.000000)") TraceHitColor : unreal.FLinearColor, DrawTime : unreal.Float32 = 5.000000) : Bool;
  ...
  /**
    ...
    @return                               True if there was a hit, false otherwise.
  **/
  @:ufunction(BlueprintCallable) static public function CapsuleTraceSingleByProfile(WorldContextObject : unreal.Const<unreal.UObject>, Start : unreal.Const<unreal.FVector>, End : unreal.Const<unreal.FVector>, Radius : unreal.Float32, HalfHeight : unreal.Float32, ProfileName : unreal.FName, bTraceComplex : Bool, ActorsToIgnore : unreal.Const<unreal.PRef<unreal.TArray<unreal.AActor>>>, DrawDebugType : unreal.EDrawDebugTrace, OutHit : unreal.PRef<unreal.FHitResult>, @:bpopt("true") bIgnoreSelf : Bool, @:opt("(R=1.000000,G=0.000000,B=0.000000,A=1.000000)") TraceColor : unreal.FLinearColor, @:opt("(R=0.000000,G=1.000000,B=0.000000,A=1.000000)") TraceHitColor : unreal.FLinearColor, DrawTime : unreal.Float32 = 5.000000) : Bool;
  ...
  /**
    ...
    @return                               True if there was a blocking hit, false otherwise.
  **/
  @:ufunction(BlueprintCallable) static public function CapsuleTraceMultiByProfile(WorldContextObject : unreal.Const<unreal.UObject>, Start : unreal.Const<unreal.FVector>, End : unreal.Const<unreal.FVector>, Radius : unreal.Float32, HalfHeight : unreal.Float32, ProfileName : unreal.FName, bTraceComplex : Bool, ActorsToIgnore : unreal.Const<unreal.PRef<unreal.TArray<unreal.AActor>>>, DrawDebugType : unreal.EDrawDebugTrace, OutHits : unreal.PRef<unreal.TArray<unreal.FHitResult>>, @:bpopt("true") bIgnoreSelf : Bool, @:opt("(R=1.000000,G=0.000000,B=0.000000,A=1.000000)") TraceColor : unreal.FLinearColor, @:opt("(R=0.000000,G=1.000000,B=0.000000,A=1.000000)") TraceHitColor : unreal.FLinearColor, DrawTime : unreal.Float32 = 5.000000) : Bool;
  ...
  **/
  ...
  /**
    Draw a debug line
  **/
  @:ufunction(BlueprintCallable) static public function DrawDebugLine(WorldContextObject : unreal.Const<unreal.UObject>, LineStart : unreal.Const<unreal.FVector>, LineEnd : unreal.Const<unreal.FVector>, LineColor : unreal.FLinearColor, Duration : unreal.Float32 = 0.000000, Thickness : unreal.Float32 = 0.000000) : Void;
  
  /**
    Draw a debug circle!
  **/
  @:ufunction(BlueprintCallable) static public function DrawDebugCircle(WorldContextObject : unreal.Const<unreal.UObject>, Center : unreal.FVector, Radius : unreal.Float32, NumSegments : unreal.Int32 = 12, @:opt("(R=1.000000,G=1.000000,B=1.000000,A=1.000000)") LineColor : unreal.FLinearColor, Duration : unreal.Float32 = 0.000000, Thickness : unreal.Float32 = 0.000000, @:opt("0.000000,1.000000,0.000000") YAxis : unreal.FVector, @:opt("0.000000,0.000000,1.000000") ZAxis : unreal.FVector, bDrawAxis : Bool = false) : Void;
  
  /**
    Draw a debug point
  **/
  @:ufunction(BlueprintCallable) static public function DrawDebugPoint(WorldContextObject : unreal.Const<unreal.UObject>, Position : unreal.Const<unreal.FVector>, Size : unreal.Float32, PointColor : unreal.FLinearColor, Duration : unreal.Float32 = 0.000000) : Void;
  
  /**
    Draw directional arrow, pointing from LineStart to LineEnd.
  **/
  @:ufunction(BlueprintCallable) static public function DrawDebugArrow(WorldContextObject : unreal.Const<unreal.UObject>, LineStart : unreal.Const<unreal.FVector>, LineEnd : unreal.Const<unreal.FVector>, ArrowSize : unreal.Float32, LineColor : unreal.FLinearColor, Duration : unreal.Float32 = 0.000000, Thickness : unreal.Float32 = 0.000000) : Void;
  
  /**
    Draw a debug box
  **/
  @:ufunction(BlueprintCallable) static public function DrawDebugBox(WorldContextObject : unreal.Const<unreal.UObject>, Center : unreal.Const<unreal.FVector>, Extent : unreal.FVector, LineColor : unreal.FLinearColor, Rotation : unreal.Const<unreal.FRotator>, Duration : unreal.Float32 = 0.000000, Thickness : unreal.Float32 = 0.000000) : Void;
  
  /**
    Draw a debug coordinate system.
  **/
  @:ufunction(BlueprintCallable) static public function DrawDebugCoordinateSystem(WorldContextObject : unreal.Const<unreal.UObject>, AxisLoc : unreal.Const<unreal.FVector>, AxisRot : unreal.Const<unreal.FRotator>, Scale : unreal.Float32 = 1.000000, Duration : unreal.Float32 = 0.000000, Thickness : unreal.Float32 = 0.000000) : Void;
  
  /**
    Draw a debug sphere
  **/
  @:ufunction(BlueprintCallable) static public function DrawDebugSphere(WorldContextObject : unreal.Const<unreal.UObject>, Center : unreal.Const<unreal.FVector>, Radius : unreal.Float32 = 100.000000, Segments : unreal.Int32 = 12, @:opt("(R=1.000000,G=1.000000,B=1.000000,A=1.000000)") LineColor : unreal.FLinearColor, Duration : unreal.Float32 = 0.000000, Thickness : unreal.Float32 = 0.000000) : Void;
  
  /**
    Draw a debug cylinder
  **/
  @:ufunction(BlueprintCallable) static public function DrawDebugCylinder(WorldContextObject : unreal.Const<unreal.UObject>, Start : unreal.Const<unreal.FVector>, End : unreal.Const<unreal.FVector>, Radius : unreal.Float32 = 100.000000, Segments : unreal.Int32 = 12, @:opt("(R=1.000000,G=1.000000,B=1.000000,A=1.000000)") LineColor : unreal.FLinearColor, Duration : unreal.Float32 = 0.000000, Thickness : unreal.Float32 = 0.000000) : Void;
  
  /**
    Draw a debug cone
  **/
  @:ufunction(BlueprintCallable) static public function DrawDebugCone(WorldContextObject : unreal.Const<unreal.UObject>, Origin : unreal.Const<unreal.FVector>, Direction : unreal.Const<unreal.FVector>, Length : unreal.Float32, AngleWidth : unreal.Float32, AngleHeight : unreal.Float32, NumSides : unreal.Int32, LineColor : unreal.FLinearColor, Duration : unreal.Float32 = 0.000000, Thickness : unreal.Float32 = 0.000000) : Void;
  
  /**
    Draw a debug cone
    Angles are specified in degrees
  **/
  @:ufunction(BlueprintCallable) static public function DrawDebugConeInDegrees(WorldContextObject : unreal.Const<unreal.UObject>, Origin : unreal.Const<unreal.FVector>, Direction : unreal.Const<unreal.FVector>, Length : unreal.Float32 = 100.000000, AngleWidth : unreal.Float32 = 45.000000, AngleHeight : unreal.Float32 = 45.000000, NumSides : unreal.Int32 = 12, @:opt("(R=1.000000,G=1.000000,B=1.000000,A=1.000000)") LineColor : unreal.FLinearColor, Duration : unreal.Float32 = 0.000000, Thickness : unreal.Float32 = 0.000000) : Void;
  
  /**
    Draw a debug capsule
  **/
  @:ufunction(BlueprintCallable) static public function DrawDebugCapsule(WorldContextObject : unreal.Const<unreal.UObject>, Center : unreal.Const<unreal.FVector>, HalfHeight : unreal.Float32, Radius : unreal.Float32, Rotation : unreal.Const<unreal.FRotator>, @:opt("(R=1.000000,G=1.000000,B=1.000000,A=1.000000)") LineColor : unreal.FLinearColor, Duration : unreal.Float32 = 0.000000, Thickness : unreal.Float32 = 0.000000) : Void;
  
  /**
    Draw a debug string at a 3d world location.
  **/
  @:ufunction(BlueprintCallable) static public function DrawDebugString(WorldContextObject : unreal.Const<unreal.UObject>, TextLocation : unreal.Const<unreal.FVector>, Text : unreal.FString, @:opt("None") TestBaseActor : unreal.AActor, @:opt("(R=1.000000,G=1.000000,B=1.000000,A=1.000000)") TextColor : unreal.FLinearColor, Duration : unreal.Float32 = 0.000000) : Void;
  ...
  /**
    ...
    @param WorldContext  World context
  **/
  @:ufunction(BlueprintCallable) static public function FlushDebugStrings(WorldContextObject : unreal.Const<unreal.UObject>) : Void;
  
  /**
    Draws a debug plane.
  **/
  @:ufunction(BlueprintCallable) static public function DrawDebugPlane(WorldContextObject : unreal.Const<unreal.UObject>, PlaneCoordinates : unreal.Const<unreal.PRef<unreal.FPlane>>, Location : unreal.Const<unreal.FVector>, Size : unreal.Float32, @:opt("(R=1.000000,G=1.000000,B=1.000000,A=1.000000)") PlaneColor : unreal.FLinearColor, Duration : unreal.Float32 = 0.000000) : Void;
  ...
  /**
    ...
    @param WorldContext  World context
  **/
  @:ufunction(BlueprintCallable) static public function FlushPersistentDebugLines(WorldContextObject : unreal.Const<unreal.UObject>) : Void;
  
  /**
    Draws a debug frustum.
  **/
  @:ufunction(BlueprintCallable) static public function DrawDebugFrustum(WorldContextObject : unreal.Const<unreal.UObject>, FrustumTransform : unreal.Const<unreal.PRef<unreal.FTransform>>, @:opt("(R=1.000000,G=1.000000,B=1.000000,A=1.000000)") FrustumColor : unreal.FLinearColor, Duration : unreal.Float32 = 0.000000, Thickness : unreal.Float32 = 0.000000) : Void;
  ...
  **/
  @:ufunction(BlueprintCallable) static public function DrawDebugFloatHistoryTransform(WorldContextObject : unreal.Const<unreal.UObject>, FloatHistory : unreal.Const<unreal.PRef<unreal.FDebugFloatHistory>>, DrawTransform : unreal.Const<unreal.PRef<unreal.FTransform>>, DrawSize : unreal.FVector2D, @:opt("(R=1.000000,G=1.000000,B=1.000000,A=1.000000)") DrawColor : unreal.FLinearColor, Duration : unreal.Float32 = 0.000000) : Void;
  
  /**
    Draws a 2D Histogram of size 'DrawSize' based FDebugFloatHistory struct, using DrawLocation for the location in the world, rotation will face camera of first player.
  **/
  @:ufunction(BlueprintCallable) static public function DrawDebugFloatHistoryLocation(WorldContextObject : unreal.Const<unreal.UObject>, FloatHistory : unreal.Const<unreal.PRef<unreal.FDebugFloatHistory>>, DrawLocation : unreal.FVector, DrawSize : unreal.FVector2D, @:opt("(R=1.000000,G=1.000000,B=1.000000,A=1.000000)") DrawColor : unreal.FLinearColor, Duration : unreal.Float32 = 0.000000) : Void;
  ...
  **/
  @:ufunction(BlueprintCallable) static public function ShowPlatformSpecificAchievementsScreen(SpecificPlayer : unreal.Const<unreal.APlayerController>) : Void;
  ...
  **/
  @:ufunction(BlueprintCallable) static public function IsLoggedIn(SpecificPlayer : unreal.Const<unreal.APlayerController>) : Bool;
  ...
  **/
  @:ufunction(BlueprintCallable) static public function SetGamepadsBlockDeviceFeedback(bBlock : Bool) : Void;
  ...
  **/
  @:ufunction(BlueprintCallable) static public function GetGamepadButtonGlyph(ButtonKey : unreal.FString, ControllerIndex : unreal.Int32) : unreal.UTexture2D;
  ...
  **/
  @:ufunction(BlueprintCallable) static public function SetSuppressViewportTransitionMessage(WorldContextObject : unreal.Const<unreal.UObject>, bState : Bool) : Void;
  ...
  **/
  @:ufunction(BlueprintCallable) static public function ParseCommandLine(InCmdLine : unreal.FString, OutTokens : unreal.PRef<unreal.TArray<unreal.FString>>, OutSwitches : unreal.PRef<unreal.TArray<unreal.FString>>, OutParams : unreal.PRef<unreal.TMap<unreal.FString, unreal.FString>>) : Void;
  
  /**
    Returns true if the string has -param in it (do not specify the leading -)
  **/
  @:ufunction(BlueprintCallable) static public function ParseParam(InString : unreal.FString, InParam : unreal.FString) : Bool;
  
  /**
    Returns 'value' if -option=value is in the string
  **/
  @:ufunction(BlueprintCallable) static public function ParseParamValue(InString : unreal.FString, InParam : unreal.FString, OutValue : unreal.PRef<unreal.FString>) : Bool;
  ...
  **/
  @:ufunction(BlueprintCallable) static public function GetEditorProperty(Object : unreal.UObject, PropertyName : unreal.Const<unreal.FName>, PropertyValue : unreal.Int32) : Bool;
  ...
  **/
  @:ufunction(BlueprintCallable) static public function SetEditorProperty(Object : unreal.UObject, PropertyName : unreal.Const<unreal.FName>, PropertyValue : unreal.Int32, ChangeNotifyMode : unreal.Const<unreal.EPropertyAccessChangeNotifyMode>) : Bool;
  #end // WITH_EDITOR
  ...
  **/
  ...
  /**
    ...
    @param       Object          The object that is about to be modified.
  **/
  @:ufunction(BlueprintCallable) static public function SnapshotObject(Object : unreal.UObject) : Void;
