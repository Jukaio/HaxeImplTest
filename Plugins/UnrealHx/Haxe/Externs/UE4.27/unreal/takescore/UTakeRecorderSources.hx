...
@:uextern @:uclass extern class UTakeRecorderSources extends unreal.UObject {
  ...
  **/
  @:ufunction(BlueprintCallable) @:final public function StartRecordingSource(InSources : unreal.TArray<unreal.takescore.UTakeRecorderSource>, CurrentFrameTime : unreal.Const<unreal.PRef<unreal.FQualifiedFrameTime>>) : Void;
