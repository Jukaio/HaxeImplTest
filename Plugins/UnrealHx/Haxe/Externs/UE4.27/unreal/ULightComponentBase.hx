...
@:uextern @:uclass extern class ULightComponentBase extends unreal.USceneComponent {
  ...
  **/
  @:uproperty public var DeepShadowLayerDistribution : unreal.Float32;
  
  /**
    Whether the light affects global illumination, when ray-traced global illumination is enabled.
  **/
  @:uproperty public var bAffectGlobalIllumination : Bool;
  ...
  **/
  @:uproperty public var bCastDeepShadow : Bool;
  ...
  **/
  ...
  @:ufunction(BlueprintCallable) @:final public function SetCastDeepShadow(bNewValue : Bool) : Void;
  @:ufunction(BlueprintCallable) @:final public function SetAffectReflection(bNewValue : Bool) : Void;
  @:ufunction(BlueprintCallable) @:final public function SetAffectGlobalIllumination(bNewValue : Bool) : Void;
