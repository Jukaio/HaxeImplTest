...
@:uextern @:uclass extern class UProjectPackagingSettings extends unreal.UObject {
  ...
  **/
  @:uproperty public var TestDirectoriesToNotSearch : unreal.TArray<unreal.FDirectoryPath>;
  ...
  **/
  @:uproperty public var IniSectionBlacklist : unreal.TArray<unreal.FString>;
  
  /**
    List of ini file keys to strip when packaging
  **/
  @:uproperty public var IniKeyBlacklist : unreal.TArray<unreal.FString>;
  ...
  **/
  @:uproperty public var LocalizationTargetCatchAllChunkId : unreal.Int32;
  
  /**
    List of localization targets that should be chunked during cooking (if using chunks)
  **/
  @:uproperty public var LocalizationTargetsToChunk : unreal.TArray<unreal.FString>;
  ...
  **/
  @:uproperty public var bDeterministicShaderCodeOrder : Bool;
  ...
  **/
  ...
  @:uproperty public var PakFileCompressionLevel_Distribution : unreal.Int32;
  @:uproperty public var PakFileCompressionLevel_TestShipping : unreal.Int32;
  ...
  **/
  @:uproperty public var PakFileCompressionLevel_DebugDevelopment : unreal.Int32;
  
  /**
    For compressors with multiple methods, select one.  eg. for Oodle you may use one of {Kraken,Mermaid,Selkie,Leviathan}
  **/
  @:uproperty public var PakFileCompressionMethod : unreal.FString;
  ...
  **/
  @:uproperty public var bForceUseProjectCompressionFormatIgnoreHardwareOverride : Bool;
  ...
  **/
  @:uproperty public var bMakeBinaryConfig : Bool;
  
  /**
    If enabled, all packages will be put into one or more container files.
  **/
  @:uproperty public var bUseIoStore : Bool;
  ...
  **/
  @:uproperty public var BuildTarget : unreal.FString;
