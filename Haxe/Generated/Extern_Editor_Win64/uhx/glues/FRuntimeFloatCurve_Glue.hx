...
package uhx.glues;
@:unrealGlue extern class FRuntimeFloatCurve_Glue {
public static function get_ExternalCurve(self:unreal.VariantPtr):unreal.UIntPtr;
public static function set_ExternalCurve(self:unreal.VariantPtr, value:unreal.UIntPtr):Void;
public static function get_EditorCurveData(self:unreal.VariantPtr):unreal.VariantPtr;
public static function set_EditorCurveData(self:unreal.VariantPtr, value:unreal.VariantPtr):Void;
