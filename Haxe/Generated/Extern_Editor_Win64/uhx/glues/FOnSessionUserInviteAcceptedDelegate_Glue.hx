...
package uhx.glues;
@:unrealGlue extern class FOnSessionUserInviteAcceptedDelegate_Glue {
...
public static function Execute(self:unreal.VariantPtr, arg_0:Bool, arg_1:Int, arg_2:unreal.VariantPtr, arg_3:unreal.VariantPtr):Void;
public static function ExecuteIfBound(self:unreal.VariantPtr, arg_0:Bool, arg_1:Int, arg_2:unreal.VariantPtr, arg_3:unreal.VariantPtr):Void;
