...
@:uextern @:uclass extern class UKismetRenderingLibrary extends unreal.UBlueprintFunctionLibrary {
  ...
  **/
  @:ufunction(BlueprintCallable) static public function CreateRenderTarget2D(WorldContextObject : unreal.UObject, Width : unreal.Int32 = 256, Height : unreal.Int32 = 256, Format : unreal.ETextureRenderTargetFormat = RTF_RGBA16f, @:opt("(R=0.000000,G=0.000000,B=0.000000,A=1.000000)") ClearColor : unreal.FLinearColor, bAutoGenerateMipMaps : Bool = false) : unreal.UTextureRenderTarget2D;
  
  /**
    Creates a new render target array and initializes it to the specified dimensions
  **/
  @:ufunction(BlueprintCallable) static public function CreateRenderTarget2DArray(WorldContextObject : unreal.UObject, Width : unreal.Int32 = 256, Height : unreal.Int32 = 256, Slices : unreal.Int32 = 1, Format : unreal.ETextureRenderTargetFormat = RTF_RGBA16f, @:opt("(R=0.000000,G=0.000000,B=0.000000,A=1.000000)") ClearColor : unreal.FLinearColor, bAutoGenerateMipMaps : Bool = false) : unreal.UTextureRenderTarget2DArray;
  
  /**
    Creates a new volume render target and initializes it to the specified dimensions
  **/
  @:ufunction(BlueprintCallable) static public function CreateRenderTargetVolume(WorldContextObject : unreal.UObject, Width : unreal.Int32 = 16, Height : unreal.Int32 = 16, Depth : unreal.Int32 = 16, Format : unreal.ETextureRenderTargetFormat = RTF_RGBA16f, @:opt("(R=0.000000,G=0.000000,B=0.000000,A=1.000000)") ClearColor : unreal.FLinearColor, bAutoGenerateMipMaps : Bool = false) : unreal.UTextureRenderTargetVolume;
  ...
  **/
  @:ufunction(BlueprintCallable) static public function SetCastInsetShadowForAllAttachments(PrimitiveComponent : unreal.UPrimitiveComponent, bCastInsetShadow : Bool, bLightAttachmentsAsGroup : Bool) : Void;
