// Ver:1
// GeneratedBy:c:\users\jukai\documents\unreal projects\haxetest\plugins\unrealhx/haxe/externs/ue4.27/unreal/umg/usizeboxslot.hx
package unreal.umg;
/**
...
@:uextern
@:uclass
@:ueGluePath("uhx.glues.USizeBoxSlot_Glue")
#if (cppia && !LIVE_RELOAD_BUILD && !macro) @:build(uhx.compiletime.types.CompiledMetaCheck.build("unreal.umg.USizeBoxSlot")) #end
class USizeBoxSlot #if !macro extends unreal.umg.UPanelSlot #end {
  #if !macro 
  /**
  ...
  **/
  ...
  static function __init__():Void {
    ...
    uhx.ue.ClassMap.addWrapper(uhx.glues.USizeBoxSlot_Glue.StaticClass(), func);
    #else
    uhx.runtime.Helpers.addCppiaExternWrapper("SizeBoxSlot", "unreal.umg.USizeBoxSlot");
    #end
  }
  
  #if !cppia
  static function wrapPointer(uobject:unreal.UIntPtr):unreal.UIntPtr {
    return uhx.internal.HaxeHelpers.dynamicToPointer(new unreal.umg.USizeBoxSlot(uobject));
  }
  #end
  inline public static function wrap(uobject:unreal.UIntPtr):unreal.umg.USizeBoxSlot {
  ...
  @:glueCppCode("int uhx::glues::USizeBoxSlot_Glue_obj::get_VerticalAlignment(unreal::UIntPtr self) {\n\treturn ( (int) (EVerticalAlignment) ( (USizeBoxSlot *) self )->VerticalAlignment );\n}")
  @:uproperty
  @:final @:nonVirtual 
  @:nonVirtual
  private function get_VerticalAlignment() : unreal.slatecore.EVerticalAlignment {
    ...
    return unreal.slatecore.EVerticalAlignment.EVerticalAlignment_EnumConv.wrap(uhx.glues.USizeBoxSlot_Glue.get_VerticalAlignment(uhx_arg_0));
  ...
  @:glueCppCode("void uhx::glues::USizeBoxSlot_Glue_obj::set_VerticalAlignment(unreal::UIntPtr self, int value) {\n\t( (USizeBoxSlot *) self )->VerticalAlignment = ( (EVerticalAlignment) value );\n}")
  @:uproperty
  @:final @:nonVirtual 
  @:nonVirtual
  @:final @:nonVirtual 
  ...
  private function set_VerticalAlignment(value : unreal.slatecore.EVerticalAlignment) : unreal.slatecore.EVerticalAlignment {
    ...
    uhx.glues.USizeBoxSlot_Glue.set_VerticalAlignment(uhx_arg_0, uhx_arg_1);
    return value;
  ...
  @:glueCppCode("int uhx::glues::USizeBoxSlot_Glue_obj::get_HorizontalAlignment(unreal::UIntPtr self) {\n\treturn ( (int) (EHorizontalAlignment) ( (USizeBoxSlot *) self )->HorizontalAlignment );\n}")
  @:uproperty
  @:final @:nonVirtual 
  @:nonVirtual
  private function get_HorizontalAlignment() : unreal.slatecore.EHorizontalAlignment {
    ...
    #else
    var uhx_arg_0:unreal.UIntPtr = uhx.internal.HaxeHelpers.getUObjectWrapped(this);
    return unreal.slatecore.EHorizontalAlignment.EHorizontalAlignment_EnumConv.wrap(uhx.glues.USizeBoxSlot_Glue.get_HorizontalAlignment(uhx_arg_0));
  ...
  @:glueCppCode("void uhx::glues::USizeBoxSlot_Glue_obj::set_HorizontalAlignment(unreal::UIntPtr self, int value) {\n\t( (USizeBoxSlot *) self )->HorizontalAlignment = ( (EHorizontalAlignment) value );\n}")
  @:uproperty
  @:final @:nonVirtual 
  @:nonVirtual
  @:final @:nonVirtual 
  ...
  private function set_HorizontalAlignment(value : unreal.slatecore.EHorizontalAlignment) : unreal.slatecore.EHorizontalAlignment {
    ...
    uhx.glues.USizeBoxSlot_Glue.set_HorizontalAlignment(uhx_arg_0, uhx_arg_1);
    return value;
  ...
  @:glueCppCode("unreal::VariantPtr uhx::glues::USizeBoxSlot_Glue_obj::get_Padding(unreal::UIntPtr self) {\n\treturn unreal::VariantPtr::fromExternalPointer( (void *) (&(( (USizeBoxSlot *) self )->Padding)) );\n}")
  @:uproperty
  @:final @:nonVirtual 
  @:nonVirtual
  private function get_Padding() : unreal.PPtr<unreal.slatecore.FMargin> {
    ...
    #else
    var uhx_arg_0:unreal.UIntPtr = uhx.internal.HaxeHelpers.getUObjectWrapped(this);
    return ( @:privateAccess unreal.slatecore.FMargin.fromPointer( uhx.glues.USizeBoxSlot_Glue.get_Padding(uhx_arg_0) ) : unreal.PPtr<unreal.slatecore.FMargin> );
  ...
  @:glueCppCode("void uhx::glues::USizeBoxSlot_Glue_obj::set_Padding(unreal::UIntPtr self, unreal::VariantPtr value) {\n\t( (USizeBoxSlot *) self )->Padding = *::uhx::StructHelper< FMargin >::getPointer(value);\n}")
  @:uproperty
  @:final @:nonVirtual 
  @:nonVirtual
  @:final @:nonVirtual 
  ...
  private function set_Padding(value : unreal.slatecore.FMargin) : unreal.slatecore.FMargin {
    ...
    uhx.glues.USizeBoxSlot_Glue.set_Padding(uhx_arg_0, uhx_arg_1);
    return value;
  ...
  @:glueCppCode("void uhx::glues::USizeBoxSlot_Glue_obj::SetPadding(unreal::UIntPtr self, unreal::VariantPtr InPadding) {\n\t( (USizeBoxSlot *) self )->SetPadding(*::uhx::StructHelper< FMargin >::getPointer(InPadding));\n}")
  ...
  public function SetPadding(InPadding : unreal.slatecore.FMargin) : Void {
    ...
    uhx.glues.USizeBoxSlot_Glue.SetPadding(uhx_arg_0, uhx_arg_1);
  ...
  @:glueCppCode("void uhx::glues::USizeBoxSlot_Glue_obj::SetHorizontalAlignment(unreal::UIntPtr self, int InHorizontalAlignment) {\n\t( (USizeBoxSlot *) self )->SetHorizontalAlignment(( (EHorizontalAlignment) InHorizontalAlignment ));\n}")
  @:ufunction(BlueprintCallable)
  @:final @:nonVirtual 
  public function SetHorizontalAlignment(InHorizontalAlignment : unreal.slatecore.EHorizontalAlignment) : Void {
    ...
    uhx.glues.USizeBoxSlot_Glue.SetHorizontalAlignment(uhx_arg_0, uhx_arg_1);
  ...
  @:glueCppCode("void uhx::glues::USizeBoxSlot_Glue_obj::SetVerticalAlignment(unreal::UIntPtr self, int InVerticalAlignment) {\n\t( (USizeBoxSlot *) self )->SetVerticalAlignment(( (EVerticalAlignment) InVerticalAlignment ));\n}")
  @:ufunction(BlueprintCallable)
  @:final @:nonVirtual 
  public function SetVerticalAlignment(InVerticalAlignment : unreal.slatecore.EVerticalAlignment) : Void {
    ...
    uhx.glues.USizeBoxSlot_Glue.SetVerticalAlignment(uhx_arg_0, uhx_arg_1);
  ...
  **/
  ...
  @:glueCppCode("unreal::UIntPtr uhx::glues::USizeBoxSlot_Glue_obj::StaticClass() {\n\treturn ( (unreal::UIntPtr) (USizeBoxSlot::StaticClass()) );\n}")
  @:ifFeature("unreal.umg.USizeBoxSlot.*")
  public static function StaticClass() : unreal.UClass {
    #if cppia
    return uhx.runtime.UReflectionGenerator.getUClass("SizeBoxSlot");
    
    #else
    return ( cast unreal.UObject.wrap(uhx.glues.USizeBoxSlot_Glue.StaticClass()) : unreal.UClass );
