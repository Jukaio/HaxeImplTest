...
package uhx.glues;
@:unrealGlue extern class FModularSynthPresetBankEntry_Glue {
public static function get_Preset(self:unreal.VariantPtr):unreal.VariantPtr;
public static function set_Preset(self:unreal.VariantPtr, value:unreal.VariantPtr):Void;
public static function get_PresetName(self:unreal.VariantPtr):unreal.VariantPtr;
public static function set_PresetName(self:unreal.VariantPtr, value:unreal.VariantPtr):Void;
