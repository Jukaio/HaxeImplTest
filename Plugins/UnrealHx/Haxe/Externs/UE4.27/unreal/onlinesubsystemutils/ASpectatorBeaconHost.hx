...
@:uextern @:uclass extern class ASpectatorBeaconHost extends unreal.onlinesubsystemutils.AOnlineBeaconHostObject {
  ...
  **/
  ...
  /**
    State of the beacon
  **/
  @:uproperty private var State : unreal.onlinesubsystemutils.USpectatorBeaconState;
