...
package uhx.glues;
@:unrealGlue extern class FOnUserControllerConnectionChange_Glue {
...
public static function Broadcast(self:unreal.VariantPtr, arg_0:Bool, arg_1:Int, arg_2:Int):Void;
