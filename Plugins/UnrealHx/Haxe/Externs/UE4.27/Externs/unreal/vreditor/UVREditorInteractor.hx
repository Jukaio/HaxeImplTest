...
@:uextern @:uclass extern class UVREditorInteractor extends unreal.viewportinteraction.UViewportInteractor {
  ...
  **/
  ...
  /**
    Sets the EControllerHand for this motioncontroller
  **/
  @:ufunction(BlueprintCallable) @:thisConst @:final public function GetControllerHandSide() : unreal.FName;
  ...
  **/
  @:ufunction(BlueprintCallable) @:final public function ReplaceHandMeshComponent(NewMesh : unreal.UStaticMesh) : Void;
