...
package uhx.glues;
@:unrealGlue extern class FBehaviorInfo_Glue {
public static function get_Behavior(self:unreal.VariantPtr):unreal.UIntPtr;
public static function set_Behavior(self:unreal.VariantPtr, value:unreal.UIntPtr):Void;
