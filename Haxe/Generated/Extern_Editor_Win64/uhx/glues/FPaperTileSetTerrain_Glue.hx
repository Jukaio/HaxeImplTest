...
package uhx.glues;
@:unrealGlue extern class FPaperTileSetTerrain_Glue {
public static function get_CenterTileIndex(self:unreal.VariantPtr):Int;
public static function set_CenterTileIndex(self:unreal.VariantPtr, value:Int):Void;
public static function get_TerrainName(self:unreal.VariantPtr):unreal.VariantPtr;
public static function set_TerrainName(self:unreal.VariantPtr, value:unreal.VariantPtr):Void;
