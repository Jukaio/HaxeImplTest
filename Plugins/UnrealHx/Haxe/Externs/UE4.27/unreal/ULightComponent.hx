...
@:uextern @:uclass extern class ULightComponent extends unreal.ULightComponentBase {
  ...
  **/
  @:uproperty public var BloomMaxBrightness : unreal.Float32;
  ...
  **/
  @:uproperty public var ShadowSlopeBias : unreal.Float32;
  ...
  **/
  ...
  @:ufunction(BlueprintCallable) @:final public function SetUseTemperature(bNewValue : Bool) : Void;
  ...
  @:ufunction(BlueprintCallable) @:final public function SetBloomMaxBrightness(NewValue : unreal.Float32) : Void;
  ...
  @:ufunction(BlueprintCallable) @:final public function SetShadowSlopeBias(NewValue : unreal.Float32) : Void;
