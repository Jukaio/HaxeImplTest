...
package uhx.glues;
@:unrealGlue extern class FCameraShakeStopParams_Glue {
public static function get_bImmediately(self:unreal.VariantPtr):Bool;
public static function set_bImmediately(self:unreal.VariantPtr, value:Bool):Void;
