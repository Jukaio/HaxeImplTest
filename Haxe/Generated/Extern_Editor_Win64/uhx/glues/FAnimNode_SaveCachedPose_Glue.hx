...
package uhx.glues;
@:unrealGlue extern class FAnimNode_SaveCachedPose_Glue {
...
public static function get_Pose(self:unreal.VariantPtr):unreal.VariantPtr;
public static function set_Pose(self:unreal.VariantPtr, value:unreal.VariantPtr):Void;
