...
package uhx.glues;
@:unrealGlue extern class FAnimNode_PoseByName_Glue {
public static function get_PoseWeight(self:unreal.VariantPtr):cpp.Float32;
public static function set_PoseWeight(self:unreal.VariantPtr, value:cpp.Float32):Void;
