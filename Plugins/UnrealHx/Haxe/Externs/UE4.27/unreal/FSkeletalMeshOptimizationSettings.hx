...
@:noCopy @:noEquals @:uextern @:ustruct extern class FSkeletalMeshOptimizationSettings {
  ...
  **/
  @:uproperty public var bLockColorBounaries : Bool;
  ...
  **/
  @:uproperty public var MaxNumOfVertsPercentage : unreal.FakeUInt32;
  
  /**
    The maximum number of triangles to retain when using percentage termination criterion.
  **/
  @:uproperty public var MaxNumOfTrianglesPercentage : unreal.FakeUInt32;
  #end // WITH_EDITORONLY_DATA
