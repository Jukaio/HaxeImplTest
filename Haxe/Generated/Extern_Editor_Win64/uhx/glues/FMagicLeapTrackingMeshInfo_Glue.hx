...
package uhx.glues;
@:unrealGlue extern class FMagicLeapTrackingMeshInfo_Glue {
public static function get_BlockData(self:unreal.VariantPtr):unreal.VariantPtr;
public static function set_BlockData(self:unreal.VariantPtr, value:unreal.VariantPtr):Void;
