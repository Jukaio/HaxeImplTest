...
package uhx.glues;
@:unrealGlue extern class UParticleModuleAttractorPointGravity_Glue {
public static function get_StrengthRaw(self:unreal.UIntPtr):unreal.VariantPtr;
public static function set_StrengthRaw(self:unreal.UIntPtr, value:unreal.VariantPtr):Void;
public static function get_Strength_DEPRECATED(self:unreal.UIntPtr):unreal.UIntPtr;
public static function set_Strength_DEPRECATED(self:unreal.UIntPtr, value:unreal.UIntPtr):Void;
