...
@:uextern @:uclass extern class UEditorPerProjectUserSettings extends unreal.UObject {
  @:uproperty public var PreviewDeviceProfileName : unreal.FName;
  
  /**
    Is feature level preview currently active
  **/
  @:uproperty public var bPreviewFeatureLevelActive : Bool;
  
  /**
    The shader platform to preview, or NAME_None if there is no preview platform
  **/
  @:uproperty public var PreviewShaderFormatName : unreal.FName;
  
  /**
    The platform name to preview, or NAME_None if there is no preview platform
  **/
  @:uproperty public var PreviewPlatformName : unreal.FName;
  
  /**
    The feature level we should use when loading or creating a new world
  **/
  @:uproperty public var PreviewFeatureLevel : unreal.Int32;
  ...
  **/
  @:uproperty public var bGetAttentionOnUATCompletion : Bool;
  ...
  **/
  @:uproperty public var bDisplayBlackboardKeysInAlphabeticalOrder : Bool;
