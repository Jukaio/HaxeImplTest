...
package uhx.glues;
@:unrealGlue extern class FSplitterStyle_Glue {
public static function get_HandleHighlightBrush(self:unreal.VariantPtr):unreal.VariantPtr;
public static function set_HandleHighlightBrush(self:unreal.VariantPtr, value:unreal.VariantPtr):Void;
public static function get_HandleNormalBrush(self:unreal.VariantPtr):unreal.VariantPtr;
public static function set_HandleNormalBrush(self:unreal.VariantPtr, value:unreal.VariantPtr):Void;
