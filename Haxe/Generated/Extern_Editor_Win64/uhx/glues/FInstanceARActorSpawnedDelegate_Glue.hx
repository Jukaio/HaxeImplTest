...
package uhx.glues;
@:unrealGlue extern class FInstanceARActorSpawnedDelegate_Glue {
public static function create():unreal.VariantPtr;
public static function createNew():unreal.VariantPtr;
public static function Broadcast(self:unreal.VariantPtr, arg_0:unreal.UIntPtr, arg_1:unreal.VariantPtr, arg_2:unreal.UIntPtr):Void;
