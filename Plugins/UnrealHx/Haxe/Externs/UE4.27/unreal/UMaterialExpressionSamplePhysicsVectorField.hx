...
@:noClass @:uextern @:uclass extern class UMaterialExpressionSamplePhysicsVectorField extends unreal.UMaterialExpression {
  
  /**
    Target Type to be accessed
  **/
  @:uproperty public var FieldTarget : unreal.chaos.EFieldVectorType;
