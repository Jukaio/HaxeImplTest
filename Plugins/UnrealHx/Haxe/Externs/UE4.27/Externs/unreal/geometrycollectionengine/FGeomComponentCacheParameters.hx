...
@:noCopy @:noEquals @:uextern @:ustruct extern class FGeomComponentCacheParameters {
  ...
  **/
  @:uproperty public var DoGenerateTrailingData : Bool;
  ...
  **/
  @:uproperty public var DoGenerateBreakingData : Bool;
  
  /**
    Whether to buffer breakings during recording
  **/
  @:uproperty public var SaveBreakingData : Bool;
  ...
  **/
  @:uproperty public var DoGenerateCollisionData : Bool;
  ...
  **/
  ...
  /**
    Cache mode, whether disabled, playing or recording
  **/
  @:uproperty public var CacheMode : unreal.chaos.EGeometryCollectionCacheType;
