...
@:uextern @:uclass extern class UAndroidRuntimeSettings extends unreal.UObject {
  ...
  **/
  @:uproperty public var bEnableDomStorage : Bool;
  ...
  **/
  @:uproperty public var bEnableMaliPerfCounters : Bool;
  ...
  **/
  @:uproperty public var bForceLDLinker : Bool;
  ...
  **/
  @:uproperty public var bAndroidOpenGLSupportsBackbufferSampling : Bool;
  
  /**
    Select a Clang's sanitizer to build the project with
  **/
  @:uproperty public var ClangSanitizer : unreal.androidruntimesettings.EClangSanitizer;
  
  /**
    Enable Vulkan SM5 rendering support
  **/
  @:uproperty public var bSupportsVulkanSM5 : Bool;
  ...
  **/
  @:uproperty public var bBundleDensitySplit : Bool;
  
  /**
    Separate resources by language into their own APK in bundle
  **/
  @:uproperty public var bBundleLanguageSplit : Bool;
  
  /**
    Separate ABIs into their own APK in bundle
  **/
  @:uproperty public var bBundleABISplit : Bool;
  
  /**
    Enables generating universal APK from bundle
  **/
  @:uproperty public var bEnableUniversalAPK : Bool;
  
  /**
    Enables generating AAB bundle
  **/
  @:uproperty public var bEnableBundle : Bool;
  ...
  **/
  @:uproperty public var bRestoreNotificationsOnReboot : Bool;
  ...
  **/
  @:uproperty public var bPublicLogFiles : Bool;
  ...
  **/
  @:uproperty public var bAllowOverflowOBBFiles : Bool;
  ...
  **/
  @:uproperty public var bAllowPatchOBBFile : Bool;
  ...
  **/
  @:uproperty public var bForceSmallOBBFiles : Bool;
  ...
  **/
  @:uproperty public var StoreVersionOffsetX8664 : unreal.Int32;
  
  /**
    Offset to add to store version for APKs generated for arm64
  **/
  @:uproperty public var StoreVersionOffsetArm64 : unreal.Int32;
  
  /**
    Offset to add to store version for APKs generated for armv7
  **/
  @:uproperty public var StoreVersionOffsetArmV7 : unreal.Int32;
