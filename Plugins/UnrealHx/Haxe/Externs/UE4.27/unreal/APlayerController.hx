...
@:uextern @:uclass extern class APlayerController extends unreal.AController {
  ...
  **/
  @:ufunction(Server) public function ServerExecRPC(Msg : unreal.FString) : Void;
  
  /**
    Executes command on server (non shipping builds only)
  **/
  @:ufunction @:final public function ServerExec(Msg : unreal.FString) : Void;
  ...
  **/
  @:ufunction(Client, BlueprintCallable) public function ClientPlayCameraAnim(AnimToPlay : unreal.UCameraAnim, Scale : unreal.Float32 = 1.000000, Rate : unreal.Float32 = 1.000000, BlendInTime : unreal.Float32 = 0.000000, BlendOutTime : unreal.Float32 = 0.000000, bLoop : Bool = false, bRandomStartTime : Bool = false, @:opt("CameraLocal") Space : unreal.ECameraShakePlaySpace, CustomPlaySpace : unreal.FRotator) : Void;
  ...
  **/
  @:ufunction(Client, BlueprintCallable) public function ClientStartCameraShake(Shake : unreal.TSubclassOf<unreal.UCameraShakeBase>, Scale : unreal.Float32 = 1.000000, @:opt("CameraLocal") PlaySpace : unreal.ECameraShakePlaySpace, UserPlaySpaceRot : unreal.FRotator) : Void;
  ...
  **/
  @:ufunction(BlueprintCallable) @:final public function ClientStartCameraShakeFromSource(Shake : unreal.TSubclassOf<unreal.UCameraShakeBase>, SourceComponent : unreal.UCameraShakeSourceComponent) : Void;
  ...
  **/
  @:ufunction(Client) public function ClientSetCameraFade(bEnableFading : Bool, FadeColor : unreal.FColor, FadeAlpha : unreal.FVector2D, FadeTime : unreal.Float32, bFadeAudio : Bool, bHoldWhenFinished : Bool) : Void;
  ...
  **/
  @:ufunction(Client, BlueprintCallable) public function ClientStopCameraShake(Shake : unreal.TSubclassOf<unreal.UCameraShakeBase>, bImmediately : Bool = true) : Void;
  
  /**
    Stop camera shake on client.
  **/
  @:ufunction(BlueprintCallable) @:final public function ClientStopCameraShakesFromSource(SourceComponent : unreal.UCameraShakeSourceComponent, bImmediately : Bool = true) : Void;
  ...
  **/
  @:ufunction(Server) @:final public function ServerUpdateLevelVisibility(LevelVisibility : unreal.Const<unreal.PRef<unreal.FUpdateLevelVisibilityLevelInfo>>) : Void;
