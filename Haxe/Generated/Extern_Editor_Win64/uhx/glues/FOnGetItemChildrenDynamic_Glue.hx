...
package uhx.glues;
@:unrealGlue extern class FOnGetItemChildrenDynamic_Glue {
public static function create():unreal.VariantPtr;
public static function createNew():unreal.VariantPtr;
public static function Execute(self:unreal.VariantPtr, arg_0:unreal.UIntPtr, arg_1:unreal.VariantPtr):Void;
public static function ExecuteIfBound(self:unreal.VariantPtr, arg_0:unreal.UIntPtr, arg_1:unreal.VariantPtr):Void;
