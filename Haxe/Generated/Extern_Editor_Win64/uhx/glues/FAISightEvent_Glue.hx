...
package uhx.glues;
@:unrealGlue extern class FAISightEvent_Glue {
public static function get_Observer(self:unreal.VariantPtr):unreal.UIntPtr;
public static function set_Observer(self:unreal.VariantPtr, value:unreal.UIntPtr):Void;
public static function get_SeenActor(self:unreal.VariantPtr):unreal.UIntPtr;
public static function set_SeenActor(self:unreal.VariantPtr, value:unreal.UIntPtr):Void;
