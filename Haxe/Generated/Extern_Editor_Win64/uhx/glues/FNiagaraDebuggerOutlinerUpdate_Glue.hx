...
package uhx.glues;
@:unrealGlue extern class FNiagaraDebuggerOutlinerUpdate_Glue {
public static function get_OutlinerData(self:unreal.VariantPtr):unreal.VariantPtr;
public static function set_OutlinerData(self:unreal.VariantPtr, value:unreal.VariantPtr):Void;
