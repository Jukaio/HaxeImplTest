...
@:uextern @:ustruct extern class FConstraintInstance extends unreal.FConstraintInstanceBase {
  ...
  **/
  ...
  @:deprecated @:uproperty public var AngularSwing2Motion_DEPRECATED : unreal.physicscore.EAngularConstraintMotion;
  @:deprecated @:uproperty public var AngularTwistMotion_DEPRECATED : unreal.physicscore.EAngularConstraintMotion;
  @:deprecated @:uproperty public var AngularSwing1Motion_DEPRECATED : unreal.physicscore.EAngularConstraintMotion;
  ...
  @:deprecated @:uproperty public var LinearZMotion_DEPRECATED : unreal.physicscore.ELinearConstraintMotion;
  @:deprecated @:uproperty public var LinearYMotion_DEPRECATED : unreal.physicscore.ELinearConstraintMotion;
  @:deprecated @:uproperty public var LinearXMotion_DEPRECATED : unreal.physicscore.ELinearConstraintMotion;
