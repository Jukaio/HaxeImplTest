...
package uhx.glues;
@:unrealGlue extern class USubmixEffectReverbPreset_Glue {
...
public static function SetSettingsWithReverbEffect(self:unreal.UIntPtr, InReverbEffect:unreal.UIntPtr, WetLevel:cpp.Float32, DryLevel:cpp.Float32):Void;
