...
@:uextern @:uclass extern class USkeletalMeshComponent extends unreal.USkinnedMeshComponent implements unreal.IInterface_CollisionDataProvider {
  ...
  **/
  @:uproperty public var bWaitForParallelClothTask : Bool;
  ...
  **/
  @:ufunction(BlueprintCallable) @:final public function GetFloatAttribute_Ref(BoneName : unreal.Const<unreal.PRef<unreal.FName>>, AttributeName : unreal.Const<unreal.PRef<unreal.FName>>, OutValue : unreal.Float32, @:opt("BoneOnly") LookupType : unreal.ECustomBoneAttributeLookup) : Bool;
  ...
  /**
    ...
    @return Whether or not the atttribute was successfully retrieved
  **/
  @:ufunction(BlueprintCallable) @:final public function GetIntegerAttribute_Ref(BoneName : unreal.Const<unreal.PRef<unreal.FName>>, AttributeName : unreal.Const<unreal.PRef<unreal.FName>>, OutValue : unreal.Int32, @:opt("BoneOnly") LookupType : unreal.ECustomBoneAttributeLookup) : Bool;
  ...
  /**
    ...
    @return Whether or not the atttribute was successfully retrieved
  **/
  @:ufunction(BlueprintCallable) @:final public function GetStringAttribute_Ref(BoneName : unreal.Const<unreal.PRef<unreal.FName>>, AttributeName : unreal.Const<unreal.PRef<unreal.FName>>, OutValue : unreal.PRef<unreal.FString>, @:opt("BoneOnly") LookupType : unreal.ECustomBoneAttributeLookup) : Bool;
  ...
  /**
    ...
    @return Whether or not the atttribute was successfully retrieved
  **/
  @:ufunction(BlueprintCallable) @:final public function GetFloatAttribute(BoneName : unreal.Const<unreal.PRef<unreal.FName>>, AttributeName : unreal.Const<unreal.PRef<unreal.FName>>, DefaultValue : unreal.Float32, OutValue : unreal.Float32, @:opt("BoneOnly") LookupType : unreal.ECustomBoneAttributeLookup) : Bool;
  ...
  /**
    ...
    @return Whether or not the atttribute was successfully retrieved
  **/
  @:ufunction(BlueprintCallable) @:final public function GetIntegerAttribute(BoneName : unreal.Const<unreal.PRef<unreal.FName>>, AttributeName : unreal.Const<unreal.PRef<unreal.FName>>, DefaultValue : unreal.Int32, OutValue : unreal.Int32, @:opt("BoneOnly") LookupType : unreal.ECustomBoneAttributeLookup) : Bool;
  ...
  /**
    ...
    @return Whether or not the atttribute was successfully retrieved
  **/
  @:ufunction(BlueprintCallable) @:final public function GetStringAttribute(BoneName : unreal.Const<unreal.PRef<unreal.FName>>, AttributeName : unreal.Const<unreal.PRef<unreal.FName>>, DefaultValue : unreal.FString, OutValue : unreal.PRef<unreal.FString>, @:opt("BoneOnly") LookupType : unreal.ECustomBoneAttributeLookup) : Bool;
  ...
  **/
  @:ufunction(BlueprintCallable) public function SetAnimClass(NewClass : unreal.UClass) : Void;
  
  /**
    Get the anim instance class via getter callable by sequencer.
  **/
  @:ufunction @:final public function GetAnimClass() : unreal.UClass;
  ...
  **/
  @:ufunction(BlueprintCallable) @:thisConst @:final public function GetLinkedAnimGraphInstanceByTag(InTag : unreal.FName) : unreal.UAnimInstance;
  
  /**
    Returns all tagged linked instance nodes that match the tag.
  **/
  @:ufunction(BlueprintCallable) @:thisConst @:final public function GetLinkedAnimGraphInstancesByTag(InTag : unreal.FName, OutLinkedInstances : unreal.PRef<unreal.TArray<unreal.UAnimInstance>>) : Void;
  ...
  **/
  @:ufunction(BlueprintCallable) @:final public function LinkAnimGraphByTag(InTag : unreal.FName, InClass : unreal.TSubclassOf<unreal.UAnimInstance>) : Void;
  ...
  **/
  @:ufunction(BlueprintCallable) @:final public function LinkAnimClassLayers(InClass : unreal.TSubclassOf<unreal.UAnimInstance>) : Void;
  ...
  **/
  @:ufunction(BlueprintCallable) @:final public function UnlinkAnimClassLayers(InClass : unreal.TSubclassOf<unreal.UAnimInstance>) : Void;
  
  /**
    Gets the layer linked instance corresponding to the specified group
  **/
  @:ufunction(BlueprintCallable) @:thisConst @:final public function GetLinkedAnimLayerInstanceByGroup(InGroup : unreal.FName) : unreal.UAnimInstance;
  
  /**
    Gets the first layer linked instance corresponding to the specified class
  **/
  @:ufunction(BlueprintCallable) @:thisConst @:final public function GetLinkedAnimLayerInstanceByClass(InClass : unreal.TSubclassOf<unreal.UAnimInstance>) : unreal.UAnimInstance;
  ...
  **/
  @:ufunction(BlueprintCallable) @:thisConst @:final public function GetClothMaxDistanceScale() : unreal.Float32;
  ...
  **/
  @:ufunction(BlueprintCallable) @:final public function SetAllowRigidBodyAnimNode(bInAllow : Bool, bReinitAnim : Bool = true) : Void;
  @:ufunction(BlueprintCallable) @:thisConst @:final public function GetAllowRigidBodyAnimNode() : Bool;
  ...
  **/
  ...
  /**
    ...
    This is supported only in the editor
  **/
  @:ufunction(BlueprintCallable) @:final public function SetUpdateClothInEditor(NewUpdateState : Bool) : Void;
