...
package uhx.glues;
@:unrealGlue extern class UARPlaneComponent_Glue {
public static function SetPlaneComponentDebugMode(NewDebugMode:Int):Void;
public static function SetObjectClassificationDebugColors(InColors:unreal.VariantPtr):Void;
public static function GetObjectClassificationDebugColors():unreal.VariantPtr;
