...
package uhx.glues;
@:unrealGlue extern class FMovementModeChangedSignature_Glue {
public static function create():unreal.VariantPtr;
public static function createNew():unreal.VariantPtr;
public static function Broadcast(self:unreal.VariantPtr, arg_0:unreal.UIntPtr, arg_1:Int, arg_2:cpp.UInt8):Void;
