...
package uhx.glues;
@:unrealGlue extern class FTTTrackId_Glue {
...
public static function get_TrackType(self:unreal.VariantPtr):Int;
public static function set_TrackType(self:unreal.VariantPtr, value:Int):Void;
