...
package uhx.glues;
@:unrealGlue extern class FOnCancelFindSessionsCompleteDelegate_Glue {
...
public static function Execute(self:unreal.VariantPtr, arg_0:Bool):Void;
public static function ExecuteIfBound(self:unreal.VariantPtr, arg_0:Bool):Void;
