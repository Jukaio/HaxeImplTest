...
package uhx.glues;
@:unrealGlue extern class FActiveHapticFeedbackEffect_Glue {
public static function get_HapticEffect(self:unreal.VariantPtr):unreal.UIntPtr;
public static function set_HapticEffect(self:unreal.VariantPtr, value:unreal.UIntPtr):Void;
