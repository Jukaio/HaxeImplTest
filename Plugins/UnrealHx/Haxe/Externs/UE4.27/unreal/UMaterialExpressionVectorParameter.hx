...
@:uextern @:uclass extern class UMaterialExpressionVectorParameter extends unreal.UMaterialExpressionParameter {
  ...
  @:uproperty public var ChannelNames : unreal.FParameterChannelNames;
  #end // WITH_EDITORONLY_DATA
  @:uproperty public var PrimitiveDataIndex : unreal.UInt8;
  @:uproperty public var bUseCustomPrimitiveData : Bool;
