...
package uhx.glues;
@:unrealGlue extern class FMaterialGraphSchemaAction_NewFunctionCall_Glue {
public static function get_FunctionPath(self:unreal.VariantPtr):unreal.VariantPtr;
public static function set_FunctionPath(self:unreal.VariantPtr, value:unreal.VariantPtr):Void;
