...
@:uextern @:uclass extern class UAnimInstance extends unreal.UObject {
  ...
  **/
  @:ufunction(BlueprintCallable) @:thisConst @:final public function GetReceiveNotifiesFromLinkedInstances() : Bool;
  
  /**
    Set whether to process notifies from any linked anim instances
  **/
  @:ufunction(BlueprintCallable) @:final public function SetReceiveNotifiesFromLinkedInstances(bSet : Bool) : Void;
  
  /**
    Get whether to propagate notifies to any linked anim instances
  **/
  @:ufunction(BlueprintCallable) @:thisConst @:final public function GetPropagateNotifiesToLinkedInstances() : Bool;
  
  /**
    Set whether to propagate notifies to any linked anim instances
  **/
  @:ufunction(BlueprintCallable) @:final public function SetPropagateNotifiesToLinkedInstances(bSet : Bool) : Void;
  ...
  **/
  @:ufunction(BlueprintImplementableEvent) public function BlueprintLinkedAnimationLayersInitialized() : Void;
  ...
  **/
  @:ufunction(BlueprintCallable) @:final public function Montage_StopGroupByName(InBlendOutTime : unreal.Float32, GroupName : unreal.FName) : Void;
  ...
  **/
  @:ufunction(BlueprintCallable) @:thisConst @:final public function GetLinkedAnimLayerInstancesByGroup(InGroup : unreal.FName, OutLinkedInstances : unreal.PRef<unreal.TArray<unreal.UAnimInstance>>) : Void;
  
  /**
    Gets layer linked instance that matches group and class
  **/
  @:ufunction(BlueprintCallable) @:thisConst @:final public function GetLinkedAnimLayerInstanceByGroupAndClass(InGroup : unreal.FName, InClass : unreal.TSubclassOf<unreal.UAnimInstance>) : unreal.UAnimInstance;
