...
@:uextern @:uclass extern class UGameMapsSettings extends unreal.UObject {
  ...
  **/
  @:ufunction(BlueprintCallable) static public function GetGameMapsSettings() : unreal.enginesettings.UGameMapsSettings;
  ...
  **/
  @:ufunction(BlueprintCallable) @:final public function SetSkipAssigningGamepadToPlayer1(bSkipFirstPlayer : Bool = true) : Void;
  @:ufunction(BlueprintCallable) @:thisConst @:final public function GetSkipAssigningGamepadToPlayer1() : Bool;
