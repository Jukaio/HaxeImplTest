...
package uhx.glues;
@:unrealGlue extern class FNamedSlotBinding_Glue {
public static function get_Content(self:unreal.VariantPtr):unreal.UIntPtr;
public static function set_Content(self:unreal.VariantPtr, value:unreal.UIntPtr):Void;
