...
package uhx.glues;
@:unrealGlue extern class FInstigatedAnyDamageSignature_Glue {
public static function create():unreal.VariantPtr;
public static function createNew():unreal.VariantPtr;
public static function Broadcast(self:unreal.VariantPtr, arg_0:cpp.Float32, arg_1:unreal.UIntPtr, arg_2:unreal.UIntPtr, arg_3:unreal.UIntPtr):Void;
