...
package uhx.glues;
@:unrealGlue extern class FRecordedTransformTrack_Glue {
public static function get_Records(self:unreal.VariantPtr):unreal.VariantPtr;
public static function set_Records(self:unreal.VariantPtr, value:unreal.VariantPtr):Void;
