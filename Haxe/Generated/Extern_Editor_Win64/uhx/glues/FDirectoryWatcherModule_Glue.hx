...
package uhx.glues;
@:unrealGlue extern class FDirectoryWatcherModule_Glue {
public static function StartupModule(self:unreal.VariantPtr):Void;
public static function ShutdownModule(self:unreal.VariantPtr):Void;
public static function Get(self:unreal.VariantPtr):unreal.VariantPtr;
