...
package uhx.glues;
@:unrealGlue extern class TSoftObjectPtr_Glue {
public  function Get(self:unreal.VariantPtr):unreal.UIntPtr;
public  function Set(self:unreal.VariantPtr, val:unreal.UIntPtr):Void;
public  function ToSoftObjectPath(self:unreal.VariantPtr):unreal.VariantPtr;
public  function LoadSynchronous(self:unreal.VariantPtr):unreal.UIntPtr;
