...
package uhx.glues;
@:unrealGlue extern class FHttpRequestCompleteDelegate_Glue {
...
public static function Execute(self:unreal.VariantPtr, arg_0:unreal.VariantPtr, arg_1:unreal.VariantPtr, arg_2:Bool):Void;
public static function ExecuteIfBound(self:unreal.VariantPtr, arg_0:unreal.VariantPtr, arg_1:unreal.VariantPtr, arg_2:Bool):Void;
