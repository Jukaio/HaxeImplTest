...
package uhx.glues;
@:unrealGlue extern class FOnlineAccountCredentials_Glue {
public static function glueNew():unreal.VariantPtr;
public static function create():unreal.VariantPtr;
public static function createFromValues(InType:unreal.VariantPtr, InId:unreal.VariantPtr, InToken:unreal.VariantPtr):unreal.VariantPtr;
