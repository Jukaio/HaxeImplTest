...
package uhx.glues;
@:unrealGlue extern class FSubmixEffectDynamicProcessorFilterSettings_Glue {
...
public static function get_Cutoff(self:unreal.VariantPtr):cpp.Float32;
public static function set_Cutoff(self:unreal.VariantPtr, value:cpp.Float32):Void;
