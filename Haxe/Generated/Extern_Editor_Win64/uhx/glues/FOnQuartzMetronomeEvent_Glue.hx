...
package uhx.glues;
@:unrealGlue extern class FOnQuartzMetronomeEvent_Glue {
public static function create():unreal.VariantPtr;
public static function createNew():unreal.VariantPtr;
public static function Broadcast(self:unreal.VariantPtr, arg_0:unreal.VariantPtr, arg_1:Int, arg_2:Int, arg_3:Int, arg_4:cpp.Float32):Void;
