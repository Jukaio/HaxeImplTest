...
@:uextern @:uclass extern class UStaticMesh extends unreal.UStreamableRenderAsset implements unreal.IInterface_CollisionDataProvider implements unreal.IInterface_AssetUserData {
  @:uproperty public var NavCollision : unreal.UNavCollisionBase;
  #if WITH_EDITORONLY_DATA
  @:uproperty public var ComplexCollisionMesh : unreal.UStaticMesh;
  ...
  **/
  @:uproperty public var bSupportGpuUniformlyDistributedSampling : Bool;
  ...
  **/
  ...
  @:uproperty public var bIsBuiltAtRuntime : Bool;
  ...
  **/
  ...
  /**
    ...
    functionality.
  **/
  @:uproperty public var bSupportPhysicalMaterialMasks : Bool;
  ...
  **/
  ...
  @:uproperty(BlueprintGetter=GetStaticMaterials, BlueprintSetter=SetStaticMaterials) public var StaticMaterials : unreal.TArray<unreal.FStaticMaterial>;
  ...
  **/
  @:uproperty public var NumStreamedLODs : unreal.FPerPlatformInt;
  ...
  **/
  @:ufunction(BlueprintCallable) static public function CreateStaticMeshDescription(@:opt("None") Outer : unreal.UObject) : unreal.staticmeshdescription.UStaticMeshDescription;
  
  /**
    Builds static mesh LODs from the array of StaticMeshDescriptions passed in
  **/
  @:ufunction(BlueprintCallable) @:final public function BuildFromStaticMeshDescriptions(StaticMeshDescriptions : unreal.Const<unreal.PRef<unreal.TArray<unreal.staticmeshdescription.UStaticMeshDescription>>>, bBuildSimpleCollision : Bool = false) : Void;
  #if WITH_EDITOR
  @:ufunction(BlueprintCallable) @:final public function SetNumSourceModels(Num : unreal.Int32) : Void;
  #end // WITH_EDITOR
  ...
  **/
  @:ufunction(BlueprintCallable) @:final public function AddMaterial(Material : unreal.UMaterialInterface) : unreal.FName;
  ...
  **/
  @:ufunction(BlueprintCallable) @:final public function AddSocket(Socket : unreal.UStaticMeshSocket) : Void;
  ...
  **/
  @:ufunction(BlueprintCallable) @:final public function RemoveSocket(Socket : unreal.UStaticMeshSocket) : Void;
  #if WITH_EDITOR
