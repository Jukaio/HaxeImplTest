...
package uhx.glues;
@:unrealGlue extern class FAnimNode_RefPose_Glue {
public static function get_RefPoseType(self:unreal.VariantPtr):Int;
public static function set_RefPoseType(self:unreal.VariantPtr, value:Int):Void;
