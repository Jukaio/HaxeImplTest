...
@:uextern @:uclass extern class UWidgetDesignerSettings extends unreal.developersettings.UDeveloperSettings {
  
  /**
    List of Favorites widgets used to populate the Favorites Palette
  **/
  @:uproperty public var Favorites : unreal.umgeditor.UWidgetPaletteFavorites;
