...
package uhx.glues;
@:unrealGlue extern class FMagicLeapHandMesh_Glue {
...
public static function get_DataCount(self:unreal.VariantPtr):Int;
public static function set_DataCount(self:unreal.VariantPtr, value:Int):Void;
