...
package uhx.glues;
@:unrealGlue extern class FMagicLeapSharedWorldAlignmentTransforms_Glue {
public static function get_AlignmentTransforms(self:unreal.VariantPtr):unreal.VariantPtr;
public static function set_AlignmentTransforms(self:unreal.VariantPtr, value:unreal.VariantPtr):Void;
