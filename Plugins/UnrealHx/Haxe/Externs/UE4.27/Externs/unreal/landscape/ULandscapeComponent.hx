...
@:uextern @:uclass extern class ULandscapeComponent extends unreal.UPrimitiveComponent {
  ...
  **/
  @:uproperty public var PhysicalMaterialHash : unreal.FakeUInt32;
  @:uproperty public var SplineHash : unreal.FakeUInt32;
  
  /**
    Represent the chosen material for each LOD
  **/
  @:uproperty public var MaterialPerLOD : unreal.TMap<unreal.UMaterialInterface, unreal.Int8>;
  ...
  **/
  @:ufunction(BlueprintCallable) @:final public function EditorGetPaintLayerWeightAtLocation(InLocation : unreal.Const<unreal.PRef<unreal.FVector>>, PaintLayer : unreal.landscape.ULandscapeLayerInfoObject) : unreal.Float32;
  
  /**
    Gets the landscape paint layer weight value at the given position using layer name. Returns 0 in case it fails.
  **/
  @:ufunction(BlueprintCallable) @:final public function EditorGetPaintLayerWeightByNameAtLocation(InLocation : unreal.Const<unreal.PRef<unreal.FVector>>, InPaintLayerName : unreal.Const<unreal.FName>) : unreal.Float32;
