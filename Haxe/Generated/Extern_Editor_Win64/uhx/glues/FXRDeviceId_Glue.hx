...
package uhx.glues;
@:unrealGlue extern class FXRDeviceId_Glue {
public static function get_DeviceId(self:unreal.VariantPtr):Int;
public static function set_DeviceId(self:unreal.VariantPtr, value:Int):Void;
