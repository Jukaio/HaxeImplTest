...
@:uextern @:uclass extern class UMagicLeapMeshTrackerComponent extends unreal.USceneComponent implements unreal.magicleap.IMagicLeapMeshBlockSelectorInterface {
  ...
  **/
  @:uproperty public var BricksPerFrame : unreal.Int32;
  ...
  **/
  @:uproperty public var VertexColorMode : unreal.magicleap.EMagicLeapMeshVertexColorMode;
  ...
  **/
  ...
  /**
    Meshing LOD.
  **/
  @:uproperty public var LevelOfDetail : unreal.magicleap.EMagicLeapMeshLOD;
  ...
  **/
  @:uproperty public var MeshType : unreal.magicleap.EMagicLeapMeshType;
  ...
  **/
  @:ufunction(BlueprintCallable) @:final public function GetNumQueuedBlockUpdates() : unreal.Int32;
  
  /**
    IMagicLeapMeshBlockSelectorInterface
  **/
  @:ufunction(BlueprintNativeEvent, BlueprintCallable) public function SelectMeshBlocks(NewMeshInfo : unreal.Const<unreal.PRef<unreal.magicleap.FMagicLeapTrackingMeshInfo>>, RequestedMesh : unreal.PRef<unreal.TArray<unreal.magicleap.FMagicLeapMeshBlockRequest>>) : Void;
  // MagicLeapMeshBlockSelectorInterface interface implementation
