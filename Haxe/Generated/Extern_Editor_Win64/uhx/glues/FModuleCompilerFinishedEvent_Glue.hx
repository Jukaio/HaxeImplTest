...
package uhx.glues;
@:unrealGlue extern class FModuleCompilerFinishedEvent_Glue {
...
public static function Broadcast(self:unreal.VariantPtr, arg_0:unreal.VariantPtr, arg_1:Int, arg_2:Bool):Void;
