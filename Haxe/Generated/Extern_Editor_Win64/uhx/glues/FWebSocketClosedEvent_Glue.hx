...
package uhx.glues;
@:unrealGlue extern class FWebSocketClosedEvent_Glue {
...
public static function Broadcast(self:unreal.VariantPtr, arg_0:Int, arg_1:unreal.VariantPtr, arg_2:Bool):Void;
