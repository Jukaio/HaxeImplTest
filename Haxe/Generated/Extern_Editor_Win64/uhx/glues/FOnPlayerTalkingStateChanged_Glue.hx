...
package uhx.glues;
@:unrealGlue extern class FOnPlayerTalkingStateChanged_Glue {
...
public static function Broadcast(self:unreal.VariantPtr, arg_0:unreal.VariantPtr, arg_1:Bool):Void;
