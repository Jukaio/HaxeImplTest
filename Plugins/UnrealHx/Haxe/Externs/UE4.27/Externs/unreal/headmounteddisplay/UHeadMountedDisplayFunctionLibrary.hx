...
@:uextern @:uclass extern class UHeadMountedDisplayFunctionLibrary extends unreal.UBlueprintFunctionLibrary {
  ...
  **/
  @:ufunction(BlueprintCallable) static public function GetXRSystemFlags() : unreal.Int32;
  ...
  **/
  @:ufunction(BlueprintCallable) static public function GetHMDData(WorldContext : unreal.UObject, HMDData : unreal.PRef<unreal.headmounteddisplay.FXRHMDData>) : Void;
  ...
  **/
  @:ufunction(BlueprintCallable) static public function GetMotionControllerData(WorldContext : unreal.UObject, Hand : unreal.Const<unreal.inputcore.EControllerHand>, MotionControllerData : unreal.PRef<unreal.headmounteddisplay.FXRMotionControllerData>) : Void;
  
  /**
    Specify which gestures to capture.
  **/
  @:ufunction(BlueprintCallable) static public function ConfigureGestures(GestureConfig : unreal.Const<unreal.PRef<unreal.headmounteddisplay.FXRGestureConfig>>) : Bool;
  
  /**
    Connect to a remote device
  **/
  @:ufunction(BlueprintCallable) static public function ConnectRemoteXRDevice(IpAddress : unreal.FString, BitRate : unreal.Int32) : unreal.headmounteddisplay.EXRDeviceConnectionResult;
  
  /**
    Disconnect remote AR Device
  **/
  @:ufunction(BlueprintCallable) static public function DisconnectRemoteXRDevice() : Void;
  @:ufunction(BlueprintCallable) static public function SetXRDisconnectDelegate(InDisconnectedDelegate : unreal.Const<unreal.PRef<unreal.headmounteddisplay.FXRDeviceOnDisconnectDelegate>>) : Void;
  ...
  **/
  @:ufunction(BlueprintCallable) static public function SetXRTimedInputActionDelegate(ActionName : unreal.Const<unreal.PRef<unreal.FName>>, InDelegate : unreal.Const<unreal.PRef<unreal.headmounteddisplay.FXRTimedInputActionDelegate>>) : Void;
  
  /**
    / Clear a delegate to get an OpenXR action event with action time.
  **/
  @:ufunction(BlueprintCallable) static public function ClearXRTimedInputActionDelegate(ActionPath : unreal.Const<unreal.PRef<unreal.FName>>) : Void;
  ...
  **/
  @:ufunction(BlueprintCallable) static public function GetControllerTransformForTime(WorldContext : unreal.UObject, ControllerIndex : unreal.Int32, MotionSource : unreal.Const<unreal.FName>, Time : unreal.FTimespan, bTimeWasUsed : Bool, Orientation : unreal.PRef<unreal.FRotator>, Position : unreal.PRef<unreal.FVector>, bProvidedLinearVelocity : Bool, LinearVelocity : unreal.PRef<unreal.FVector>, bProvidedAngularVelocity : Bool, AngularVelocityRadPerSec : unreal.PRef<unreal.FVector>) : Bool;
  
  /**
    Get the bounds of the area where the user can freely move while remaining tracked centered around the specified origin
  **/
  @:ufunction(BlueprintCallable) static public function GetPlayAreaBounds(Origin : unreal.headmounteddisplay.EHMDTrackingOrigin = Stage) : unreal.FVector2D;
  
  /**
    Breaks an XR key apart into the interaction profile, handedness, motion source, indentifier and component.
  **/
  @:ufunction(BlueprintCallable) static public function BreakKey(InKey : unreal.inputcore.FKey, InteractionProfile : unreal.PRef<unreal.FString>, Hand : unreal.Ref<unreal.inputcore.EControllerHand>, MotionSource : unreal.PRef<unreal.FName>, Indentifier : unreal.PRef<unreal.FString>, Component : unreal.PRef<unreal.FString>) : Void;
