...
package uhx.glues;
@:unrealGlue extern class FOculusCapsuleCollider_Glue {
public static function get_BoneId(self:unreal.VariantPtr):Int;
public static function set_BoneId(self:unreal.VariantPtr, value:Int):Void;
public static function get_Capsule(self:unreal.VariantPtr):unreal.UIntPtr;
public static function set_Capsule(self:unreal.VariantPtr, value:unreal.UIntPtr):Void;
