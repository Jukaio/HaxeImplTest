...
@:uextern @:uclass extern class UViewportWorldInteraction extends unreal.editor.UEditorWorldExtension {
  ...
  **/
  @:ufunction(BlueprintCallable) @:final public function SetWorldToMetersScale(NewWorldToMetersScale : unreal.Float32, bCompensateRoomWorldScale : Bool = false) : Void;
