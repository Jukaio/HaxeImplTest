...
@:uextern @:uclass extern class UMagicLeapARPinContentBindings extends unreal.USaveGame {
  
  /**
    Map of a PinID and all object ids (of MagicLeapARPinComponent) saved by this app.
  **/
  @:uproperty public var AllContentBindings : unreal.TMap<unreal.FGuid, unreal.magicleaparpin.FMagicLeapARPinObjectIdList>;
