...
@:uextern @:uclass extern class UWidgetLayoutLibrary extends unreal.UBlueprintFunctionLibrary {
  ...
  **/
  @:ufunction(BlueprintCallable) static public function ProjectWorldLocationToWidgetPosition(PlayerController : unreal.APlayerController, WorldLocation : unreal.FVector, ScreenPosition : unreal.PRef<unreal.FVector2D>, bPlayerViewportRelative : Bool) : Bool;
  ...
  **/
  @:ufunction(BlueprintCallable) static public function SlotAsScrollBoxSlot(Widget : unreal.umg.UWidget) : unreal.umg.UScrollBoxSlot;
  ...
  **/
  @:ufunction(BlueprintCallable) static public function SlotAsSafeBoxSlot(Widget : unreal.umg.UWidget) : unreal.umg.USafeZoneSlot;
  ...
  **/
  @:ufunction(BlueprintCallable) static public function SlotAsScaleBoxSlot(Widget : unreal.umg.UWidget) : unreal.umg.UScaleBoxSlot;
  ...
  **/
  @:ufunction(BlueprintCallable) static public function SlotAsSizeBoxSlot(Widget : unreal.umg.UWidget) : unreal.umg.USizeBoxSlot;
  ...
  **/
  @:ufunction(BlueprintCallable) static public function SlotAsWrapBoxSlot(Widget : unreal.umg.UWidget) : unreal.umg.UWrapBoxSlot;
  ...
  **/
  @:ufunction(BlueprintCallable) static public function SlotAsWidgetSwitcherSlot(Widget : unreal.umg.UWidget) : unreal.umg.UWidgetSwitcherSlot;
