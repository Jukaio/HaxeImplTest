...
package uhx.glues;
@:unrealGlue extern class FNiagaraSchemaAction_NewNode_Glue {
public static function get_InternalName(self:unreal.VariantPtr):unreal.VariantPtr;
public static function set_InternalName(self:unreal.VariantPtr, value:unreal.VariantPtr):Void;
