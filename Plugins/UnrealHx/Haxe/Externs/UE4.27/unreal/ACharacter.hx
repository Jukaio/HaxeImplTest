...
@:uextern @:uclass extern class ACharacter extends unreal.APawn {
  ...
  **/
  @:uproperty public var JumpCurrentCountPreJump : unreal.Int32;
  ...
  **/
  @:ufunction(Server) public function ServerMovePacked(PackedBits : unreal.Const<unreal.PRef<unreal.FCharacterServerMovePackedBits>>) : Void;
  
  /**
    Client RPC that passes through to CharacterMovement (avoids RPC overhead for components).
  **/
  @:ufunction(Client) public function ClientMoveResponsePacked(PackedBits : unreal.Const<unreal.PRef<unreal.FCharacterMoveResponsePackedBits>>) : Void;
  ...
  **/
  @:ufunction(BlueprintCallable) @:thisConst public function CanCrouch() : Bool;
