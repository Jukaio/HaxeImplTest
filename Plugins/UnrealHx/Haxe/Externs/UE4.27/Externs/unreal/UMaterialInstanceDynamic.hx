...
@:uextern @:uclass extern class UMaterialInstanceDynamic extends unreal.UMaterialInstance {
  ...
  **/
  @:ufunction(BlueprintCallable) @:final public function SetScalarParameterValueByInfo(ParameterInfo : unreal.Const<unreal.PRef<unreal.FMaterialParameterInfo>>, Value : unreal.Float32) : Void;
  ...
  **/
  @:ufunction(BlueprintCallable) @:final public function K2_GetScalarParameterValueByInfo(ParameterInfo : unreal.Const<unreal.PRef<unreal.FMaterialParameterInfo>>) : unreal.Float32;
  ...
  **/
  @:ufunction(BlueprintCallable) @:final public function SetTextureParameterValueByInfo(ParameterInfo : unreal.Const<unreal.PRef<unreal.FMaterialParameterInfo>>, Value : unreal.UTexture) : Void;
  ...
  **/
  @:ufunction(BlueprintCallable) @:final public function K2_GetTextureParameterValueByInfo(ParameterInfo : unreal.Const<unreal.PRef<unreal.FMaterialParameterInfo>>) : unreal.UTexture;
  ...
  **/
  @:ufunction(BlueprintCallable) @:final public function SetVectorParameterValueByInfo(ParameterInfo : unreal.Const<unreal.PRef<unreal.FMaterialParameterInfo>>, Value : unreal.FLinearColor) : Void;
  ...
  **/
  @:ufunction(BlueprintCallable) @:final public function K2_GetVectorParameterValueByInfo(ParameterInfo : unreal.Const<unreal.PRef<unreal.FMaterialParameterInfo>>) : unreal.FLinearColor;
