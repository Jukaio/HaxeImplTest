...
package uhx.glues;
@:unrealGlue extern class FSynth1PatchCable_Glue {
public static function get_Destination(self:unreal.VariantPtr):Int;
public static function set_Destination(self:unreal.VariantPtr, value:Int):Void;
