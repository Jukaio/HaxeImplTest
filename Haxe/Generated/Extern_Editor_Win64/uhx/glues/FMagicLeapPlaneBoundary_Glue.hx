...
package uhx.glues;
@:unrealGlue extern class FMagicLeapPlaneBoundary_Glue {
public static function get_Holes(self:unreal.VariantPtr):unreal.VariantPtr;
public static function set_Holes(self:unreal.VariantPtr, value:unreal.VariantPtr):Void;
public static function get_Polygon(self:unreal.VariantPtr):unreal.VariantPtr;
public static function set_Polygon(self:unreal.VariantPtr, value:unreal.VariantPtr):Void;
