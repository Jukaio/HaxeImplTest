...
@:uextern @:uclass extern class UCameraModifier_CameraShake extends unreal.UCameraModifier {
  ...
  **/
  ...
  @:uproperty private var ExpiredPooledShakesMap : unreal.TMap<unreal.TSubclassOf<unreal.UCameraShakeBase>, unreal.FPooledCameraShakes>;
  
  /**
    List of active CameraShake instances
  **/
  @:uproperty private var ActiveShakes : unreal.TArray<unreal.FActiveCameraShakeInfo>;
