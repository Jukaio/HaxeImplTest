...
@:uextern @:uclass extern class ADebugCameraController extends unreal.APlayerController {
  ...
  **/
  ...
  /**
    Selected hit point
  **/
  @:uproperty public var SelectedHitPoint : unreal.FHitResult;
  ...
  **/
  @:uproperty public var bLastDisplayEnabled : Bool;
  
  /**
    Whether GBuffer visualization overview inputs are set up
  **/
  @:uproperty public var bIsBufferVisualizationInputSetup : Bool;
  
  /**
    Whether set view mode to display GBuffer visualization full
  **/
  @:uproperty public var bEnableBufferVisualizationFullMode : Bool;
  
  /**
    Whether set view mode to display GBuffer visualization overview
  **/
  @:uproperty public var bEnableBufferVisualization : Bool;
  
  /**
    When orbiting, true if using actor center as pivot, false if using last selected hitpoint
  **/
  @:uproperty public var bOrbitPivotUseCenter : Bool;
  
  /**
    Whether to orbit selected actor.
  **/
  @:uproperty public var bIsOrbitingSelectedActor : Bool;
