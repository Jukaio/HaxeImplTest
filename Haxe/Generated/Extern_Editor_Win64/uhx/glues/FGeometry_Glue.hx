...
package uhx.glues;
@:unrealGlue extern class FGeometry_Glue {
...
public static function GetLocalSize(self:unreal.VariantPtr):unreal.VariantPtr;
public static function GetAbsoluteSize(self:unreal.VariantPtr):unreal.VariantPtr;
public static function GetAbsolutePosition(self:unreal.VariantPtr):unreal.VariantPtr;
public static function AbsoluteToLocal(self:unreal.VariantPtr, AbsoluteCoordinate:unreal.VariantPtr):unreal.VariantPtr;
