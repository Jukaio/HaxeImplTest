...
package uhx.glues;
@:unrealGlue extern class FBlueprintCookedComponentInstancingData_Glue {
public static function get_bHasValidCookedData(self:unreal.VariantPtr):Bool;
public static function set_bHasValidCookedData(self:unreal.VariantPtr, value:Bool):Void;
public static function get_ChangedPropertyList(self:unreal.VariantPtr):unreal.VariantPtr;
public static function set_ChangedPropertyList(self:unreal.VariantPtr, value:unreal.VariantPtr):Void;
