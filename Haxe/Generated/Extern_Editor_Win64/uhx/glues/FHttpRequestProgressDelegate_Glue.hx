...
package uhx.glues;
@:unrealGlue extern class FHttpRequestProgressDelegate_Glue {
...
public static function Execute(self:unreal.VariantPtr, arg_0:unreal.VariantPtr, arg_1:Int, arg_2:Int):Void;
public static function ExecuteIfBound(self:unreal.VariantPtr, arg_0:unreal.VariantPtr, arg_1:Int, arg_2:Int):Void;
