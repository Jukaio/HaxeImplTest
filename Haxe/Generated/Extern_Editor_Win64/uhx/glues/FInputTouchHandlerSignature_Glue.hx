...
package uhx.glues;
@:unrealGlue extern class FInputTouchHandlerSignature_Glue {
...
public static function Execute(self:unreal.VariantPtr, arg_0:Int, arg_1:unreal.VariantPtr):Void;
public static function ExecuteIfBound(self:unreal.VariantPtr, arg_0:Int, arg_1:unreal.VariantPtr):Void;
