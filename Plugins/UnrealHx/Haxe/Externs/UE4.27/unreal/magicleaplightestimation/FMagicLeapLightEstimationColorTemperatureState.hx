...
@:uextern @:ustruct extern class FMagicLeapLightEstimationColorTemperatureState {
  @:uproperty public var Timestamp : unreal.FTimespan;
  @:uproperty public var AmbientColor : unreal.FLinearColor;
  @:uproperty public var ColorTemperatureKelvin : unreal.Float32;
