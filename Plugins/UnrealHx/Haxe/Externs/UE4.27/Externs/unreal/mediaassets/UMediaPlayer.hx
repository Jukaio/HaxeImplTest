...
@:uextern @:uclass extern class UMediaPlayer extends unreal.UObject {
  ...
  **/
  ...
  /**
    ...
    @see GetDuration, Seek
  **/
  @:ufunction(BlueprintCallable) @:thisConst @:final public function GetTimeStamp() : unreal.mediaassets.UMediaTimeStampInfo;
  ...
  **/
  @:ufunction(BlueprintCallable) @:final public function PlayAndSeek() : Void;
  ...
  **/
  @:ufunction(BlueprintCallable) @:final public function SetMediaOptions(Options : unreal.Const<unreal.mediaassets.UMediaSource>) : Void;
