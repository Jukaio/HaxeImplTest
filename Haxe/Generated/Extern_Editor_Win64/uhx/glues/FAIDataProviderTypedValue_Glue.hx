...
package uhx.glues;
@:unrealGlue extern class FAIDataProviderTypedValue_Glue {
public static function get_PropertyType_DEPRECATED(self:unreal.VariantPtr):unreal.UIntPtr;
public static function set_PropertyType_DEPRECATED(self:unreal.VariantPtr, value:unreal.UIntPtr):Void;
