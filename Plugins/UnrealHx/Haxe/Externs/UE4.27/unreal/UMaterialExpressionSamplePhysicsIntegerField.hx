...
@:noClass @:uextern @:uclass extern class UMaterialExpressionSamplePhysicsIntegerField extends unreal.UMaterialExpression {
  
  /**
    Target Type to be accessed
  **/
  @:uproperty public var FieldTarget : unreal.chaos.EFieldIntegerType;
