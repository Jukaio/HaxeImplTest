...
@:uextern @:uclass extern class UBlueprintEditorSettings extends unreal.UObject {
  ...
  **/
  @:uproperty public var NamespacesToAlwaysInclude : unreal.TArray<unreal.FString>;
  ...
  **/
  @:uproperty public var GraphEditorQuickJumps : unreal.TMap<unreal.Int32, unreal.FEditedDocumentInfo>;
  ...
  **/
  @:uproperty public var bShowAccessSpecifier : Bool;
  ...
  **/
  @:uproperty public var bExposeDeprecatedFunctions : Bool;
  ...
  **/
  @:uproperty public var bShowShortTooltips : Bool;
