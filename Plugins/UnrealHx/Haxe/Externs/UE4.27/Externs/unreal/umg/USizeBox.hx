...
@:uextern @:uclass extern class USizeBox extends unreal.umg.UContentWidget {
  ...
  @:uproperty public var bOverride_MinAspectRatio : Bool;
  ...
  @:uproperty public var MinAspectRatio : unreal.Float32;
  ...
  **/
  ...
  @:ufunction(BlueprintCallable) @:final public function SetMinAspectRatio(InMinAspectRatio : unreal.Float32) : Void;
  @:ufunction(BlueprintCallable) @:final public function SetMaxAspectRatio(InMaxAspectRatio : unreal.Float32) : Void;
  @:ufunction(BlueprintCallable) @:final public function ClearMinAspectRatio() : Void;
