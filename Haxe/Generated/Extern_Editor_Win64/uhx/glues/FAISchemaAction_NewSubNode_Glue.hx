...
package uhx.glues;
@:unrealGlue extern class FAISchemaAction_NewSubNode_Glue {
public static function get_ParentNode(self:unreal.VariantPtr):unreal.UIntPtr;
public static function set_ParentNode(self:unreal.VariantPtr, value:unreal.UIntPtr):Void;
