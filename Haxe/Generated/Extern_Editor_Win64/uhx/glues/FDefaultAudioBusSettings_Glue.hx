...
package uhx.glues;
@:unrealGlue extern class FDefaultAudioBusSettings_Glue {
public static function get_AudioBus(self:unreal.VariantPtr):unreal.VariantPtr;
public static function set_AudioBus(self:unreal.VariantPtr, value:unreal.VariantPtr):Void;
