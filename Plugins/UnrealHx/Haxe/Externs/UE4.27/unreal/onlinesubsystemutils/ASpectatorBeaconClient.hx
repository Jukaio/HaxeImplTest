...
@:uextern @:uclass extern class ASpectatorBeaconClient extends unreal.onlinesubsystemutils.AOnlineBeaconClient {
  
  /**
    Type of request currently being handled by this client beacon
  **/
  @:uproperty private var RequestType : unreal.onlinesubsystemutils.ESpectatorClientRequestType;
  
  /**
    Pending reservation that will be sent upon connection with the intended host
  **/
  @:uproperty private var PendingReservation : unreal.onlinesubsystemutils.FSpectatorReservation;
  ...
  **/
  @:ufunction(Client) public function ClientReservationResponse(ReservationResponse : unreal.onlinesubsystemutils.ESpectatorReservationResult) : Void;
  ...
  /**
    ...
    @param ReservationResponse response from server
  **/
  @:ufunction(Client) public function ClientCancelReservationResponse(ReservationResponse : unreal.onlinesubsystemutils.ESpectatorReservationResult) : Void;
  ...
  **/
  @:ufunction(Server) private function ServerReservationRequest(SessionId : unreal.FString, Reservation : unreal.Const<unreal.PRef<unreal.onlinesubsystemutils.FSpectatorReservation>>) : Void;
  ...
  **/
  @:ufunction(Server) private function ServerCancelReservationRequest(Spectator : unreal.Const<unreal.PRef<unreal.FUniqueNetIdRepl>>) : Void;
