...
package uhx.glues;
@:unrealGlue extern class FControlFindReplaceString_Glue {
public static function get_Replace(self:unreal.VariantPtr):unreal.VariantPtr;
public static function set_Replace(self:unreal.VariantPtr, value:unreal.VariantPtr):Void;
public static function get_Find(self:unreal.VariantPtr):unreal.VariantPtr;
public static function set_Find(self:unreal.VariantPtr, value:unreal.VariantPtr):Void;
