...
package uhx.glues;
@:unrealGlue extern class FTimelineEventEntry_Glue {
public static function get_EventFunc(self:unreal.VariantPtr):unreal.VariantPtr;
public static function set_EventFunc(self:unreal.VariantPtr, value:unreal.VariantPtr):Void;
