...
package uhx.glues;
@:unrealGlue extern class FEpicSynth1Patch_Glue {
public static function get_PatchCables(self:unreal.VariantPtr):unreal.VariantPtr;
public static function set_PatchCables(self:unreal.VariantPtr, value:unreal.VariantPtr):Void;
public static function get_PatchSource(self:unreal.VariantPtr):Int;
public static function set_PatchSource(self:unreal.VariantPtr, value:Int):Void;
