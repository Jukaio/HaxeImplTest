...
@:uextern @:uclass extern class UGizmoComponentAxisSource extends unreal.UObject implements unreal.interactivetoolsframework.IGizmoAxisSource {
  
  /**
    If false, returns World axes
  **/
  @:uproperty public var bLocalAxes : Bool;
  
  /**
    Clamped internally to 0,1,2
  **/
  @:uproperty public var AxisIndex : unreal.Int32;
  @:uproperty public var Component : unreal.USceneComponent;
