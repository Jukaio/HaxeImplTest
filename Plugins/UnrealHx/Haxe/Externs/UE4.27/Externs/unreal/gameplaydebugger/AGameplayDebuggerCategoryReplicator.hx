...
@:uextern @:uclass extern class AGameplayDebuggerCategoryReplicator extends unreal.AActor {
  ...
  **/
  ...
  @:uproperty private var VisLogSync : unreal.gameplaydebugger.FGameplayDebuggerVisLogSync;
  ...
  @:ufunction(Server) private function ServerSetDebugActor(Actor : unreal.AActor, bSelectInEditor : Bool) : Void;
