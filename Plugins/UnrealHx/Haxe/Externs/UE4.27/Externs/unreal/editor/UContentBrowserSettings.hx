...
@:uextern @:uclass extern class UContentBrowserSettings extends unreal.UObject {
  ...
  **/
  @:uproperty public var bEnableRealtimeMaterialInstanceThumbnails : Bool;
