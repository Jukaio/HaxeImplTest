...
@:uextern @:ustruct extern class FMagicLeapPlaneBoundary {
  
  /**
    A polygon may contains multiple holes.
  **/
  @:uproperty public var Holes : unreal.TArray<unreal.magicleapplanes.FMagicLeapPolygon>;
  
  /**
    The polygon that defines the region.
  **/
  @:uproperty public var Polygon : unreal.magicleapplanes.FMagicLeapPolygon;
