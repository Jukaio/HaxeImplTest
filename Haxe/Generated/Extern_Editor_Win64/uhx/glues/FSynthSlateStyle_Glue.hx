...
package uhx.glues;
@:unrealGlue extern class FSynthSlateStyle_Glue {
public static function get_ColorStyle(self:unreal.VariantPtr):Int;
public static function set_ColorStyle(self:unreal.VariantPtr, value:Int):Void;
public static function get_SizeType(self:unreal.VariantPtr):Int;
public static function set_SizeType(self:unreal.VariantPtr, value:Int):Void;
