...
@:uextern @:uclass extern class UNiagaraDataInterfaceRenderTargetCube extends unreal.niagara.UNiagaraDataInterfaceRWBase {
  @:uproperty private var ManagedRenderTargets : unreal.TMap<unreal.FakeUInt64, unreal.UTextureRenderTargetCube>;
