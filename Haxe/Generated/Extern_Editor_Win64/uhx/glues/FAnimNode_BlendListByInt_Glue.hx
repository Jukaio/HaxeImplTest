...
package uhx.glues;
@:unrealGlue extern class FAnimNode_BlendListByInt_Glue {
public static function get_ActiveChildIndex(self:unreal.VariantPtr):Int;
public static function set_ActiveChildIndex(self:unreal.VariantPtr, value:Int):Void;
