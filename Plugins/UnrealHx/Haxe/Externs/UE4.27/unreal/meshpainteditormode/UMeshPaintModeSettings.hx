...
@:uextern @:uclass extern class UMeshPaintModeSettings extends unreal.UObject {
  
  /**
    Color view mode used to display Vertex Colors
  **/
  @:uproperty public var ColorViewMode : unreal.meshpaintingtoolset.EMeshPaintDataColorViewMode;
