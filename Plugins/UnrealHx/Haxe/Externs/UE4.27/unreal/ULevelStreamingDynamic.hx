...
@:uextern @:uclass extern class ULevelStreamingDynamic extends unreal.ULevelStreaming {
  ...
  **/
  @:ufunction(BlueprintCallable) static public function LoadLevelInstance(WorldContextObject : unreal.UObject, LevelName : unreal.FString, Location : unreal.FVector, Rotation : unreal.FRotator, bOutSuccess : Bool, OptionalLevelNameOverride : unreal.FString) : unreal.ULevelStreamingDynamic;
