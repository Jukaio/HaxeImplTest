...
package uhx.glues;
@:unrealGlue extern class FSoftObjectPtr_Glue {
public static function create():unreal.VariantPtr;
public static function createWithObject(Object:unreal.UIntPtr):unreal.VariantPtr;
public static function Get(self:unreal.VariantPtr):unreal.UIntPtr;
public static function ToSoftObjectPath(self:unreal.VariantPtr):unreal.VariantPtr;
