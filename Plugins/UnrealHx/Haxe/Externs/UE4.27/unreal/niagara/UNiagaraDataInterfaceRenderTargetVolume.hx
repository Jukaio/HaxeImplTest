...
@:uextern @:uclass extern class UNiagaraDataInterfaceRenderTargetVolume extends unreal.niagara.UNiagaraDataInterfaceRWBase {
  @:uproperty private var ManagedRenderTargets : unreal.TMap<unreal.FakeUInt64, unreal.UTextureRenderTargetVolume>;
  ...
  **/
  ...
  @:uproperty public var Size : unreal.FIntVector;
