...
@:uextern @:uclass extern class UMaterialExpressionMakeMaterialAttributes extends unreal.UMaterialExpression {
  @:uproperty public var ShadingModel : unreal.FExpressionInput;
  ...
  @:uproperty public var Tangent : unreal.FExpressionInput;
  ...
  @:uproperty public var Anisotropy : unreal.FExpressionInput;
