...
package uhx.glues;
@:unrealGlue extern class FModifierKeysState_Glue {
public static function createWithValues(bIsLeftShiftDown:Bool, bIsRightShiftDown:Bool, bIsLeftControlDown:Bool, bIsRightControlDown:Bool, bIsLeftAltDown:Bool, bIsRightAltDown:Bool, bIsLeftCommandDown:Bool, bIsRightCommandDown:Bool, bAreCapsLocked:Bool):unreal.VariantPtr;
