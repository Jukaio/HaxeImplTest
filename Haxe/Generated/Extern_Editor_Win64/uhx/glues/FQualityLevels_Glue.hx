...
package uhx.glues;
@:unrealGlue extern class FQualityLevels_Glue {
...
public static function GetSingleQualityLevel(self:unreal.VariantPtr):Int;
public static function SetFromSingleQualityLevel(self:unreal.VariantPtr, Value:Int):Void;
