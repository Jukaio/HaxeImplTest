...
package uhx.glues;
@:unrealGlue extern class FOnQueryOnlineStoreOffersComplete_Glue {
...
public static function Execute(self:unreal.VariantPtr, arg_0:Bool, arg_1:unreal.VariantPtr, arg_2:unreal.VariantPtr):Void;
public static function ExecuteIfBound(self:unreal.VariantPtr, arg_0:Bool, arg_1:unreal.VariantPtr, arg_2:unreal.VariantPtr):Void;
