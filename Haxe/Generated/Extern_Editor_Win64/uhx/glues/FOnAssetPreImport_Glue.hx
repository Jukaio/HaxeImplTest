...
package uhx.glues;
@:unrealGlue extern class FOnAssetPreImport_Glue {
...
public static function Broadcast(self:unreal.VariantPtr, arg_0:unreal.UIntPtr, arg_1:unreal.UIntPtr, arg_2:unreal.UIntPtr, arg_3:unreal.VariantPtr, arg_4:unreal.UIntPtr):Void;
