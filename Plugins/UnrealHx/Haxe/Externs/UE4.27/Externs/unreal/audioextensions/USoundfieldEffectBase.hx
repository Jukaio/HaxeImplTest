...
@:uextern @:uclass extern class USoundfieldEffectBase extends unreal.UObject {
  
  /**
    TODO: Filter classes settable on here by GetSettingsClass.
  **/
  @:uproperty public var Settings : unreal.audioextensions.USoundfieldEffectSettingsBase;
