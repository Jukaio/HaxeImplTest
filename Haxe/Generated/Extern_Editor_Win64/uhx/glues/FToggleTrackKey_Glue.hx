...
package uhx.glues;
@:unrealGlue extern class FToggleTrackKey_Glue {
public static function get_ToggleAction(self:unreal.VariantPtr):Int;
public static function set_ToggleAction(self:unreal.VariantPtr, value:Int):Void;
