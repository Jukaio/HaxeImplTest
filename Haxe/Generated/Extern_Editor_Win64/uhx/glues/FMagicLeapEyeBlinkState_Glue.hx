...
package uhx.glues;
@:unrealGlue extern class FMagicLeapEyeBlinkState_Glue {
public static function get_RightEyeBlinked(self:unreal.VariantPtr):Bool;
public static function set_RightEyeBlinked(self:unreal.VariantPtr, value:Bool):Void;
public static function get_LeftEyeBlinked(self:unreal.VariantPtr):Bool;
public static function set_LeftEyeBlinked(self:unreal.VariantPtr, value:Bool):Void;
