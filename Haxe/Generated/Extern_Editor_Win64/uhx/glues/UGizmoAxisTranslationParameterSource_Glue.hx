...
package uhx.glues;
@:unrealGlue extern class UGizmoAxisTranslationParameterSource_Glue {
...
public static function get_CurTranslationAxis(self:unreal.UIntPtr):unreal.VariantPtr;
public static function set_CurTranslationAxis(self:unreal.UIntPtr, value:unreal.VariantPtr):Void;
