...
@:uextern @:uclass extern class UTextLayoutWidget extends unreal.umg.UWidget {
  ...
  **/
  @:uproperty(BlueprintSetter=SetJustification) private var Justification : unreal.slate.ETextJustify;
  ...
  **/
  ...
  @:ufunction(BlueprintCallable) public function SetJustification(InJustification : unreal.slate.ETextJustify) : Void;
