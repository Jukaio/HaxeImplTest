...
@:uextern @:uclass extern class UAIPerceptionComponent extends unreal.UActorComponent {
  ...
  **/
  @:uproperty public var OnTargetPerceptionInfoUpdated : unreal.aimodule.FActorPerceptionInfoUpdatedDelegate;
  ...
  **/
  @:ufunction(BlueprintCallable) @:final public function ForgetAll() : Void;
  ...
  **/
  ...
  @:ufunction(BlueprintCallable) @:thisConst @:final public function GetPerceivedHostileActorsBySense(SenseToUse : unreal.Const<unreal.TSubclassOf<unreal.aimodule.UAISense>>, OutActors : unreal.PRef<unreal.TArray<unreal.AActor>>) : Void;
