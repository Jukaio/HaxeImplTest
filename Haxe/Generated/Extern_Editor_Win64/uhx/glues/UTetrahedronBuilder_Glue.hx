...
package uhx.glues;
@:unrealGlue extern class UTetrahedronBuilder_Glue {
...
public static function get_SphereExtrapolation(self:unreal.UIntPtr):Int;
public static function set_SphereExtrapolation(self:unreal.UIntPtr, value:Int):Void;
