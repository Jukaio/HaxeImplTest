...
package uhx.glues;
@:unrealGlue extern class URadialFalloff_Glue {
...
public static function SetRadialFalloff(self:unreal.UIntPtr, Magnitude:cpp.Float32, MinRange:cpp.Float32, MaxRange:cpp.Float32, Default:cpp.Float32, Radius:cpp.Float32, Position:unreal.VariantPtr, Falloff:Int):unreal.UIntPtr;
