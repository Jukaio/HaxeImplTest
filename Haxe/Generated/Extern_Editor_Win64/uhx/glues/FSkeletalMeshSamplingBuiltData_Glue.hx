...
package uhx.glues;
@:unrealGlue extern class FSkeletalMeshSamplingBuiltData_Glue {
public static function get_RegionBuiltData(self:unreal.VariantPtr):unreal.VariantPtr;
public static function set_RegionBuiltData(self:unreal.VariantPtr, value:unreal.VariantPtr):Void;
public static function get_WholeMeshBuiltData(self:unreal.VariantPtr):unreal.VariantPtr;
public static function set_WholeMeshBuiltData(self:unreal.VariantPtr, value:unreal.VariantPtr):Void;
