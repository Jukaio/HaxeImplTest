...
package uhx.glues;
@:unrealGlue extern class FInputTouchBinding_Glue {
public static function glueNew(InKeyEvent:Int):unreal.VariantPtr;
...
public static function get_TouchDelegate(self:unreal.VariantPtr):unreal.VariantPtr;
public static function set_TouchDelegate(self:unreal.VariantPtr, value:unreal.VariantPtr):Void;
