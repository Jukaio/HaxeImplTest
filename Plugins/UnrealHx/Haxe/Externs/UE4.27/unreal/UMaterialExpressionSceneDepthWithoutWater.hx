...
@:noClass @:uextern @:uclass extern class UMaterialExpressionSceneDepthWithoutWater extends unreal.UMaterialExpression {
  
  /**
    Depth to fall back to in case the needed texture isn't available on a particular platform or configuration
  **/
  @:uproperty public var FallbackDepth : unreal.Float32;
