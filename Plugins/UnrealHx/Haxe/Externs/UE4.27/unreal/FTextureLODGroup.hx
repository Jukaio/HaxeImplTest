...
@:uextern @:ustruct extern class FTextureLODGroup {
  ...
  @:uproperty public var VirtualTextureTileSizeBias : unreal.Int32;
  @:uproperty public var VirtualTextureTileCountBias : unreal.Int32;
  @:uproperty public var DownscaleOptions : unreal.ETextureDownscaleOptions;
  @:uproperty public var Downscale : unreal.Float32;
  @:uproperty public var DuplicateNonOptionalMips : Bool;
  ...
  **/
  @:uproperty public var HighPriorityLoad : Bool;
