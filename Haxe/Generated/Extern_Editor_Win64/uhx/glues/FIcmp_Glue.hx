...
package uhx.glues;
@:unrealGlue extern class FIcmp_Glue {
public static function IcmpEcho(TargetAddress:unreal.VariantPtr, Timeout:cpp.Float32, HandleResult:unreal.VariantPtr):Void;
