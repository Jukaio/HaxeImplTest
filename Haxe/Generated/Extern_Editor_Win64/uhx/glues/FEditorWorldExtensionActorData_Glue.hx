...
package uhx.glues;
@:unrealGlue extern class FEditorWorldExtensionActorData_Glue {
public static function get_bValidForPIE(self:unreal.VariantPtr):Bool;
public static function set_bValidForPIE(self:unreal.VariantPtr, value:Bool):Void;
