...
package uhx.glues;
@:unrealGlue extern class FSourceEffectBitCrusherBaseSettings_Glue {
public static function get_BitDepth(self:unreal.VariantPtr):cpp.Float32;
public static function set_BitDepth(self:unreal.VariantPtr, value:cpp.Float32):Void;
