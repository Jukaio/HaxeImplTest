...
@:uextern @:ustruct extern class FQuartzTransportTimeStamp {
  
  /**
    The time in seconds that this TimeStamp occured at
  **/
  @:uproperty public var Seconds : unreal.Float32;
  
  /**
    A fractional representation of the time that's played since the last bear
  **/
  @:uproperty public var BeatFraction : unreal.Float32;
  
  /**
    The current beat this clock is on
  **/
  @:uproperty public var Beat : unreal.Int32;
  
  /**
    The current bar this clock is on
  **/
  @:uproperty public var Bars : unreal.Int32;
