...
package uhx.glues;
@:unrealGlue extern class FCurveTableRowHandle_Glue {
...
public static function get_CurveTable(self:unreal.VariantPtr):unreal.UIntPtr;
public static function set_CurveTable(self:unreal.VariantPtr, value:unreal.UIntPtr):Void;
