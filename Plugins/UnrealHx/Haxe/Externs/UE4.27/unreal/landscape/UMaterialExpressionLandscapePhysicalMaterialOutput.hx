...
@:uextern @:uclass extern class UMaterialExpressionLandscapePhysicalMaterialOutput extends unreal.UMaterialExpressionCustomOutput {
  
  /**
    Array of physical material inputs.
  **/
  @:uproperty public var Inputs : unreal.TArray<unreal.landscape.FPhysicalMaterialInput>;
