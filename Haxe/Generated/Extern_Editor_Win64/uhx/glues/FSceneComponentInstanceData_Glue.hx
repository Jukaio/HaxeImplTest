...
package uhx.glues;
@:unrealGlue extern class FSceneComponentInstanceData_Glue {
public static function get_AttachedInstanceComponents(self:unreal.VariantPtr):unreal.VariantPtr;
public static function set_AttachedInstanceComponents(self:unreal.VariantPtr, value:unreal.VariantPtr):Void;
