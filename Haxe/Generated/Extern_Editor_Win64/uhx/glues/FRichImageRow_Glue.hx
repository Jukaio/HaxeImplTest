...
package uhx.glues;
@:unrealGlue extern class FRichImageRow_Glue {
public static function get_Brush(self:unreal.VariantPtr):unreal.VariantPtr;
public static function set_Brush(self:unreal.VariantPtr, value:unreal.VariantPtr):Void;
