...
@:uextern @:uclass extern class UKismetMaterialLibrary extends unreal.UBlueprintFunctionLibrary {
  ...
  **/
  @:ufunction(BlueprintCallable) static public function CreateDynamicMaterialInstance(WorldContextObject : unreal.UObject, Parent : unreal.UMaterialInterface, @:opt("None") OptionalName : unreal.FName, @:opt("None") CreationFlags : unreal.EMIDCreationFlags) : unreal.UMaterialInstanceDynamic;
