...
package uhx.glues;
@:unrealGlue extern class FAnimNode_RandomPlayer_Glue {
public static function get_bShuffleMode(self:unreal.VariantPtr):Bool;
public static function set_bShuffleMode(self:unreal.VariantPtr, value:Bool):Void;
