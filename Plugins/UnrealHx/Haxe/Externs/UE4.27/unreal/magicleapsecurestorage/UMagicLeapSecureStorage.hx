...
@:uextern @:uclass extern class UMagicLeapSecureStorage extends unreal.UBlueprintFunctionLibrary {
  ...
  **/
  ...
  /**
    ...
    @return  True if the data was stored successfully, false otherwise.
  **/
  @:ufunction(BlueprintCallable) static public function PutSecureInt64(Key : unreal.FString, DataToStore : unreal.Int64) : Bool;
  ...
  **/
  ...
  /**
    ...
    @return  True if the key was found and output parameter was successfully populated with the data, false otherwise.
  **/
  @:ufunction(BlueprintCallable) static public function GetSecureInt64(Key : unreal.FString, DataToRetrieve : unreal.Int64) : Bool;
  ...
  **/
  ...
  /**
    ...
    @return  True if the data was stored successfully, false otherwise.
  **/
  @:ufunction(BlueprintCallable) static public function PutSecureSaveGame(Key : unreal.FString, ObjectToStore : unreal.USaveGame) : Bool;
  ...
  /**
    ...
    @return  True if the data was stored successfully, false otherwise.
  **/
  @:ufunction(BlueprintCallable) static public function PutSecureArray(Key : unreal.FString, DataToStore : unreal.Const<unreal.PRef<unreal.TArray<unreal.Int32>>>) : Bool;
  ...
  /**
    ...
    @return  True if the key was found and output parameter was successfully populated with the data, false otherwise.
  **/
  @:ufunction(BlueprintCallable) static public function GetSecureArray(Key : unreal.FString, DataToRetrieve : unreal.PRef<unreal.TArray<unreal.Int32>>) : Bool;
