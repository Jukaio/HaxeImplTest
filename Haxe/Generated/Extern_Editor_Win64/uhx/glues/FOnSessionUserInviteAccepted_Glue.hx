...
package uhx.glues;
@:unrealGlue extern class FOnSessionUserInviteAccepted_Glue {
...
public static function Broadcast(self:unreal.VariantPtr, arg_0:Bool, arg_1:Int, arg_2:unreal.VariantPtr, arg_3:unreal.VariantPtr):Void;
