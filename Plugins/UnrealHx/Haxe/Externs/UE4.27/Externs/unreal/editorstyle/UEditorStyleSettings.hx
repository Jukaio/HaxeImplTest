...
@:uextern @:uclass extern class UEditorStyleSettings extends unreal.UObject {
  ...
  **/
  @:uproperty public var bEnableLegacyEditorModeUI : Bool;
  ...
  **/
  @:uproperty public var bShowNativeComponentNames : Bool;
  ...
  **/
  @:uproperty public var GraphBackgroundBrush : unreal.slatecore.FSlateBrush;
  ...
  **/
  @:uproperty public var bEnableUserEditorLayoutManagement : Bool;
