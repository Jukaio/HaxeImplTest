...
@:uextern @:uclass extern class UTakeMetaData extends unreal.UObject implements unreal.levelsequence.ILevelSequenceMetaData {
  ...
  **/
  @:ufunction(BlueprintCallable) @:thisConst @:final public function GetTimecodeIn() : unreal.FTimecode;
  
  /**
    @return The timecode out for this take
  **/
  @:ufunction(BlueprintCallable) @:thisConst @:final public function GetTimecodeOut() : unreal.FTimecode;
  ...
  **/
  @:ufunction(BlueprintCallable) @:final public function GetFrameRate() : unreal.FFrameRate;
  ...
  **/
  @:ufunction(BlueprintCallable) @:thisConst @:final public function GetFrameRateFromTimecode() : Bool;
  ...
  **/
  @:ufunction(BlueprintCallable) @:final public function SetSlate(InSlate : unreal.FString, bEmitChanged : Bool = true) : Void;
  ...
  /**
    ...
    @note: Only valid for takes that have not been locked
  **/
  @:ufunction(BlueprintCallable) @:final public function SetTakeNumber(InTakeNumber : unreal.Int32, bEmitChanged : Bool = true) : Void;
  ...
  **/
  ...
  /**
    ...
    @note: Only valid for takes that have not been locked
  **/
  @:ufunction(BlueprintCallable) @:final public function SetTimecodeIn(InTimecodeIn : unreal.FTimecode) : Void;
  
  /**
    Set this take's timecode out
    @note: Only valid for takes that have not been locked
  **/
  @:ufunction(BlueprintCallable) @:final public function SetTimecodeOut(InTimecodeOut : unreal.FTimecode) : Void;
  ...
  **/
  @:ufunction(BlueprintCallable) @:final public function SetFrameRateFromTimecode(InFromTimecode : Bool) : Void;
