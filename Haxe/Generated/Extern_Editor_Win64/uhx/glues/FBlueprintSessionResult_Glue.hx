...
package uhx.glues;
@:unrealGlue extern class FBlueprintSessionResult_Glue {
public static function create():unreal.VariantPtr;
public static function createNew():unreal.VariantPtr;
public static function get_OnlineResult(self:unreal.VariantPtr):unreal.VariantPtr;
public static function set_OnlineResult(self:unreal.VariantPtr, value:unreal.VariantPtr):Void;
}