...
package uhx.glues;
@:unrealGlue extern class FWebSocketRawMessageEvent_Glue {
...
public static function Broadcast(self:unreal.VariantPtr, arg_0:unreal.ConstAnyPtr, arg_1:unreal.SizeT, arg_2:unreal.SizeT):Void;
