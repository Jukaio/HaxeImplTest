...
@:uextern @:uclass extern class UNetworkSettings extends unreal.developersettings.UDeveloperSettings {
  
  /**
    This lists the common network emulation profiles that will be selectable in PIE settings
  **/
  @:uproperty public var NetworkEmulationProfiles : unreal.TArray<unreal.FNetworkEmulationProfileDescription>;
