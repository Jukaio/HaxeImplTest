...
package uhx.glues;
@:unrealGlue extern class FEventGraphFastCallPair_Glue {
public static function get_EventGraphCallOffset(self:unreal.VariantPtr):Int;
public static function set_EventGraphCallOffset(self:unreal.VariantPtr, value:Int):Void;
public static function get_FunctionToPatch(self:unreal.VariantPtr):unreal.UIntPtr;
public static function set_FunctionToPatch(self:unreal.VariantPtr, value:unreal.UIntPtr):Void;
