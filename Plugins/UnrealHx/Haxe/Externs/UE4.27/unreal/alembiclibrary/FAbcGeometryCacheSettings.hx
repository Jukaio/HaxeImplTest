...
@:noCopy @:noEquals @:uextern @:ustruct extern class FAbcGeometryCacheSettings {
  ...
  **/
  ...
  @:uproperty public var MotionVectors : unreal.alembiclibrary.EAbcGeometryCacheMotionVectorsImport;
  ...
  **/
  @:deprecated @:uproperty public var bCalculateMotionVectorsDuringImport_DEPRECATED : Bool;
