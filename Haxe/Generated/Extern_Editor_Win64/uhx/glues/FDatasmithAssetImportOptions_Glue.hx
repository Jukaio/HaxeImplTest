...
package uhx.glues;
@:unrealGlue extern class FDatasmithAssetImportOptions_Glue {
public static function get_PackagePath(self:unreal.VariantPtr):unreal.VariantPtr;
public static function set_PackagePath(self:unreal.VariantPtr, value:unreal.VariantPtr):Void;
