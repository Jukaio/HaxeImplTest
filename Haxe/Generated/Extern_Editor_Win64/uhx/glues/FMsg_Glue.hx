...
package uhx.glues;
@:unrealGlue extern class FMsg_Glue {
public static function Logf(file:unreal.UIntPtr, line:Int, category:unreal.VariantPtr, verbosity:Int, data:unreal.UIntPtr):Void;
