...
package uhx.glues;
@:unrealGlue extern class FGeoTrackingAvailabilityDelegate_Glue {
public static function create():unreal.VariantPtr;
public static function createNew():unreal.VariantPtr;
public static function Broadcast(self:unreal.VariantPtr, arg_0:Bool, arg_1:unreal.VariantPtr):Void;
