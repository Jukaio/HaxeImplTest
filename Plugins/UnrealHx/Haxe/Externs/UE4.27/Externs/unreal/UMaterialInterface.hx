...
@:uextern @:uclass extern class UMaterialInterface extends unreal.UObject implements unreal.IBlendableInterface implements unreal.IInterface_AssetUserData {
  ...
  **/
  ...
  @:uproperty public var ParameterOverviewExpansion : unreal.TMap<unreal.FString, Bool>;
  @:uproperty public var LayerParameterExpansion : unreal.TMap<unreal.FString, Bool>;
  ...
  **/
  @:uproperty public var TextureStreamingDataMissingEntries : unreal.TArray<unreal.FMaterialTextureInfo>;
  ...
  **/
  ...
  @:ufunction(BlueprintCallable) @:thisConst @:final public function GetParameterInfo(Association : unreal.EMaterialParameterAssociation, ParameterName : unreal.FName, LayerFunction : unreal.UMaterialFunctionInterface) : unreal.FMaterialParameterInfo;
  ...
  **/
  @:ufunction(BlueprintCallable) public function SetForceMipLevelsToBeResident(OverrideForceMiplevelsToBeResident : Bool, bForceMiplevelsToBeResidentValue : Bool, ForceDuration : unreal.Float32, CinematicTextureGroups : unreal.Int32 = 0, bFastResponse : Bool = false) : Void;
