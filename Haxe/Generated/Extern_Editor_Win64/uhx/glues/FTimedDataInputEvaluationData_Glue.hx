...
package uhx.glues;
@:unrealGlue extern class FTimedDataInputEvaluationData_Glue {
public static function get_DistanceToOldestSampleSeconds(self:unreal.VariantPtr):cpp.Float32;
public static function set_DistanceToOldestSampleSeconds(self:unreal.VariantPtr, value:cpp.Float32):Void;
public static function get_DistanceToNewestSampleSeconds(self:unreal.VariantPtr):cpp.Float32;
public static function set_DistanceToNewestSampleSeconds(self:unreal.VariantPtr, value:cpp.Float32):Void;
