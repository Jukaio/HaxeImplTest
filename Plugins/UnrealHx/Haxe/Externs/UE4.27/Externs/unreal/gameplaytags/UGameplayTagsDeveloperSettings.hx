...
@:uextern @:uclass extern class UGameplayTagsDeveloperSettings extends unreal.developersettings.UDeveloperSettings {
  ...
  **/
  @:uproperty public var FavoriteTagSource : unreal.FName;
