...
@:uextern @:uclass extern class UMagicLeapHandTrackingFunctionLibrary extends unreal.UBlueprintFunctionLibrary {
  ...
  **/
  ...
  /**
    ...
    @return true if the output param was populated with a valid value, false means that is is either unchanged or populated with a stale value.
  **/
  @:ufunction(BlueprintCallable) static public function GetHandIndexFingerTip(Hand : unreal.inputcore.EControllerHand, TransformSpace : unreal.magicleaphandtracking.EMagicLeapGestureTransformSpace, Pointer : unreal.PRef<unreal.FTransform>) : Bool;
  ...
  /**
    ...
    @return true if the output param was populated with a valid value, false means that is is either unchanged or populated with a stale value.
  **/
  @:ufunction(BlueprintCallable) static public function GetHandThumbTip(Hand : unreal.inputcore.EControllerHand, TransformSpace : unreal.magicleaphandtracking.EMagicLeapGestureTransformSpace, Secondary : unreal.PRef<unreal.FTransform>) : Bool;
  ...
  **/
  ...
  /**
    ...
    @return true if the output param was populated with a valid value, false means that is is either unchanged or populated with a stale value.
  **/
  @:ufunction(BlueprintCallable) static public function GetGestureKeypointTransform(Hand : unreal.inputcore.EControllerHand, Keypoint : unreal.magicleaphandtracking.EMagicLeapHandTrackingKeypoint, TransformSpace : unreal.magicleaphandtracking.EMagicLeapGestureTransformSpace, Transform : unreal.PRef<unreal.FTransform>) : Bool;
  ...
  **/
  @:ufunction(BlueprintCallable) static public function SetConfiguration(StaticGesturesToActivate : unreal.Const<unreal.PRef<unreal.TArray<unreal.magicleaphandtracking.EMagicLeapHandTrackingGesture>>>, @:opt("NoFilter") KeypointsFilterLevel : unreal.magicleaphandtracking.EMagicLeapHandTrackingKeypointFilterLevel, @:opt("NoFilter") GestureFilterLevel : unreal.magicleaphandtracking.EMagicLeapHandTrackingGestureFilterLevel, bTrackingEnabled : Bool = true) : Bool;
  ...
  **/
  @:ufunction(BlueprintCallable) static public function SetStaticGestureConfidenceThreshold(Gesture : unreal.magicleaphandtracking.EMagicLeapHandTrackingGesture, Confidence : unreal.Float32) : Void;
  ...
  **/
  @:ufunction(BlueprintCallable) static public function GetStaticGestureConfidenceThreshold(Gesture : unreal.magicleaphandtracking.EMagicLeapHandTrackingGesture) : unreal.Float32;
  ...
  **/
  ...
  /**
    ...
    @return true if the output param was populated with a valid value, false otherwise.
  **/
  @:ufunction(BlueprintCallable) static public function GetCurrentGesture(Hand : unreal.inputcore.EControllerHand, Gesture : unreal.Ref<unreal.magicleaphandtracking.EMagicLeapHandTrackingGesture>) : Bool;
  ...
  **/
  @:ufunction(BlueprintCallable) static public function IsHoldingControl(Hand : unreal.inputcore.EControllerHand) : Bool;
  ...
  **/
  @:ufunction(BlueprintCallable) static public function GetMotionSourceForHandKeypoint(Hand : unreal.inputcore.EControllerHand, Keypoint : unreal.magicleaphandtracking.EMagicLeapHandTrackingKeypoint, OutMotionSource : unreal.PRef<unreal.FName>) : Bool;
  ...
  /**
    ...
    @return True if the lookup succeeded, false othewise.
  **/
  @:ufunction(BlueprintCallable) static public function GetHandKeypointForMotionSource(MotionSource : unreal.FName, OutKeyPoint : unreal.Ref<unreal.magicleaphandtracking.EMagicLeapHandTrackingKeypoint>) : Bool;
