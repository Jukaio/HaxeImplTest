...
@:noClass @:uextern @:uclass extern class UEditorLevelUtils extends unreal.UObject {
  ...
  **/
  @:ufunction(BlueprintCallable) static public function MoveActorsToLevel(ActorsToMove : unreal.Const<unreal.PRef<unreal.TArray<unreal.AActor>>>, DestStreamingLevel : unreal.ULevelStreaming, bWarnAboutReferences : Bool = true, bWarnAboutRenaming : Bool = true) : unreal.Int32;
  ...
  **/
  @:ufunction(BlueprintCallable) static public function SetLevelVisibility(Level : unreal.ULevel, bShouldBeVisible : Bool, bForceLayersVisible : Bool, @:opt("ModifyOnChange") ModifyMode : unreal.Const<unreal.editor.ELevelVisibilityDirtyMode>) : Void;
  ...
  /**
    ...
    @param       ModifyMode                              ELevelVisibilityDirtyMode mode value.
  **/
  @:ufunction(BlueprintCallable) static public function SetLevelsVisibility(Levels : unreal.Const<unreal.PRef<unreal.TArray<unreal.ULevel>>>, bShouldBeVisible : unreal.Const<unreal.PRef<unreal.TArray<Bool>>>, bForceLayersVisible : Bool, @:opt("ModifyOnChange") ModifyMode : unreal.Const<unreal.editor.ELevelVisibilityDirtyMode>) : Void;
