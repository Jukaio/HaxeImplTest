...
package uhx.glues;
@:unrealGlue extern class FAnimSequenceTrackContainer_Glue {
public static function get_TrackNames(self:unreal.VariantPtr):unreal.VariantPtr;
public static function set_TrackNames(self:unreal.VariantPtr, value:unreal.VariantPtr):Void;
public static function get_AnimationTracks(self:unreal.VariantPtr):unreal.VariantPtr;
public static function set_AnimationTracks(self:unreal.VariantPtr, value:unreal.VariantPtr):Void;
