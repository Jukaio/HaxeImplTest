...
package uhx.glues;
@:unrealGlue extern class FRotationMatrix_Glue {
public static function createWithRotator(rot:unreal.VariantPtr):unreal.VariantPtr;
public static function createNewWithRotator(rot:unreal.VariantPtr):unreal.VariantPtr;
