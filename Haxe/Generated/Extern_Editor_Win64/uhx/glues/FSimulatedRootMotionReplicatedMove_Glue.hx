...
package uhx.glues;
@:unrealGlue extern class FSimulatedRootMotionReplicatedMove_Glue {
public static function get_RootMotion(self:unreal.VariantPtr):unreal.VariantPtr;
public static function set_RootMotion(self:unreal.VariantPtr, value:unreal.VariantPtr):Void;
