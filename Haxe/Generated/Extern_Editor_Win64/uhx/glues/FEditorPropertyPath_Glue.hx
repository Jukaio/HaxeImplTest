...
package uhx.glues;
@:unrealGlue extern class FEditorPropertyPath_Glue {
public static function get_Segments(self:unreal.VariantPtr):unreal.VariantPtr;
public static function set_Segments(self:unreal.VariantPtr, value:unreal.VariantPtr):Void;
