...
package uhx.glues;
@:unrealGlue extern class FSkelMeshComponentLODInfo_Glue {
public static function get_HiddenMaterials(self:unreal.VariantPtr):unreal.VariantPtr;
public static function set_HiddenMaterials(self:unreal.VariantPtr, value:unreal.VariantPtr):Void;
