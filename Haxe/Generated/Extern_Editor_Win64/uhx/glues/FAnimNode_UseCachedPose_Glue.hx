...
package uhx.glues;
@:unrealGlue extern class FAnimNode_UseCachedPose_Glue {
public static function get_CachePoseName(self:unreal.VariantPtr):unreal.VariantPtr;
public static function set_CachePoseName(self:unreal.VariantPtr, value:unreal.VariantPtr):Void;
public static function get_LinkToCachingNode(self:unreal.VariantPtr):unreal.VariantPtr;
public static function set_LinkToCachingNode(self:unreal.VariantPtr, value:unreal.VariantPtr):Void;
