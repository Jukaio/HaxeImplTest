...
package uhx.glues;
@:unrealGlue extern class FGizmoSelectData_Glue {
public static function get_HeightData(self:unreal.VariantPtr):cpp.Float32;
public static function set_HeightData(self:unreal.VariantPtr, value:cpp.Float32):Void;
