...
@:uextern @:uclass extern class UBlueprint extends unreal.UBlueprintCore {
  ...
  **/
  @:uproperty public var Extensions : unreal.TArray<unreal.UBlueprintExtension>;
  
  /**
    Maps old to new component template names
  **/
  @:uproperty public var OldToNewComponentTemplateNames : unreal.TMap<unreal.FName, unreal.FName>;
  
  /**
    Index map for component template names
  **/
  @:uproperty public var ComponentTemplateNameIndex : unreal.TMap<unreal.FName, unreal.Int32>;
  ...
  **/
  ...
  /**
    Bookmark data
  **/
  @:uproperty public var Bookmarks : unreal.TMap<unreal.FGuid, unreal.FEditedDocumentInfo>;
  ...
  **/
  @:uproperty public var PRIVATE_CachedMacroInfo : unreal.TMap<unreal.UEdGraph, unreal.FBlueprintMacroCosmeticInfo>;
  ...
  **/
  @:uproperty public var BlueprintNamespace : unreal.FString;
