...
package uhx.glues;
@:unrealGlue extern class FMovieScenePropertySectionTemplate_Glue {
public static function get_PropertyData(self:unreal.VariantPtr):unreal.VariantPtr;
public static function set_PropertyData(self:unreal.VariantPtr, value:unreal.VariantPtr):Void;
