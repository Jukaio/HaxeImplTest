...
@:uextern @:uclass extern class UKismetInputLibrary extends unreal.UBlueprintFunctionLibrary {
  ...
  **/
  @:ufunction(BlueprintCallable) static public function Key_IsAxis1D(Key : unreal.Const<unreal.PRef<unreal.inputcore.FKey>>) : Bool;
  
  /**
    Returns true if the key is a 2D (vector) axis
  **/
  @:ufunction(BlueprintCallable) static public function Key_IsAxis2D(Key : unreal.Const<unreal.PRef<unreal.inputcore.FKey>>) : Bool;
  
  /**
    Returns true if the key is a 3D (vector) axis
  **/
  @:ufunction(BlueprintCallable) static public function Key_IsAxis3D(Key : unreal.Const<unreal.PRef<unreal.inputcore.FKey>>) : Bool;
  
  /**
    Returns true if the key is a 1D axis emulating a digital button press.
  **/
  @:ufunction(BlueprintCallable) static public function Key_IsButtonAxis(Key : unreal.Const<unreal.PRef<unreal.inputcore.FKey>>) : Bool;
  
  /**
    Returns true if the key is an analog axis
  **/
  @:ufunction(BlueprintCallable) static public function Key_IsAnalog(Key : unreal.Const<unreal.PRef<unreal.inputcore.FKey>>) : Bool;
  
  /**
    Returns true if the key is a digital button press
  **/
  @:ufunction(BlueprintCallable) static public function Key_IsDigital(Key : unreal.Const<unreal.PRef<unreal.inputcore.FKey>>) : Bool;
  ...
  **/
  ...
  @:ufunction(BlueprintCallable) static public function Key_GetNavigationAction(InKey : unreal.Const<unreal.PRef<unreal.inputcore.FKey>>) : unreal.slatecore.EUINavigationAction;
  
  /**
    Returns the navigation action corresponding to this key, or Invalid if not found
  **/
  @:ufunction(BlueprintCallable) static public function Key_GetNavigationActionFromKey(InKeyEvent : unreal.Const<unreal.PRef<unreal.slatecore.FKeyEvent>>) : unreal.slatecore.EUINavigationAction;
  
  /**
    Returns the navigation action corresponding to this key, or Invalid if not found
  **/
  @:ufunction(BlueprintCallable) static public function Key_GetNavigationDirectionFromKey(InKeyEvent : unreal.Const<unreal.PRef<unreal.slatecore.FKeyEvent>>) : unreal.slatecore.EUINavigation;
  
  /**
    Returns the navigation action corresponding to this key, or Invalid if not found
  **/
  @:ufunction(BlueprintCallable) static public function Key_GetNavigationDirectionFromAnalog(InAnalogEvent : unreal.Const<unreal.PRef<unreal.slatecore.FAnalogInputEvent>>) : unreal.slatecore.EUINavigation;
  ...
  **/
  @:ufunction(BlueprintCallable) static public function InputChord_GetDisplayName(Key : unreal.Const<unreal.PRef<unreal.slate.FInputChord>>) : unreal.FText;
