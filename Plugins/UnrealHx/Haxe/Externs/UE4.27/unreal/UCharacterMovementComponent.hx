...
@:uextern @:uclass extern class UCharacterMovementComponent extends unreal.UPawnMovementComponent implements unreal.IRVOAvoidanceInterface implements unreal.INetworkPredictionInterface {
  ...
  **/
  ...
  @:uproperty public var ServerCorrectionRootMotion : unreal.FRootMotionSourceGroup;
  ...
  **/
  @:uproperty public var bServerAcceptClientAuthoritativePosition : Bool;
  ...
  **/
  @:uproperty public var MaxJumpApexAttemptsPerSimulation : unreal.Int32;
