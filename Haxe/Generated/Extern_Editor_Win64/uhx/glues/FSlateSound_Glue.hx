...
package uhx.glues;
@:unrealGlue extern class FSlateSound_Glue {
public static function get_ResourceObject(self:unreal.VariantPtr):unreal.UIntPtr;
public static function set_ResourceObject(self:unreal.VariantPtr, value:unreal.UIntPtr):Void;
