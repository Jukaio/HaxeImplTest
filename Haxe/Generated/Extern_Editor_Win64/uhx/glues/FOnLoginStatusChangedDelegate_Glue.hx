...
package uhx.glues;
@:unrealGlue extern class FOnLoginStatusChangedDelegate_Glue {
...
public static function Execute(self:unreal.VariantPtr, arg_0:Int, arg_1:Int, arg_2:Int, arg_3:unreal.VariantPtr):Void;
public static function ExecuteIfBound(self:unreal.VariantPtr, arg_0:Int, arg_1:Int, arg_2:Int, arg_3:unreal.VariantPtr):Void;
