...
@:noClass @:uextern @:uclass extern class UEditorLoadingAndSavingUtils extends unreal.UObject {
  ...
  **/
  @:ufunction(BlueprintCallable) static public function ReloadPackages(PackagesToReload : unreal.Const<unreal.PRef<unreal.TArray<unreal.UPackage>>>, bOutAnyPackagesReloaded : Bool, OutErrorMessage : unreal.PRef<unreal.FText>, @:opt("Interactive") InteractionMode : unreal.Const<unreal.editor.EReloadPackagesInteractionMode>) : Void;
