...
package uhx.glues;
@:unrealGlue extern class FAnimSyncMarker_Glue {
...
public static function get_MarkerName(self:unreal.VariantPtr):unreal.VariantPtr;
public static function set_MarkerName(self:unreal.VariantPtr, value:unreal.VariantPtr):Void;
}