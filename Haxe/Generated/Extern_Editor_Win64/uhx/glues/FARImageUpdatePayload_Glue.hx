...
package uhx.glues;
@:unrealGlue extern class FARImageUpdatePayload_Glue {
public static function get_EstimatedSize(self:unreal.VariantPtr):unreal.VariantPtr;
public static function set_EstimatedSize(self:unreal.VariantPtr, value:unreal.VariantPtr):Void;
public static function get_DetectedImage(self:unreal.VariantPtr):unreal.UIntPtr;
public static function set_DetectedImage(self:unreal.VariantPtr, value:unreal.UIntPtr):Void;
