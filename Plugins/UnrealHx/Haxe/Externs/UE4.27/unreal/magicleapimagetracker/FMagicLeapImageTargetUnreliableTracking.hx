...
typedef FMagicLeapImageTargetUnreliableTracking = unreal.DynamicDelegate<FMagicLeapImageTargetUnreliableTracking, unreal.Const<unreal.PRef<unreal.FVector>>->unreal.Const<unreal.PRef<unreal.FRotator>>->unreal.Const<unreal.PRef<unreal.FVector>>->unreal.Const<unreal.PRef<unreal.FRotator>>->Void>;