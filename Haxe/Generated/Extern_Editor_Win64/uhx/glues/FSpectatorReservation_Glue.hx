...
package uhx.glues;
@:unrealGlue extern class FSpectatorReservation_Glue {
public static function get_Spectator(self:unreal.VariantPtr):unreal.VariantPtr;
public static function set_Spectator(self:unreal.VariantPtr, value:unreal.VariantPtr):Void;
public static function get_SpectatorId(self:unreal.VariantPtr):unreal.VariantPtr;
public static function set_SpectatorId(self:unreal.VariantPtr, value:unreal.VariantPtr):Void;
