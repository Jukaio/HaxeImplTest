...
@:uextern @:uclass extern class UAnimationBlueprintLibrary extends unreal.UBlueprintFunctionLibrary {
  ...
  **/
  @:ufunction(BlueprintCallable) static public function GetAnimationCurveNames(AnimationSequence : unreal.Const<unreal.UAnimSequence>, CurveType : unreal.ERawCurveTrackTypes, CurveNames : unreal.PRef<unreal.TArray<unreal.FName>>) : Void;
  ...
  **/
  @:ufunction(BlueprintCallable) static public function SetBoneCompressionSettings(AnimationSequence : unreal.UAnimSequence, CompressionSettings : unreal.UAnimBoneCompressionSettings) : Void;
  
  /**
    Sets the Curve Compression Settings for the given Animation Sequence
  **/
  @:ufunction(BlueprintCallable) static public function SetCurveCompressionSettings(AnimationSequence : unreal.UAnimSequence, CompressionSettings : unreal.UAnimCurveCompressionSettings) : Void;
  ...
  **/
  @:ufunction(BlueprintCallable) static public function AddAnimationNotifyEvent(AnimationSequence : unreal.UAnimSequence, NotifyTrackName : unreal.FName, StartTime : unreal.Float32, NotifyClass : unreal.TSubclassOf<unreal.UAnimNotify>) : unreal.Const<unreal.UAnimNotify>;
  
  /**
    Adds an Animation Notify State Event to Notify track in the given Animation with the given Notify State creation data
  **/
  @:ufunction(BlueprintCallable) static public function AddAnimationNotifyStateEvent(AnimationSequence : unreal.UAnimSequence, NotifyTrackName : unreal.FName, StartTime : unreal.Float32, Duration : unreal.Float32, NotifyStateClass : unreal.TSubclassOf<unreal.UAnimNotifyState>) : unreal.Const<unreal.UAnimNotifyState>;
  ...
  **/
  @:ufunction(BlueprintCallable) static public function AddAnimationNotifyStateEventObject(AnimationSequence : unreal.UAnimSequence, StartTime : unreal.Float32, Duration : unreal.Float32, NotifyState : unreal.Const<unreal.UAnimNotifyState>, NotifyTrackName : unreal.FName) : Void;
