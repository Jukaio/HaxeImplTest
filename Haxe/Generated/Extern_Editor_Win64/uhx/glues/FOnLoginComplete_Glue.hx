...
package uhx.glues;
@:unrealGlue extern class FOnLoginComplete_Glue {
...
public static function Broadcast(self:unreal.VariantPtr, arg_0:Int, arg_1:Bool, arg_2:unreal.VariantPtr, arg_3:unreal.VariantPtr):Void;
