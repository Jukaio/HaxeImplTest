...
package uhx.glues;
@:unrealGlue extern class UInterpTrackMoveAxis_Glue {
...
public static function get_MoveAxis(self:unreal.UIntPtr):Int;
public static function set_MoveAxis(self:unreal.UIntPtr, value:Int):Void;
