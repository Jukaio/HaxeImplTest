...
@:uextern @:uclass extern class USceneCaptureComponent2D extends unreal.USceneCaptureComponent {
  ...
  **/
  @:uproperty public var bDisableFlipCopyGLES : Bool;
  ...
  **/
  @:uproperty public var CustomNearClippingPlane : unreal.Float32;
  @:uproperty public var bOverride_CustomNearClippingPlane : Bool;
