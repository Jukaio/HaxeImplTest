...
@:uextern @:uclass extern class ULiveLinkPreset extends unreal.UObject {
  ...
  **/
  @:ufunction(BlueprintCallable) @:thisConst @:final public function ApplyToClient() : Bool;
  ...
  /**
    ...
    @return True is all sources and subjects from this preset could be created and added.
  **/
  @:ufunction(BlueprintCallable) @:thisConst @:final public function AddToClient(bRecreatePresets : Bool = true) : Bool;
  
  /**
    Reset this preset and build the list of sources and subjects from the client.
  **/
  @:ufunction(BlueprintCallable) @:final public function BuildFromClient() : Void;
