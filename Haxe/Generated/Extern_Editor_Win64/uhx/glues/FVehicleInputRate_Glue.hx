...
package uhx.glues;
@:unrealGlue extern class FVehicleInputRate_Glue {
public static function get_FallRate(self:unreal.VariantPtr):cpp.Float32;
public static function set_FallRate(self:unreal.VariantPtr, value:cpp.Float32):Void;
public static function get_RiseRate(self:unreal.VariantPtr):cpp.Float32;
public static function set_RiseRate(self:unreal.VariantPtr, value:cpp.Float32):Void;
