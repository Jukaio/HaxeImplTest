...
package uhx.glues;
@:unrealGlue extern class FNiagaraTypeDefinition_Glue {
public static function get_UnderlyingType(self:unreal.VariantPtr):cpp.UInt16;
public static function set_UnderlyingType(self:unreal.VariantPtr, value:cpp.UInt16):Void;
public static function get_ClassStructOrEnum(self:unreal.VariantPtr):unreal.UIntPtr;
public static function set_ClassStructOrEnum(self:unreal.VariantPtr, value:unreal.UIntPtr):Void;
