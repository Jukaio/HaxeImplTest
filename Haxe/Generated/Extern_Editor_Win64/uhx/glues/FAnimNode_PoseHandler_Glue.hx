...
package uhx.glues;
@:unrealGlue extern class FAnimNode_PoseHandler_Glue {
public static function get_PoseAsset(self:unreal.VariantPtr):unreal.UIntPtr;
public static function set_PoseAsset(self:unreal.VariantPtr, value:unreal.UIntPtr):Void;
