...
package uhx.glues;
@:unrealGlue extern class FNiagaraParameterStore_Glue {
public static function get_ParameterGuidMapping(self:unreal.VariantPtr):unreal.VariantPtr;
public static function set_ParameterGuidMapping(self:unreal.VariantPtr, value:unreal.VariantPtr):Void;
public static function get_DebugName(self:unreal.VariantPtr):unreal.VariantPtr;
public static function set_DebugName(self:unreal.VariantPtr, value:unreal.VariantPtr):Void;
