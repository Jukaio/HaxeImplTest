...
package uhx.glues;
@:unrealGlue extern class FFilterOptionPerAxis_Glue {
public static function get_bZ(self:unreal.VariantPtr):Bool;
public static function set_bZ(self:unreal.VariantPtr, value:Bool):Void;
public static function get_bY(self:unreal.VariantPtr):Bool;
public static function set_bY(self:unreal.VariantPtr, value:Bool):Void;
public static function get_bX(self:unreal.VariantPtr):Bool;
public static function set_bX(self:unreal.VariantPtr, value:Bool):Void;
