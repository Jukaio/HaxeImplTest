...
package uhx.glues;
@:unrealGlue extern class FEdGraphSchemaAction_K2ViewNode_Glue {
public static function get_NodePtr(self:unreal.VariantPtr):unreal.UIntPtr;
public static function set_NodePtr(self:unreal.VariantPtr, value:unreal.UIntPtr):Void;
