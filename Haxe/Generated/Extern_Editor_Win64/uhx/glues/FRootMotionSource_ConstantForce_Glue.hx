...
package uhx.glues;
@:unrealGlue extern class FRootMotionSource_ConstantForce_Glue {
...
public static function get_Force(self:unreal.VariantPtr):unreal.VariantPtr;
public static function set_Force(self:unreal.VariantPtr, value:unreal.VariantPtr):Void;
