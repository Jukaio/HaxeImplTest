...
package uhx.glues;
@:unrealGlue extern class FStreamableManager_Glue {
public static function get_DefaultAsyncLoadPriority():Int;
public static function get_AsyncLoadHighPriority():Int;
