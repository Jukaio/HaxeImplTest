...
@:noCopy @:noEquals @:uextern @:ustruct extern class FChaosDebugSubstepControl {
  
  /**
    * Step the solver to the next synchronization point.
  **/
  @:uproperty public var bStep : Bool;
  
  /**
    * Substep the solver to the next synchronization point.
  **/
  @:uproperty public var bSubstep : Bool;
  
  /**
    * Pause the solver at the next synchronization point.
  **/
  @:uproperty public var bPause : Bool;
