...
@:uextern @:uclass extern class UGraphEditorSettings extends unreal.UObject {
  ...
  **/
  @:uproperty public var bShowCommentBubbleWhenZoomedOut : Bool;
  
  /**
    Whether a comment node should move any fully enclosed nodes around when it is moved
  **/
  @:uproperty public var DefaultCommentNodeMoveMode : unreal.editor.ECommentBoxMode;
  ...
  **/
  @:uproperty public var bOpenCreateMenuOnBlankGraphAreas : Bool;
  
  /**
    The amount of padding to add in order to auto collate multiple created nodes when using tab context menu (defaults to 20)
  **/
  @:uproperty public var PaddingAutoCollateIncrement : unreal.Float32;
