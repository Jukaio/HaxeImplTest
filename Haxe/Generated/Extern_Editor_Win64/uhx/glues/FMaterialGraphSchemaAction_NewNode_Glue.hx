...
package uhx.glues;
@:unrealGlue extern class FMaterialGraphSchemaAction_NewNode_Glue {
public static function get_MaterialExpressionClass(self:unreal.VariantPtr):unreal.UIntPtr;
public static function set_MaterialExpressionClass(self:unreal.VariantPtr, value:unreal.UIntPtr):Void;
