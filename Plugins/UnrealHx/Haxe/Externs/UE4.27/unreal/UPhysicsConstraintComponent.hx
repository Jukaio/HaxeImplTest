...
@:uextern @:uclass extern class UPhysicsConstraintComponent extends unreal.USceneComponent {
  ...
  **/
  @:ufunction(BlueprintCallable) @:final public function SetLinearXLimit(ConstraintType : unreal.physicscore.ELinearConstraintMotion, LimitSize : unreal.Float32) : Void;
  ...
  /**
    Sets the LinearY Motion Type
         ...
         @param LimitSize                Size of limit
  **/
  @:ufunction(BlueprintCallable) @:final public function SetLinearYLimit(ConstraintType : unreal.physicscore.ELinearConstraintMotion, LimitSize : unreal.Float32) : Void;
  ...
  /**
    Sets the LinearZ Motion Type
         ...
         @param LimitSize                Size of limit
  **/
  @:ufunction(BlueprintCallable) @:final public function SetLinearZLimit(ConstraintType : unreal.physicscore.ELinearConstraintMotion, LimitSize : unreal.Float32) : Void;
  ...
  **/
  @:ufunction(BlueprintCallable) @:final public function SetAngularSwing1Limit(MotionType : unreal.physicscore.EAngularConstraintMotion, Swing1LimitAngle : unreal.Float32) : Void;
  ...
  **/
  @:ufunction(BlueprintCallable) @:final public function SetAngularSwing2Limit(MotionType : unreal.physicscore.EAngularConstraintMotion, Swing2LimitAngle : unreal.Float32) : Void;
  ...
  **/
  @:ufunction(BlueprintCallable) @:final public function SetAngularTwistLimit(ConstraintType : unreal.physicscore.EAngularConstraintMotion, TwistLimitAngle : unreal.Float32) : Void;
  ...
  **/
  @:ufunction(BlueprintCallable) @:final public function SetLinearPlasticity(bLinearPlasticity : Bool, LinearPlasticityThreshold : unreal.Float32) : Void;
  ...
  **/
  @:ufunction(BlueprintCallable) @:final public function SetAngularPlasticity(bAngularPlasticity : Bool, AngularPlasticityThreshold : unreal.Float32) : Void;
  ...
  **/
  @:ufunction(BlueprintCallable) @:final public function SetConstraintReferenceFrame(Frame : unreal.physicscore.EConstraintFrame, RefFrame : unreal.Const<unreal.PRef<unreal.FTransform>>) : Void;
  ...
  **/
  @:ufunction(BlueprintCallable) @:final public function SetConstraintReferencePosition(Frame : unreal.physicscore.EConstraintFrame, RefPosition : unreal.Const<unreal.PRef<unreal.FVector>>) : Void;
  ...
  **/
  @:ufunction(BlueprintCallable) @:final public function SetConstraintReferenceOrientation(Frame : unreal.physicscore.EConstraintFrame, PriAxis : unreal.Const<unreal.PRef<unreal.FVector>>, SecAxis : unreal.Const<unreal.PRef<unreal.FVector>>) : Void;
