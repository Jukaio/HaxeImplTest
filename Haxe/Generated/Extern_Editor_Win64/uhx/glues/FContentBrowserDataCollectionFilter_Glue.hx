...
package uhx.glues;
@:unrealGlue extern class FContentBrowserDataCollectionFilter_Glue {
public static function get_bIncludeChildCollections(self:unreal.VariantPtr):Bool;
public static function set_bIncludeChildCollections(self:unreal.VariantPtr, value:Bool):Void;
