...
@:uextern @:uclass extern class ULandscapeEditorObject extends unreal.UObject {
  @:uproperty public var CurrentLayerIndex : unreal.Int32;
  ...
  **/
  @:uproperty public var BlueprintBrush : unreal.TSubclassOf<unreal.landscapeeditorutilities.ALandscapeBlueprintBrush>;
  ...
  **/
  ...
  @:uproperty public var bCombinedLayersOperation : Bool;
