...
package uhx.glues;
@:unrealGlue extern class FAITouchEvent_Glue {
...
public static function get_TouchReceiver(self:unreal.VariantPtr):unreal.UIntPtr;
public static function set_TouchReceiver(self:unreal.VariantPtr, value:unreal.UIntPtr):Void;
