...
@:uextern @:ustruct extern class FAnimNode_RigidBody extends unreal.animgraphruntime.FAnimNode_SkeletalControlBase {
  ...
  **/
  @:uproperty public var EvaluationResetTime : unreal.Float32;
  ...
  **/
  @:uproperty public var WorldSpaceMinimumScale : unreal.Float32;
  ...
  **/
  @:uproperty public var SimSpaceSettings : unreal.animgraphruntime.FSimSpaceSettings;
