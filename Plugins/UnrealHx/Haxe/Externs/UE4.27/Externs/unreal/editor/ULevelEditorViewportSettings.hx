...
@:uextern @:uclass extern class ULevelEditorViewportSettings extends unreal.UObject {
  ...
  **/
  @:uproperty public var SplineTangentScale : unreal.Float32;
  
  /**
    The size adjustment to apply to spline tangent handle (in screen space units).
  **/
  @:uproperty public var SplineTangentHandleSizeAdjustment : unreal.Float32;
  
  /**
    The size adjustment to apply to spline line thickness which increases the spline's hit tolerance.
  **/
  @:uproperty public var SplineLineThicknessAdjustment : unreal.Float32;
  
  /**
    The size adjustment to apply to selected spline points (in screen space units).
  **/
  @:uproperty public var SelectedSplinePointSizeAdjustment : unreal.Float32;
  ...
  **/
  ...
  @:uproperty public var bUseLegacyPostEditBehavior : Bool;
  ...
  **/
  @:uproperty public var bAllowScreenRotate : Bool;
  
  /**
    Allow arcball rotation with rotate widget
  **/
  @:uproperty public var bAllowArcballRotate : Bool;
  ...
  **/
  @:uproperty public var MinimumOrthographicZoom : unreal.Float32;
  ...
  **/
  @:uproperty public var FlightCameraControlExperimentalNavigation : Bool;
