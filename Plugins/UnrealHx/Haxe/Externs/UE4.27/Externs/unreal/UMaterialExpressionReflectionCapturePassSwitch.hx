...
@:noClass @:uextern @:uclass extern class UMaterialExpressionReflectionCapturePassSwitch extends unreal.UMaterialExpression {
  
  /**
    Input will be used when rendering into reflection passes.
  **/
  @:uproperty public var Reflection : unreal.FExpressionInput;
