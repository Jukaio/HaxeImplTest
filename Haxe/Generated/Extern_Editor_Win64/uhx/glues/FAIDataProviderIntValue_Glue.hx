...
package uhx.glues;
@:unrealGlue extern class FAIDataProviderIntValue_Glue {
public static function get_DefaultValue(self:unreal.VariantPtr):Int;
public static function set_DefaultValue(self:unreal.VariantPtr, value:Int):Void;
