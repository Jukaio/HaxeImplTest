...
package uhx.glues;
@:unrealGlue extern class FProceduralFoliageInstance_Glue {
public static function get_Type(self:unreal.VariantPtr):unreal.UIntPtr;
public static function set_Type(self:unreal.VariantPtr, value:unreal.UIntPtr):Void;
