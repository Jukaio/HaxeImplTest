...
@:uextern @:uclass extern class ALevelSequenceActor extends unreal.AActor implements unreal.moviescene.IMovieSceneSequenceActor implements unreal.moviescene.IMovieScenePlaybackClient implements unreal.moviescene.IMovieSceneBindingOwnerInterface {
  ...
  **/
  ...
  @:uproperty public var CameraSettings : unreal.levelsequence.FLevelSequenceCameraSettings;
  ...
  **/
  ...
  /**
    Hide burnin
  **/
  @:ufunction(BlueprintCallable) @:final public function HideBurnin() : Void;
  
  /**
    Show burnin
  **/
  @:ufunction(BlueprintCallable) @:final public function ShowBurnin() : Void;
  ...
  **/
  @:ufunction(BlueprintCallable) @:final public function SetBindingByTag(BindingTag : unreal.FName, Actors : unreal.Const<unreal.PRef<unreal.TArray<unreal.AActor>>>, bAllowBindingsFromAsset : Bool = false) : Void;
  ...
  **/
  ...
  /**
    ...
    @param bAllowBindingsFromAsset Whether to continue to allow bindings from the level sequence asset (true) or not (false)
  **/
  @:ufunction(BlueprintCallable) @:final public function AddBindingByTag(BindingTag : unreal.FName, Actor : unreal.AActor, bAllowBindingsFromAsset : Bool = false) : Void;
  ...
  **/
  ...
  /**
    Removes the specified actor from the specified binding's actor array
  **/
  @:ufunction(BlueprintCallable) @:final public function RemoveBindingByTag(Tag : unreal.FName, Actor : unreal.AActor) : Void;
  ...
  **/
  @:ufunction(BlueprintCallable) @:thisConst @:final public function FindNamedBinding(Tag : unreal.FName) : unreal.moviescene.FMovieSceneObjectBindingID;
  ...
  **/
  @:ufunction(BlueprintCallable) @:thisConst @:final public function FindNamedBindings(Tag : unreal.FName) : unreal.Const<unreal.PRef<unreal.TArray<unreal.moviescene.FMovieSceneObjectBindingID>>>;
