...
@:uextern @:uclass extern class UFoliageType extends unreal.UObject {
  ...
  **/
  @:uproperty public var bEnableDiscardOnLoad : Bool;
  ...
  **/
  ...
  @:uproperty public var bEvaluateWorldPositionOffset : Bool;
  ...
  **/
  @:uproperty public var MinimumExclusionLayerWeight : unreal.Float32;
  ...
  **/
  @:uproperty public var ExclusionLandscapeLayers : unreal.TArray<unreal.FName>;
  ...
  **/
  @:uproperty public var SingleInstanceModeRadius : unreal.Float32;
  
  /**
    Option to override radius used to detect collision with other instances when painting in single instance mode
  **/
  @:uproperty public var bSingleInstanceModeOverrideRadius : Bool;
