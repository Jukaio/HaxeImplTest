...
package uhx.glues;
@:unrealGlue extern class FRedirector_Glue {
...
public static function get_OldName(self:unreal.VariantPtr):unreal.VariantPtr;
public static function set_OldName(self:unreal.VariantPtr, value:unreal.VariantPtr):Void;
