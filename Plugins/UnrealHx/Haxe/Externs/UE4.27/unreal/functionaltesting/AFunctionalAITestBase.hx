...
@:uextern @:uclass extern class AFunctionalAITestBase extends unreal.functionaltesting.AFunctionalTest {
  ...
  **/
  ...
  @:ufunction(BlueprintCallable) public function IsOneOfSpawnedPawns(Actor : unreal.AActor) : Bool;
