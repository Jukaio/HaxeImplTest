...
@:uextern @:uclass extern class UNavigationSystemV1 extends unreal.UNavigationSystemBase {
  ...
  **/
  @:uproperty private var SupportedAgentsMask : unreal.FNavAgentSelector;
  ...
  **/
  @:uproperty private var DirtyAreaWarningSizeThreshold : unreal.Float32;
  ...
  **/
  ...
  /**
    ...
    as the default one
  **/
  @:uproperty private var DefaultAgentName : unreal.FName;
  ...
  **/
  ...
  /**
    Generates a random location in navigable space within given radius of Origin.
        @return Return Value represents if the call was successful
  **/
  @:ufunction(BlueprintCallable) static public function K2_GetRandomLocationInNavigableRadius(WorldContextObject : unreal.UObject, Origin : unreal.Const<unreal.PRef<unreal.FVector>>, RandomLocation : unreal.PRef<unreal.FVector>, Radius : unreal.Float32, @:opt("None") NavData : unreal.navigationsystem.ANavigationData, @:opt("None") FilterClass : unreal.TSubclassOf<unreal.navigationsystem.UNavigationQueryFilter>) : Bool;
  ...
  **/
  ...
  @:ufunction(BlueprintCallable) @:final public function K2_ReplaceAreaInOctreeData(Object : unreal.Const<unreal.UObject>, OldArea : unreal.TSubclassOf<unreal.navigationsystem.UNavArea>, NewArea : unreal.TSubclassOf<unreal.navigationsystem.UNavArea>) : Bool;
