...
@:uextern @:uclass extern class USourceControlHelpers extends unreal.UObject {
  ...
  **/
  @:ufunction(BlueprintCallable) static public function SyncFile(InFile : unreal.FString, bSilent : Bool = false) : Bool;
  ...
  /**
    ...
    @return      true if succeeded, false if failed and can call LastErrorMsg() for more info.
  **/
  @:ufunction(BlueprintCallable) static public function SyncFiles(InFiles : unreal.Const<unreal.PRef<unreal.TArray<unreal.FString>>>, bSilent : Bool = false) : Bool;
  ...
  **/
  ...
  /**
    ...
    @return      true if succeeded, false if failed and can call LastErrorMsg() for more info.
  **/
  @:ufunction(BlueprintCallable) static public function CheckOutOrAddFiles(InFiles : unreal.Const<unreal.PRef<unreal.TArray<unreal.FString>>>, bSilent : Bool = false) : Bool;
  ...
  **/
  ...
  /**
    ...
    @return      true if succeeded, false if failed and can call LastErrorMsg() for more info.
  **/
  @:ufunction(BlueprintCallable) static public function MarkFilesForDelete(InFiles : unreal.Const<unreal.PRef<unreal.TArray<unreal.FString>>>, bSilent : Bool = false) : Bool;
