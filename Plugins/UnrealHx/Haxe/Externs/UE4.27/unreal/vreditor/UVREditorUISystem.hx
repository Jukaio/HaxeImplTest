...
@:noClass @:uextern @:uclass extern class UVREditorUISystem extends unreal.UObject {
  ...
  **/
  @:uproperty private var PreviewWindowInfo : unreal.TMap<unreal.FName, unreal.AActor>;
  
  /**
    All of the floating UIs.  These may or may not be visible (spawned)
  **/
  @:uproperty private var FloatingUIs : unreal.TMap<unreal.FName, unreal.vreditor.AVREditorFloatingUI>;
