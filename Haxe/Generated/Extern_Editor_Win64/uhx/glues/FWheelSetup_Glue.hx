...
package uhx.glues;
@:unrealGlue extern class FWheelSetup_Glue {
public static function get_bDisableSteering(self:unreal.VariantPtr):Bool;
public static function set_bDisableSteering(self:unreal.VariantPtr, value:Bool):Void;
public static function get_AdditionalOffset(self:unreal.VariantPtr):unreal.VariantPtr;
public static function set_AdditionalOffset(self:unreal.VariantPtr, value:unreal.VariantPtr):Void;
...
public static function get_WheelClass(self:unreal.VariantPtr):unreal.UIntPtr;
public static function set_WheelClass(self:unreal.VariantPtr, value:unreal.UIntPtr):Void;
