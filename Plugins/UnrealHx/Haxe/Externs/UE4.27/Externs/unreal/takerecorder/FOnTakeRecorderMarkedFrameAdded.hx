...
typedef FOnTakeRecorderMarkedFrameAdded = unreal.DynamicDelegate<FOnTakeRecorderMarkedFrameAdded, unreal.Const<unreal.PRef<unreal.moviescene.FMovieSceneMarkedFrame>>->Void>;