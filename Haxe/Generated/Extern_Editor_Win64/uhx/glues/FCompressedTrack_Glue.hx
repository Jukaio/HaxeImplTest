...
package uhx.glues;
@:unrealGlue extern class FCompressedTrack_Glue {
...
public static function get_ByteStream(self:unreal.VariantPtr):unreal.VariantPtr;
public static function set_ByteStream(self:unreal.VariantPtr, value:unreal.VariantPtr):Void;
