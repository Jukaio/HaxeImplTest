...
package uhx.glues;
@:unrealGlue extern class FRawDistributionVector_Glue {
public static function get_Distribution(self:unreal.VariantPtr):unreal.UIntPtr;
public static function set_Distribution(self:unreal.VariantPtr, value:unreal.UIntPtr):Void;
