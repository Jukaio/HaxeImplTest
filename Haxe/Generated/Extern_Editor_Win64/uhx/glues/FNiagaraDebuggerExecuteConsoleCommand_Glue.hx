...
package uhx.glues;
@:unrealGlue extern class FNiagaraDebuggerExecuteConsoleCommand_Glue {
public static function get_bRequiresWorld(self:unreal.VariantPtr):Bool;
public static function set_bRequiresWorld(self:unreal.VariantPtr, value:Bool):Void;
