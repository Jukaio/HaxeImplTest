...
package uhx.glues;
@:unrealGlue extern class FInstancePointDamageSignature_Glue {
public static function create():unreal.VariantPtr;
public static function createNew():unreal.VariantPtr;
public static function Broadcast(self:unreal.VariantPtr, arg_0:Int, arg_1:cpp.Float32, arg_2:unreal.UIntPtr, arg_3:unreal.VariantPtr, arg_4:unreal.VariantPtr, arg_5:unreal.UIntPtr, arg_6:unreal.UIntPtr):Void;
