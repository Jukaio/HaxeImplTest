...
package uhx.glues;
@:unrealGlue extern class FMagicLeapSharedWorldPinData_Glue {
public static function get_PinState(self:unreal.VariantPtr):unreal.VariantPtr;
public static function set_PinState(self:unreal.VariantPtr, value:unreal.VariantPtr):Void;
public static function get_PinID(self:unreal.VariantPtr):unreal.VariantPtr;
public static function set_PinID(self:unreal.VariantPtr, value:unreal.VariantPtr):Void;
