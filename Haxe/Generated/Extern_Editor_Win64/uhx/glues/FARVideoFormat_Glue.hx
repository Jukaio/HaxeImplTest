...
package uhx.glues;
@:unrealGlue extern class FARVideoFormat_Glue {
...
public static function get_FPS(self:unreal.VariantPtr):Int;
public static function set_FPS(self:unreal.VariantPtr, value:Int):Void;
