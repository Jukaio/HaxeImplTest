...
@:uextern @:uclass extern class USpectatorBeaconState extends unreal.UObject {
  
  /**
    Current reservations in the system
  **/
  @:uproperty private var Reservations : unreal.TArray<unreal.onlinesubsystemutils.FSpectatorReservation>;
