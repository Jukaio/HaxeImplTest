...
package uhx.glues;
@:unrealGlue extern class FAnimNode_LinkedAnimLayer_Glue {
public static function get_Layer(self:unreal.VariantPtr):unreal.VariantPtr;
public static function set_Layer(self:unreal.VariantPtr, value:unreal.VariantPtr):Void;
