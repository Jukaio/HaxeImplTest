...
@:uextern @:uclass extern class UKismetArrayLibrary extends unreal.UBlueprintFunctionLibrary {
  ...
  **/
  @:ufunction(BlueprintCallable) static public function Array_Reverse(TargetArray : unreal.Const<unreal.PRef<unreal.TArray<unreal.Int32>>>) : Void;
  ...
  **/
  @:ufunction(BlueprintCallable) static public function Array_Random(TargetArray : unreal.Const<unreal.PRef<unreal.TArray<unreal.Int32>>>, OutItem : unreal.Int32, OutIndex : unreal.Int32) : Void;
  ...
  /**
    ...
    @param       OutIndex                The index of random item (will be -1 if array is empty)
  **/
  @:ufunction(BlueprintCallable) static public function Array_RandomFromStream(TargetArray : unreal.Const<unreal.PRef<unreal.TArray<unreal.Int32>>>, RandomStream : unreal.PRef<unreal.FRandomStream>, OutItem : unreal.Int32, OutIndex : unreal.Int32) : Void;
