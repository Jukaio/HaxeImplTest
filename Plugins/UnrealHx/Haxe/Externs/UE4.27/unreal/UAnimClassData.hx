...
@:uextern @:uclass extern class UAnimClassData extends unreal.UObject implements unreal.IAnimClassInterface {
  ...
  **/
  @:uproperty public var PropertyAccessLibrary : unreal.propertyaccess.FPropertyAccessLibrary;
  ...
  **/
  @:uproperty public var GraphNameAssetPlayers : unreal.TMap<unreal.FName, unreal.FGraphAssetPlayerInformation>;
  
  /**
    Serialized function data, used to patch up transient data in AnimBlueprintFunctions
  **/
  @:uproperty public var AnimBlueprintFunctionData : unreal.TArray<unreal.FAnimBlueprintFunctionData>;
  
  /**
    All of the functions that this anim class provides
  **/
  @:uproperty public var AnimBlueprintFunctions : unreal.TArray<unreal.FAnimBlueprintFunction>;
