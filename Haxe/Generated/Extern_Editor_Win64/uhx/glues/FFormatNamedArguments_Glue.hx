...
package uhx.glues;
@:unrealGlue extern class FFormatNamedArguments_Glue {
public static function create():unreal.VariantPtr;
public static function Add(self:unreal.VariantPtr, InKey:unreal.VariantPtr, InValue:unreal.VariantPtr):Void;
