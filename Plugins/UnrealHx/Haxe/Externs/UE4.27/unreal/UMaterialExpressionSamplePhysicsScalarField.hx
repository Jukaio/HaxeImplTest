...
@:noClass @:uextern @:uclass extern class UMaterialExpressionSamplePhysicsScalarField extends unreal.UMaterialExpression {
  
  /**
    Target Type to be accessed
  **/
  @:uproperty public var FieldTarget : unreal.chaos.EFieldScalarType;
