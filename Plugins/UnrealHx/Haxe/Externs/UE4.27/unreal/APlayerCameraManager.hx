...
@:uextern @:uclass extern class APlayerCameraManager extends unreal.AActor {
  ...
  **/
  @:uproperty public var OnAudioFadeChangeEvent : unreal.FOnAudioFadeChangeSignature;
  ...
  **/
  @:ufunction(BlueprintCallable) @:thisConst public function GetCameraRotation() : unreal.FRotator;
  
  /**
    Returns camera's current location.
  **/
  @:ufunction(BlueprintCallable) @:thisConst public function GetCameraLocation() : unreal.FVector;
  ...
  **/
  @:ufunction(BlueprintCallable) public function StartCameraShake(ShakeClass : unreal.TSubclassOf<unreal.UCameraShakeBase>, Scale : unreal.Float32 = 1.000000, @:opt("CameraLocal") PlaySpace : unreal.ECameraShakePlaySpace, UserPlaySpaceRot : unreal.FRotator) : unreal.UCameraShakeBase;
  ...
  /**
    ...
    @param UserPlaySpaceRot - Coordinate system to play shake when PlaySpace == CAPS_UserDefined.
  **/
  @:ufunction(BlueprintCallable) public function StartCameraShakeFromSource(ShakeClass : unreal.TSubclassOf<unreal.UCameraShakeBase>, SourceComponent : unreal.UCameraShakeSourceComponent, Scale : unreal.Float32 = 1.000000, @:opt("CameraLocal") PlaySpace : unreal.ECameraShakePlaySpace, UserPlaySpaceRot : unreal.FRotator) : unreal.UCameraShakeBase;
  
  /**
    Immediately stops the given shake instance and invalidates it.
  **/
  @:ufunction(BlueprintCallable) public function StopCameraShake(ShakeInstance : unreal.UCameraShakeBase, bImmediately : Bool = true) : Void;
  
  /**
    Stops playing all shakes of the given class.
  **/
  @:ufunction(BlueprintCallable) public function StopAllInstancesOfCameraShake(Shake : unreal.TSubclassOf<unreal.UCameraShakeBase>, bImmediately : Bool = true) : Void;
  ...
  **/
  @:ufunction(BlueprintCallable) public function StopAllInstancesOfCameraShakeFromSource(Shake : unreal.TSubclassOf<unreal.UCameraShakeBase>, SourceComponent : unreal.UCameraShakeSourceComponent, bImmediately : Bool = true) : Void;
  
  /**
    Stops playing all shakes originating from the given source.
  **/
  @:ufunction(BlueprintCallable) public function StopAllCameraShakesFromSource(SourceComponent : unreal.UCameraShakeSourceComponent, bImmediately : Bool = true) : Void;
  ...
  **/
  @:ufunction(BlueprintCallable) public function PlayCameraAnim(Anim : unreal.UCameraAnim, Rate : unreal.Float32 = 1.000000, Scale : unreal.Float32 = 1.000000, BlendInTime : unreal.Float32 = 0.000000, BlendOutTime : unreal.Float32 = 0.000000, bLoop : Bool = false, bRandomStartTime : Bool = false, Duration : unreal.Float32 = 0.000000, @:opt("CameraLocal") PlaySpace : unreal.ECameraShakePlaySpace, UserPlaySpaceRot : unreal.FRotator) : unreal.UCameraAnimInst;
  ...
  **/
  @:ufunction(BlueprintCallable) @:final public function SetGameCameraCutThisFrame() : Void;
  ...
  **/
  @:ufunction @:final private function SwapPendingViewTargetWhenUsingClientSideCameraUpdates() : Void;
