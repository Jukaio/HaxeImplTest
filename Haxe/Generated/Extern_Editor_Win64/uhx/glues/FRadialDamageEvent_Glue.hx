...
package uhx.glues;
@:unrealGlue extern class FRadialDamageEvent_Glue {
...
public static function get_ComponentHits(self:unreal.VariantPtr):unreal.VariantPtr;
public static function set_ComponentHits(self:unreal.VariantPtr, value:unreal.VariantPtr):Void;
