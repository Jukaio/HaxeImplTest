...
package uhx.glues;
@:unrealGlue extern class FActorHitSignature_Glue {
public static function create():unreal.VariantPtr;
public static function createNew():unreal.VariantPtr;
public static function Broadcast(self:unreal.VariantPtr, arg_0:unreal.UIntPtr, arg_1:unreal.UIntPtr, arg_2:unreal.VariantPtr, arg_3:unreal.VariantPtr):Void;
