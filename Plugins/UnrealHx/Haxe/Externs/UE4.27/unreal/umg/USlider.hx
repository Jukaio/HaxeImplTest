...
@:uextern @:uclass extern class USlider extends unreal.umg.UWidget {
  ...
  **/
  @:ufunction(BlueprintCallable) @:thisConst @:final public function GetNormalizedValue() : unreal.Float32;
  ...
  **/
  @:ufunction(BlueprintCallable) @:final public function SetMinValue(InValue : unreal.Float32) : Void;
  
  /**
    Sets the maximum value of the slider.
  **/
  @:ufunction(BlueprintCallable) @:final public function SetMaxValue(InValue : unreal.Float32) : Void;
