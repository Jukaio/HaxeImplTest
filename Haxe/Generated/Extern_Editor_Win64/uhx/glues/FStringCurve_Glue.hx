...
package uhx.glues;
@:unrealGlue extern class FStringCurve_Glue {
public static function get_Keys(self:unreal.VariantPtr):unreal.VariantPtr;
public static function set_Keys(self:unreal.VariantPtr, value:unreal.VariantPtr):Void;
