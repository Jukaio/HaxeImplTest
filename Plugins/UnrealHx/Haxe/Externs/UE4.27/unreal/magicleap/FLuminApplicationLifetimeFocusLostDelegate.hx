...
typedef FLuminApplicationLifetimeFocusLostDelegate = unreal.DynamicMulticastDelegate<FLuminApplicationLifetimeFocusLostDelegate, unreal.magicleap.EFocusLostReason->Void>;