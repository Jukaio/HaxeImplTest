...
@:noCopy @:noEquals @:uextern @:ustruct extern class FTrackedCamera {
  ...
  **/
  @:deprecated @:uproperty public var RawOffset_DEPRECATED : unreal.FVector;
  
  /**
    The raw pose of the camera to the attached tracking device (Deprecated)
  **/
  @:deprecated @:uproperty public var RawRotation_DEPRECATED : unreal.FRotator;
  ...
  **/
  @:uproperty public var UpdateTime : unreal.Float64;
