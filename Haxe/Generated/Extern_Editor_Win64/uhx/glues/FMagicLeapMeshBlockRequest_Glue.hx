...
package uhx.glues;
@:unrealGlue extern class FMagicLeapMeshBlockRequest_Glue {
public static function get_LevelOfDetail(self:unreal.VariantPtr):Int;
public static function set_LevelOfDetail(self:unreal.VariantPtr, value:Int):Void;
