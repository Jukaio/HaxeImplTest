...
package uhx.glues;
@:unrealGlue extern class UClothingSimulationInteractorNv_Glue {
public static function SetAnimDriveDamperStiffness(self:unreal.UIntPtr, InStiffness:cpp.Float32):Void;
