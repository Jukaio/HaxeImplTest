...
package uhx.glues;
@:unrealGlue extern class FActiveForceFeedbackEffect_Glue {
public static function get_ForceFeedbackEffect(self:unreal.VariantPtr):unreal.UIntPtr;
public static function set_ForceFeedbackEffect(self:unreal.VariantPtr, value:unreal.UIntPtr):Void;
