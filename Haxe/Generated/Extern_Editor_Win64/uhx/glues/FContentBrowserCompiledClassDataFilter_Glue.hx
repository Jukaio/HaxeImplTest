...
package uhx.glues;
@:unrealGlue extern class FContentBrowserCompiledClassDataFilter_Glue {
public static function get_ValidFolders(self:unreal.VariantPtr):unreal.VariantPtr;
public static function set_ValidFolders(self:unreal.VariantPtr, value:unreal.VariantPtr):Void;
public static function get_ValidClasses(self:unreal.VariantPtr):unreal.VariantPtr;
public static function set_ValidClasses(self:unreal.VariantPtr, value:unreal.VariantPtr):Void;
