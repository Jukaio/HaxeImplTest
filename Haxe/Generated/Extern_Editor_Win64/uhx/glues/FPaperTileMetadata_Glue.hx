...
package uhx.glues;
@:unrealGlue extern class FPaperTileMetadata_Glue {
...
public static function get_UserDataName(self:unreal.VariantPtr):unreal.VariantPtr;
public static function set_UserDataName(self:unreal.VariantPtr, value:unreal.VariantPtr):Void;
