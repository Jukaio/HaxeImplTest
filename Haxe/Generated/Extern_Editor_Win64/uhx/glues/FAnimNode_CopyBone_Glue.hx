...
package uhx.glues;
@:unrealGlue extern class FAnimNode_CopyBone_Glue {
public static function get_ControlSpace(self:unreal.VariantPtr):Int;
public static function set_ControlSpace(self:unreal.VariantPtr, value:Int):Void;
