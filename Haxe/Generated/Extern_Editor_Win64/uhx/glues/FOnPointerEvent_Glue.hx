...
package uhx.glues;
@:unrealGlue extern class FOnPointerEvent_Glue {
public static function create():unreal.VariantPtr;
public static function createNew():unreal.VariantPtr;
public static function Execute(self:unreal.VariantPtr, arg_0:unreal.VariantPtr, arg_1:unreal.VariantPtr):unreal.VariantPtr;
