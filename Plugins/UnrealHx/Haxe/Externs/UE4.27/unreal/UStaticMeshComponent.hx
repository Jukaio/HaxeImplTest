...
@:uextern @:uclass extern class UStaticMeshComponent extends unreal.UMeshComponent {
  ...
  **/
  ...
  #if WITH_EDITORONLY_DATA
  @:uproperty public var bDisplayPhysicalMaterialMasks : Bool;
  ...
  **/
  @:deprecated @:uproperty public var PreviousLODLevel_DEPRECATED : unreal.Int32;
  ...
  **/
  ...
  @:ufunction(BlueprintCallable) @:final public function SetEvaluateWorldPositionOffsetInRayTracing(NewValue : Bool) : Void;
