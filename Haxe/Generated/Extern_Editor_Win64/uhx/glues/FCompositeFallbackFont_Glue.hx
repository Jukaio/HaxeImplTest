...
package uhx.glues;
@:unrealGlue extern class FCompositeFallbackFont_Glue {
public static function get_ScalingFactor(self:unreal.VariantPtr):cpp.Float32;
public static function set_ScalingFactor(self:unreal.VariantPtr, value:cpp.Float32):Void;
public static function get_Typeface(self:unreal.VariantPtr):unreal.VariantPtr;
public static function set_Typeface(self:unreal.VariantPtr, value:unreal.VariantPtr):Void;
