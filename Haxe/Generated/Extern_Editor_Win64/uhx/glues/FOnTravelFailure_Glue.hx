...
package uhx.glues;
@:unrealGlue extern class FOnTravelFailure_Glue {
...
public static function Broadcast(self:unreal.VariantPtr, arg_0:unreal.UIntPtr, arg_1:Int, arg_2:unreal.VariantPtr):Void;
