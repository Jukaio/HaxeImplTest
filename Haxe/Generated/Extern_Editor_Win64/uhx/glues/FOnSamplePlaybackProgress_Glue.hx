...
package uhx.glues;
@:unrealGlue extern class FOnSamplePlaybackProgress_Glue {
public static function create():unreal.VariantPtr;
public static function createNew():unreal.VariantPtr;
public static function Broadcast(self:unreal.VariantPtr, arg_0:cpp.Float32, arg_1:cpp.Float32):Void;
