...
@:uextern @:uclass extern class UGameplayStatics extends unreal.UBlueprintFunctionLibrary {
  ...
  **/
  @:ufunction(BlueprintCallable) static public function GetActorOfClass(WorldContextObject : unreal.Const<unreal.UObject>, ActorClass : unreal.TSubclassOf<unreal.AActor>) : unreal.AActor;
  ...
  **/
  ...
  /**
    ...
    @param  OutActors       Output array of Actors of the specified tag.
  **/
  @:ufunction(BlueprintCallable) static public function GetAllActorsOfClassWithTag(WorldContextObject : unreal.Const<unreal.UObject>, ActorClass : unreal.TSubclassOf<unreal.AActor>, Tag : unreal.FName, OutActors : unreal.PRef<unreal.TArray<unreal.AActor>>) : Void;
  ...
  **/
  @:ufunction(BlueprintCallable) static public function FindNearestActor(Origin : unreal.FVector, ActorsToCheck : unreal.Const<unreal.PRef<unreal.TArray<unreal.AActor>>>, Distance : unreal.Float32) : unreal.AActor;
  ...
  **/
  @:ufunction(BlueprintCallable) static public function GetPlayerControllerFromID(WorldContextObject : unreal.Const<unreal.UObject>, ControllerID : unreal.Int32) : unreal.APlayerController;
  ...
  **/
  @:ufunction(BlueprintCallable) static public function SetForceDisableSplitscreen(WorldContextObject : unreal.Const<unreal.UObject>, bDisable : Bool) : Void;
  
  /**
    Returns the split screen state
    @return      Whether the game viewport is split screen or not
  **/
  @:ufunction(BlueprintCallable) static public function IsSplitscreenForceDisabled(WorldContextObject : unreal.Const<unreal.UObject>) : Bool;
  ...
  **/
  @:ufunction(BlueprintCallable) static public function GetViewportMouseCaptureMode(WorldContextObject : unreal.Const<unreal.UObject>) : unreal.EMouseCaptureMode;
  
  /**
    Sets the current viewport mouse capture mode
  **/
  @:ufunction(BlueprintCallable) static public function SetViewportMouseCaptureMode(WorldContextObject : unreal.Const<unreal.UObject>, MouseCaptureMode : unreal.Const<unreal.EMouseCaptureMode>) : Void;
  ...
  **/
  @:ufunction(BlueprintCallable) static public function SpawnEmitterAtLocation(WorldContextObject : unreal.Const<unreal.UObject>, EmitterTemplate : unreal.UParticleSystem, Location : unreal.FVector, Rotation : unreal.FRotator, @:opt("1.000000,1.000000,1.000000") Scale : unreal.FVector, bAutoDestroy : Bool = true, @:opt("None") PoolingMethod : unreal.EPSCPoolMethod, bAutoActivateSystem : Bool = true) : unreal.UParticleSystemComponent;
  ...
  /**
    ...
    @param bAutoActivate - Whether the component will be automatically activated on creation.
  **/
  @:ufunction(BlueprintCallable) static public function SpawnEmitterAttached(EmitterTemplate : unreal.UParticleSystem, AttachToComponent : unreal.USceneComponent, @:opt("None") AttachPointName : unreal.FName, Location : unreal.FVector, Rotation : unreal.FRotator, @:opt("1.000000,1.000000,1.000000") Scale : unreal.FVector, LocationType : unreal.EAttachLocation = KeepRelativeOffset, bAutoDestroy : Bool = true, @:opt("None") PoolingMethod : unreal.EPSCPoolMethod, bAutoActivate : Bool = true) : unreal.UParticleSystemComponent;
  ...
  **/
  @:ufunction(BlueprintCallable) static public function AreAnyListenersWithinRange(WorldContextObject : unreal.Const<unreal.UObject>, Location : unreal.Const<unreal.PRef<unreal.FVector>>, MaximumRange : unreal.Float32) : Bool;
  ...
  /**
    ...
    @note This will always return false if there is no audio device, or the audio device is disabled.
  **/
  @:ufunction(BlueprintCallable) static public function GetClosestListenerLocation(WorldContextObject : unreal.Const<unreal.UObject>, Location : unreal.Const<unreal.PRef<unreal.FVector>>, MaximumRange : unreal.Float32, bAllowAttenuationOverride : Bool, ListenerPosition : unreal.PRef<unreal.FVector>) : Bool;
  ...
  **/
  @:ufunction(BlueprintCallable) static public function SetSoundClassDistanceScale(WorldContextObject : unreal.Const<unreal.UObject>, SoundClass : unreal.USoundClass, DistanceAttenuationScale : unreal.Float32, TimeSec : unreal.Float32 = 0.000000) : Void;
  ...
  **/
  @:ufunction(BlueprintCallable) static public function PlaySound2D(WorldContextObject : unreal.Const<unreal.UObject>, Sound : unreal.USoundBase, VolumeMultiplier : unreal.Float32 = 1.000000, PitchMultiplier : unreal.Float32 = 1.000000, StartTime : unreal.Float32 = 0.000000, @:opt("None") ConcurrencySettings : unreal.USoundConcurrency, @:opt("None") OwningActor : unreal.AActor, bIsUISound : Bool = true) : Void;
  ...
  **/
  @:ufunction(BlueprintCallable) static public function PrimeSound(InSound : unreal.USoundBase) : Void;
  
  /**
    Primes the sound sound waves in the given USoundClass, caching the first chunk of streamed audio. *
  **/
  @:ufunction(BlueprintCallable) static public function PrimeAllSoundsInSoundClass(InSoundClass : unreal.USoundClass) : Void;
  ...
  **/
  @:ufunction(BlueprintCallable) static public function UnRetainAllSoundsInSoundClass(InSoundClass : unreal.USoundClass) : Void;
  ...
  **/
  @:ufunction(BlueprintCallable) static public function MakeHitResult(bBlockingHit : Bool, bInitialOverlap : Bool, Time : unreal.Float32, Distance : unreal.Float32, Location : unreal.FVector, ImpactPoint : unreal.FVector, @:bpopt("0,0,1") Normal : unreal.FVector, @:bpopt("0,0,1") ImpactNormal : unreal.FVector, PhysMat : unreal.physicscore.UPhysicalMaterial, HitActor : unreal.AActor, HitComponent : unreal.UPrimitiveComponent, HitBoneName : unreal.FName, HitItem : unreal.Int32, ElementIndex : unreal.Int32, FaceIndex : unreal.Int32, TraceStart : unreal.FVector, TraceEnd : unreal.FVector) : unreal.FHitResult;
  ...
  **/
  @:ufunction(BlueprintCallable) static public function GetSurfaceType(Hit : unreal.Const<unreal.PRef<unreal.FHitResult>>) : unreal.physicscore.EPhysicalSurface;
  ...
  **/
  @:ufunction(BlueprintCallable) static public function GetAccurateRealTime(Seconds : unreal.Int32, PartialSeconds : unreal.Float32) : Void;
  ...
  **/
  @:ufunction(BlueprintCallable) static public function GetViewProjectionMatrix(DesiredView : unreal.FMinimalViewInfo, ViewMatrix : unreal.PRef<unreal.FMatrix>, ProjectionMatrix : unreal.PRef<unreal.FMatrix>, ViewProjectionMatrix : unreal.PRef<unreal.FMatrix>) : Void;
  ...
  **/
  @:ufunction(BlueprintCallable) static public function AnnounceAccessibleString(AnnouncementString : unreal.FString) : Void;
