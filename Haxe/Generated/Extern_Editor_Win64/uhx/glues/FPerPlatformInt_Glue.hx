...
package uhx.glues;
@:unrealGlue extern class FPerPlatformInt_Glue {
...
public static function get_Default(self:unreal.VariantPtr):Int;
public static function set_Default(self:unreal.VariantPtr, value:Int):Void;
