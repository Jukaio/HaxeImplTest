...
package uhx.glues;
@:unrealGlue extern class FAnimNode_BlendSpaceEvaluator_Glue {
public static function get_NormalizedTime(self:unreal.VariantPtr):cpp.Float32;
public static function set_NormalizedTime(self:unreal.VariantPtr, value:cpp.Float32):Void;
