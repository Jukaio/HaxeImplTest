...
package uhx.glues;
@:unrealGlue extern class FDataTableRowHandle_Glue {
public static function get_RowName(self:unreal.VariantPtr):unreal.VariantPtr;
public static function set_RowName(self:unreal.VariantPtr, value:unreal.VariantPtr):Void;
...
public static function IsNull(self:unreal.VariantPtr):Bool;
