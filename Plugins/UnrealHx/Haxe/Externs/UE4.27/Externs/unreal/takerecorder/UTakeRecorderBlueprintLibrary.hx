...
@:uextern @:uclass extern class UTakeRecorderBlueprintLibrary extends unreal.UBlueprintFunctionLibrary {
  ...
  **/
  @:ufunction(BlueprintCallable) static public function SetOnTakeRecorderPreInitialize(OnTakeRecorderPreInitialize : unreal.takerecorder.FOnTakeRecorderPreInitialize) : Void;
  
  /**
    Called when take recording starts.
  **/
  @:ufunction(BlueprintCallable) static public function SetOnTakeRecorderStarted(OnTakeRecorderStarted : unreal.takerecorder.FOnTakeRecorderStarted) : Void;
  
  /**
    Called when take recording is stopped.
  **/
  @:ufunction(BlueprintCallable) static public function SetOnTakeRecorderStopped(OnTakeRecorderStopped : unreal.takerecorder.FOnTakeRecorderStopped) : Void;
  
  /**
    Called when take recording finishes.
  **/
  @:ufunction(BlueprintCallable) static public function SetOnTakeRecorderFinished(OnTakeRecorderFinished : unreal.takerecorder.FOnTakeRecorderFinished) : Void;
  
  /**
    Called when take recording is cancelled.
  **/
  @:ufunction(BlueprintCallable) static public function SetOnTakeRecorderCancelled(OnTakeRecorderCancelled : unreal.takerecorder.FOnTakeRecorderCancelled) : Void;
  
  /**
    Called when a marked frame is added.
  **/
  @:ufunction(BlueprintCallable) static public function SetOnTakeRecorderMarkedFrameAdded(OnTakeRecorderMarkedFrameAdded : unreal.takerecorder.FOnTakeRecorderMarkedFrameAdded) : Void;
