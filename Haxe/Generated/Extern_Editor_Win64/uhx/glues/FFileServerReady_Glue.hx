...
package uhx.glues;
@:unrealGlue extern class FFileServerReady_Glue {
...
public static function get_AddressList(self:unreal.VariantPtr):unreal.VariantPtr;
public static function set_AddressList(self:unreal.VariantPtr, value:unreal.VariantPtr):Void;
}