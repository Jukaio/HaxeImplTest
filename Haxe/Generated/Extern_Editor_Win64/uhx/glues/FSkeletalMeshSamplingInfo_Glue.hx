...
package uhx.glues;
@:unrealGlue extern class FSkeletalMeshSamplingInfo_Glue {
public static function get_Regions(self:unreal.VariantPtr):unreal.VariantPtr;
public static function set_Regions(self:unreal.VariantPtr, value:unreal.VariantPtr):Void;
