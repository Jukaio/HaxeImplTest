...
@:uextern @:uclass extern class UViewportInteractor extends unreal.UObject {
  ...
  **/
  @:uproperty private var KeyToActionMap : unreal.TMap<unreal.inputcore.FKey, unreal.viewportinteraction.FViewportActionKeyInput>;
  ...
  **/
  @:ufunction(BlueprintCallable) @:thisConst @:final public function GetRoomSpaceTransform() : unreal.FTransform;
  
  /**
    Gets the last world transform of this interactor
  **/
  @:ufunction(BlueprintCallable) @:thisConst @:final public function GetLastTransform() : unreal.FTransform;
  
  /**
    Gets the last hand transform of the interactor, in the local tracking space
  **/
  @:ufunction(BlueprintCallable) @:thisConst @:final public function GetLastRoomSpaceTransform() : unreal.FTransform;
  ...
  **/
  @:ufunction(BlueprintCallable) @:final public function SetHitResultGizmoFilterMode(newFilter : unreal.viewportinteraction.EHitResultGizmoFilterMode) : Void;
  
  /**
    Gets current gizmo filter mode used for Interaction
  **/
  @:ufunction(BlueprintCallable) @:thisConst @:final public function GetHitResultGizmoFilterMode() : unreal.viewportinteraction.EHitResultGizmoFilterMode;
  
  /**
    Sets if the interactor can carry an object
  **/
  @:ufunction(BlueprintCallable) @:final public function SetCanCarry(bInCanCarry : Bool) : Void;
  
  /**
    Gets if the interactor can carry an object
  **/
  @:ufunction(BlueprintCallable) @:thisConst @:final public function CanCarry() : Bool;
