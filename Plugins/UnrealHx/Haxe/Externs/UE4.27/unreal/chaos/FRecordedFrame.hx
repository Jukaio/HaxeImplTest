...
@:noCopy @:noEquals @:uextern @:ustruct extern class FRecordedFrame {
  ...
  @:uproperty public var Trailings : unreal.TSet<unreal.chaos.FSolverTrailingData>;
  @:uproperty public var Breakings : unreal.TArray<unreal.chaos.FSolverBreakingData>;
  @:uproperty public var Collisions : unreal.TArray<unreal.chaos.FSolverCollisionData>;
