...
@:uextern @:uclass extern class USceneCaptureComponent extends unreal.USceneComponent {
  ...
  **/
  @:uproperty public var bUseRayTracingIfEnabled : Bool;
  ...
  **/
  @:ufunction(BlueprintCallable) @:final public function HideActorComponents(InActor : unreal.AActor, bIncludeFromChildActors : Bool = false) : Void;
  ...
  **/
  ...
  /**
    ...
    @param bIncludeFromChildActors Whether to include the components from child actors
  **/
  @:ufunction(BlueprintCallable) @:final public function ShowOnlyActorComponents(InActor : unreal.AActor, bIncludeFromChildActors : Bool = false) : Void;
  ...
  **/
  @:ufunction(BlueprintCallable) @:final public function RemoveShowOnlyActorComponents(InActor : unreal.AActor, bIncludeFromChildActors : Bool = false) : Void;
