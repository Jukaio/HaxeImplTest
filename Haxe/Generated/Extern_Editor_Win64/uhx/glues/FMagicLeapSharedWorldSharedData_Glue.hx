...
package uhx.glues;
@:unrealGlue extern class FMagicLeapSharedWorldSharedData_Glue {
public static function get_PinIDs(self:unreal.VariantPtr):unreal.VariantPtr;
public static function set_PinIDs(self:unreal.VariantPtr, value:unreal.VariantPtr):Void;
