...
@:uParamName("BoneName")
@:uParamName("PhysMat")
typedef FParticleCollisionSignature = unreal.DynamicMulticastDelegate<FParticleCollisionSignature, unreal.FName->unreal.Float32->unreal.Int32->unreal.FVector->unreal.FVector->unreal.FVector->unreal.FVector->unreal.FName->unreal.physicscore.UPhysicalMaterial->Void>;