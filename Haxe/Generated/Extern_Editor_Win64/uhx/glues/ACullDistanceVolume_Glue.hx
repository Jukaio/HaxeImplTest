...
package uhx.glues;
@:unrealGlue extern class ACullDistanceVolume_Glue {
...
public static function get_CullDistances(self:unreal.UIntPtr):unreal.VariantPtr;
public static function set_CullDistances(self:unreal.UIntPtr, value:unreal.VariantPtr):Void;
