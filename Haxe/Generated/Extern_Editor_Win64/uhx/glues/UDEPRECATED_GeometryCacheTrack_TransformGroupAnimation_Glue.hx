...
package uhx.glues;
@:unrealGlue extern class UDEPRECATED_GeometryCacheTrack_TransformGroupAnimation_Glue {
public static function SetMesh(self:unreal.UIntPtr, NewMeshData:unreal.VariantPtr):Void;
