...
package uhx.glues;
@:unrealGlue extern class FNiagaraMeshMaterialOverride_Glue {
public static function get_UserParamBinding(self:unreal.VariantPtr):unreal.VariantPtr;
public static function set_UserParamBinding(self:unreal.VariantPtr, value:unreal.VariantPtr):Void;
public static function get_ExplicitMat(self:unreal.VariantPtr):unreal.UIntPtr;
public static function set_ExplicitMat(self:unreal.VariantPtr, value:unreal.UIntPtr):Void;
