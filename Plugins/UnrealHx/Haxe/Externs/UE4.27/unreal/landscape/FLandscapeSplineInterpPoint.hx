...
@:noCopy @:noEquals @:uextern @:ustruct extern class FLandscapeSplineInterpPoint {
  ...
  **/
  @:uproperty public var LayerFalloffRight : unreal.FVector;
  
  /**
    Left Layer Falloff Point
  **/
  @:uproperty public var LayerFalloffLeft : unreal.FVector;
  
  /**
    Layer Right Point
  **/
  @:uproperty public var LayerRight : unreal.FVector;
  
  /**
    Layer Left Point
  **/
  @:uproperty public var LayerLeft : unreal.FVector;
