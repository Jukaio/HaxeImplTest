// Ver:1
// GeneratedBy:c:\users\jukai\documents\unreal projects\haxetest\plugins\unrealhx/haxe/externs/ue4.27/unreal/umg/ubuttonslot.hx
package unreal.umg;
/**
...
@:uextern
@:uclass
@:ueGluePath("uhx.glues.UButtonSlot_Glue")
#if (cppia && !LIVE_RELOAD_BUILD && !macro) @:build(uhx.compiletime.types.CompiledMetaCheck.build("unreal.umg.UButtonSlot")) #end
class UButtonSlot #if !macro extends unreal.umg.UPanelSlot #end {
  #if !macro 
  /**
  ...
  **/
  ...
  static function __init__():Void {
    ...
    uhx.ue.ClassMap.addWrapper(uhx.glues.UButtonSlot_Glue.StaticClass(), func);
    #else
    uhx.runtime.Helpers.addCppiaExternWrapper("ButtonSlot", "unreal.umg.UButtonSlot");
    #end
  }
  
  #if !cppia
  static function wrapPointer(uobject:unreal.UIntPtr):unreal.UIntPtr {
    return uhx.internal.HaxeHelpers.dynamicToPointer(new unreal.umg.UButtonSlot(uobject));
  }
  #end
  inline public static function wrap(uobject:unreal.UIntPtr):unreal.umg.UButtonSlot {
  ...
  @:glueCppCode("int uhx::glues::UButtonSlot_Glue_obj::get_VerticalAlignment(unreal::UIntPtr self) {\n\treturn ( (int) (EVerticalAlignment) ( (UButtonSlot *) self )->VerticalAlignment );\n}")
  @:uproperty
  @:final @:nonVirtual 
  @:nonVirtual
  private function get_VerticalAlignment() : unreal.slatecore.EVerticalAlignment {
    ...
    return unreal.slatecore.EVerticalAlignment.EVerticalAlignment_EnumConv.wrap(uhx.glues.UButtonSlot_Glue.get_VerticalAlignment(uhx_arg_0));
  ...
  @:glueCppCode("void uhx::glues::UButtonSlot_Glue_obj::set_VerticalAlignment(unreal::UIntPtr self, int value) {\n\t( (UButtonSlot *) self )->VerticalAlignment = ( (EVerticalAlignment) value );\n}")
  @:uproperty
  @:final @:nonVirtual 
  @:nonVirtual
  @:final @:nonVirtual 
  ...
  private function set_VerticalAlignment(value : unreal.slatecore.EVerticalAlignment) : unreal.slatecore.EVerticalAlignment {
    ...
    uhx.glues.UButtonSlot_Glue.set_VerticalAlignment(uhx_arg_0, uhx_arg_1);
    return value;
  ...
  @:glueCppCode("int uhx::glues::UButtonSlot_Glue_obj::get_HorizontalAlignment(unreal::UIntPtr self) {\n\treturn ( (int) (EHorizontalAlignment) ( (UButtonSlot *) self )->HorizontalAlignment );\n}")
  @:uproperty
  @:final @:nonVirtual 
  @:nonVirtual
  private function get_HorizontalAlignment() : unreal.slatecore.EHorizontalAlignment {
    ...
    #else
    var uhx_arg_0:unreal.UIntPtr = uhx.internal.HaxeHelpers.getUObjectWrapped(this);
    return unreal.slatecore.EHorizontalAlignment.EHorizontalAlignment_EnumConv.wrap(uhx.glues.UButtonSlot_Glue.get_HorizontalAlignment(uhx_arg_0));
  ...
  @:glueCppCode("void uhx::glues::UButtonSlot_Glue_obj::set_HorizontalAlignment(unreal::UIntPtr self, int value) {\n\t( (UButtonSlot *) self )->HorizontalAlignment = ( (EHorizontalAlignment) value );\n}")
  @:uproperty
  @:final @:nonVirtual 
  @:nonVirtual
  @:final @:nonVirtual 
  ...
  private function set_HorizontalAlignment(value : unreal.slatecore.EHorizontalAlignment) : unreal.slatecore.EHorizontalAlignment {
    ...
    uhx.glues.UButtonSlot_Glue.set_HorizontalAlignment(uhx_arg_0, uhx_arg_1);
    return value;
  ...
  @:glueCppCode("unreal::VariantPtr uhx::glues::UButtonSlot_Glue_obj::get_Padding(unreal::UIntPtr self) {\n\treturn unreal::VariantPtr::fromExternalPointer( (void *) (&(( (UButtonSlot *) self )->Padding)) );\n}")
  @:uproperty
  @:final @:nonVirtual 
  @:nonVirtual
  private function get_Padding() : unreal.PPtr<unreal.slatecore.FMargin> {
    ...
    #else
    var uhx_arg_0:unreal.UIntPtr = uhx.internal.HaxeHelpers.getUObjectWrapped(this);
    return ( @:privateAccess unreal.slatecore.FMargin.fromPointer( uhx.glues.UButtonSlot_Glue.get_Padding(uhx_arg_0) ) : unreal.PPtr<unreal.slatecore.FMargin> );
  ...
  @:glueCppCode("void uhx::glues::UButtonSlot_Glue_obj::set_Padding(unreal::UIntPtr self, unreal::VariantPtr value) {\n\t( (UButtonSlot *) self )->Padding = *::uhx::StructHelper< FMargin >::getPointer(value);\n}")
  @:uproperty
  @:final @:nonVirtual 
  @:nonVirtual
  @:final @:nonVirtual 
  ...
  private function set_Padding(value : unreal.slatecore.FMargin) : unreal.slatecore.FMargin {
    ...
    uhx.glues.UButtonSlot_Glue.set_Padding(uhx_arg_0, uhx_arg_1);
    return value;
  ...
  @:glueCppCode("void uhx::glues::UButtonSlot_Glue_obj::SetPadding(unreal::UIntPtr self, unreal::VariantPtr InPadding) {\n\t( (UButtonSlot *) self )->SetPadding(*::uhx::StructHelper< FMargin >::getPointer(InPadding));\n}")
  ...
  public function SetPadding(InPadding : unreal.slatecore.FMargin) : Void {
    ...
    uhx.glues.UButtonSlot_Glue.SetPadding(uhx_arg_0, uhx_arg_1);
  ...
  @:glueCppCode("void uhx::glues::UButtonSlot_Glue_obj::SetHorizontalAlignment(unreal::UIntPtr self, int InHorizontalAlignment) {\n\t( (UButtonSlot *) self )->SetHorizontalAlignment(( (EHorizontalAlignment) InHorizontalAlignment ));\n}")
  @:ufunction(BlueprintCallable)
  @:final @:nonVirtual 
  public function SetHorizontalAlignment(InHorizontalAlignment : unreal.slatecore.EHorizontalAlignment) : Void {
    ...
    uhx.glues.UButtonSlot_Glue.SetHorizontalAlignment(uhx_arg_0, uhx_arg_1);
  ...
  @:glueCppCode("void uhx::glues::UButtonSlot_Glue_obj::SetVerticalAlignment(unreal::UIntPtr self, int InVerticalAlignment) {\n\t( (UButtonSlot *) self )->SetVerticalAlignment(( (EVerticalAlignment) InVerticalAlignment ));\n}")
  @:ufunction(BlueprintCallable)
  @:final @:nonVirtual 
  public function SetVerticalAlignment(InVerticalAlignment : unreal.slatecore.EVerticalAlignment) : Void {
    ...
    uhx.glues.UButtonSlot_Glue.SetVerticalAlignment(uhx_arg_0, uhx_arg_1);
  ...
  **/
  ...
  @:glueCppCode("unreal::UIntPtr uhx::glues::UButtonSlot_Glue_obj::StaticClass() {\n\treturn ( (unreal::UIntPtr) (UButtonSlot::StaticClass()) );\n}")
  @:ifFeature("unreal.umg.UButtonSlot.*")
  public static function StaticClass() : unreal.UClass {
    #if cppia
    return uhx.runtime.UReflectionGenerator.getUClass("ButtonSlot");
    
    #else
    return ( cast unreal.UObject.wrap(uhx.glues.UButtonSlot_Glue.StaticClass()) : unreal.UClass );
