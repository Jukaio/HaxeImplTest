...
@:uextern @:uclass extern class UKismetStringLibrary extends unreal.UBlueprintFunctionLibrary {
  ...
  **/
  @:ufunction(BlueprintCallable) static public function Conv_IntPointToString(InIntPoint : unreal.FIntPoint) : unreal.FString;
  ...
  **/
  ...
  /**
    Converts a name value to a string
  **/
  @:ufunction(BlueprintCallable) static public function Conv_MatrixToString(InMatrix : unreal.Const<unreal.PRef<unreal.FMatrix>>) : unreal.FString;
  ...
  **/
  @:ufunction(BlueprintCallable) static public function IsEmpty(InString : unreal.FString) : Bool;
