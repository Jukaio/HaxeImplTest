...
@:noClass @:uextern @:uclass extern class UFractureCollisionSettings extends unreal.fractureeditor.UFractureToolSettings {
  
  /**
    Target spacing between collision samples on the mesh surface.
  **/
  @:uproperty public var PointSpacing : unreal.Float32;
