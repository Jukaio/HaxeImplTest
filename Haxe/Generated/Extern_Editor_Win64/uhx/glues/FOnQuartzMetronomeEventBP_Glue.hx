...
package uhx.glues;
@:unrealGlue extern class FOnQuartzMetronomeEventBP_Glue {
public static function create():unreal.VariantPtr;
public static function createNew():unreal.VariantPtr;
public static function Execute(self:unreal.VariantPtr, arg_0:unreal.VariantPtr, arg_1:Int, arg_2:Int, arg_3:Int, arg_4:cpp.Float32):Void;
public static function ExecuteIfBound(self:unreal.VariantPtr, arg_0:unreal.VariantPtr, arg_1:Int, arg_2:Int, arg_3:Int, arg_4:cpp.Float32):Void;
