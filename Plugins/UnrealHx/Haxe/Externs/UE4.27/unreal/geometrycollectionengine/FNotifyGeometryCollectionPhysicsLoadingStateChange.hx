...
typedef FNotifyGeometryCollectionPhysicsLoadingStateChange = unreal.DynamicMulticastDelegate<FNotifyGeometryCollectionPhysicsLoadingStateChange, unreal.geometrycollectionengine.UGeometryCollectionComponent->Void>;