...
@:uextern @:uclass extern class UBlueprintPlatformLibrary extends unreal.UBlueprintFunctionLibrary {
  ...
  **/
  ...
  /**
    ...
    @param ActivationEvent A string that is passed in the delegate callback when the app is brought into the foreground from the user activating the notification
  **/
  @:ufunction(BlueprintCallable) static public function ScheduleLocalNotificationFromNow(inSecondsFromNow : unreal.Int32, Title : unreal.Const<unreal.PRef<unreal.FText>>, Body : unreal.Const<unreal.PRef<unreal.FText>>, Action : unreal.Const<unreal.PRef<unreal.FText>>, ActivationEvent : unreal.FString) : unreal.Int32;
  ...
  /**
    ...
    @param ActivationEvent A string that is passed in the delegate callback when the app is brought into the foreground from the user activating the notification
  **/
  @:ufunction(BlueprintCallable) static public function ScheduleLocalNotificationBadgeAtTime(FireDateTime : unreal.Const<unreal.PRef<unreal.FDateTime>>, LocalTime : Bool, ActivationEvent : unreal.FString) : unreal.Int32;
  ...
  **/
  @:ufunction(BlueprintCallable) static public function CancelLocalNotificationById(NotificationId : unreal.Int32) : Void;
