...
@:uextern @:uclass extern class UProjectileMovementComponent extends unreal.UMovementComponent {
  ...
  **/
  @:uproperty public var bRotationRemainsVertical : Bool;
  ...
  **/
  @:ufunction(BlueprintCallable) @:thisConst @:final public function LimitVelocity(NewVelocity : unreal.FVector) : unreal.FVector;
