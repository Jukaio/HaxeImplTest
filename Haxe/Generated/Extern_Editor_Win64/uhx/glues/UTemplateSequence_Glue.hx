...
package uhx.glues;
@:unrealGlue extern class UTemplateSequence_Glue {
public static function get_BoundActorComponents(self:unreal.UIntPtr):unreal.VariantPtr;
public static function set_BoundActorComponents(self:unreal.UIntPtr, value:unreal.VariantPtr):Void;
