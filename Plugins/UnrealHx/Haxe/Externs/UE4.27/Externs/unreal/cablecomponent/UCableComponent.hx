...
@:uextern @:uclass extern class UCableComponent extends unreal.UMeshComponent {
  ...
  **/
  ...
  @:uproperty public var bSkipCableUpdateWhenNotOwnerRecentlyRendered : Bool;
  @:uproperty public var bSkipCableUpdateWhenNotVisible : Bool;
  ...
  **/
  @:uproperty public var bUseSubstepping : Bool;
