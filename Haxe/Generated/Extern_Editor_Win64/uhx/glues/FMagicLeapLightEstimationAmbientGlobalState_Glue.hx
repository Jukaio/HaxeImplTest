...
package uhx.glues;
@:unrealGlue extern class FMagicLeapLightEstimationAmbientGlobalState_Glue {
...
public static function get_AmbientIntensityNits(self:unreal.VariantPtr):unreal.VariantPtr;
public static function set_AmbientIntensityNits(self:unreal.VariantPtr, value:unreal.VariantPtr):Void;
