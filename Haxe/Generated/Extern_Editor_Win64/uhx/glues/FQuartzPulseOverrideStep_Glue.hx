...
package uhx.glues;
@:unrealGlue extern class FQuartzPulseOverrideStep_Glue {
public static function get_PulseDuration(self:unreal.VariantPtr):Int;
public static function set_PulseDuration(self:unreal.VariantPtr, value:Int):Void;
public static function get_NumberOfPulses(self:unreal.VariantPtr):Int;
public static function set_NumberOfPulses(self:unreal.VariantPtr, value:Int):Void;
