...
package uhx.glues;
@:unrealGlue extern class FAudioQualitySettings_Glue {
public static function get_MaxChannels(self:unreal.VariantPtr):Int;
public static function set_MaxChannels(self:unreal.VariantPtr, value:Int):Void;
