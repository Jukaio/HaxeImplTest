...
@:uextern @:ustruct extern class FSoundAttenuationSettings extends unreal.FBaseAttenuationSettings {
  ...
  **/
  @:uproperty public var CustomPriorityAttenuationCurve : unreal.FRuntimeFloatCurve;
  
  /**
    Static priority scalar to use (doesn't change as a function of distance).
  **/
  @:uproperty public var ManualPriorityAttenuation : unreal.Float32;
  
  /**
    The max distance to attenuate priority.
  **/
  @:uproperty public var PriorityAttenuationDistanceMax : unreal.Float32;
  
  /**
    The min distance to attenuate priority.
  **/
  @:uproperty public var PriorityAttenuationDistanceMin : unreal.Float32;
  ...
  **/
  @:uproperty public var PriorityAttenuationMax : unreal.Float32;
  ...
  **/
  @:uproperty public var PriorityAttenuationMin : unreal.Float32;
  
  /**
    Set of submix send settings to use to send audio to submixes as a function of distance.
  **/
  @:uproperty public var SubmixSendSettings : unreal.TArray<unreal.FAttenuationSubmixSendSettings>;
  ...
  **/
  ...
  @:deprecated @:uproperty public var ReverbPluginSettings_DEPRECATED : unreal.audioextensions.UReverbPluginSourceSettingsBase;
  @:deprecated @:uproperty public var OcclusionPluginSettings_DEPRECATED : unreal.audioextensions.UOcclusionPluginSourceSettingsBase;
  ...
  **/
  ...
  @:deprecated @:uproperty public var SpatializationPluginSettings_DEPRECATED : unreal.audioextensions.USpatializationPluginSourceSettingsBase;
  #end // WITH_EDITORONLY_DATA
  ...
  **/
  @:uproperty public var PriorityAttenuationMethod : unreal.EPriorityAttenuationMethod;
  ...
  **/
  @:uproperty public var BinauralRadius : unreal.Float32;
  ...
  **/
  @:uproperty public var bEnablePriorityAttenuation : Bool;
