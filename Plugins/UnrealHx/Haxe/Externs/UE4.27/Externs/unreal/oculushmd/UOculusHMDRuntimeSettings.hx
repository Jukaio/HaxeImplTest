...
@:uextern @:uclass extern class UOculusHMDRuntimeSettings extends unreal.UObject {
  ...
  **/
  @:uproperty public var bLateLatching : Bool;
  ...
  **/
  @:uproperty public var bFocusAware : Bool;
  ...
  **/
  @:uproperty public var FFRDynamic : Bool;
  
  /**
    Default Fixed Foveated Rendering level for Oculus Quest
  **/
  @:uproperty public var FFRLevel : unreal.oculushmd.EFixedFoveatedRenderingLevel;
  ...
  **/
  @:uproperty public var ColorSpace : unreal.oculushmd.EColorSpace;
  
  /**
    If enabled, the target HMD will perform a color space transformation
  **/
  @:uproperty public var bEnableSpecificColorGamut : Bool;
