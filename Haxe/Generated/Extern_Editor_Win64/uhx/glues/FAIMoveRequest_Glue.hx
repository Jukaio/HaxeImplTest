...
package uhx.glues;
@:unrealGlue extern class FAIMoveRequest_Glue {
public static function get_GoalActor(self:unreal.VariantPtr):unreal.UIntPtr;
public static function set_GoalActor(self:unreal.VariantPtr, value:unreal.UIntPtr):Void;
