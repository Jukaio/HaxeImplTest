...
package uhx.glues;
@:unrealGlue extern class URadialVector_Glue {
...
public static function SetRadialVector(self:unreal.UIntPtr, Magnitude:cpp.Float32, Position:unreal.VariantPtr):unreal.UIntPtr;
