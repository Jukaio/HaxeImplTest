...
@:uextern @:uclass extern class UTexture extends unreal.UStreamableRenderAsset implements unreal.IInterface_AssetUserData {
  ...
  **/
  @:uproperty public var bNotOfflineProcessed : Bool;
  ...
  **/
  @:uproperty public var VirtualTextureStreaming : Bool;
  ...
  **/
  @:uproperty public var DownscaleOptions : unreal.ETextureDownscaleOptions;
  ...
  /**
    ...
    > 1.0 - scale texure
  **/
  @:uproperty public var Downscale : unreal.FPerPlatformFloat;
  ...
  **/
  @:uproperty public var MipLoadOptions : unreal.ETextureMipLoadOptions;
  ...
  **/
  @:uproperty public var LayerFormatSettings : unreal.TArray<unreal.FTextureFormatSettings>;
  ...
  **/
  @:uproperty public var LossyCompressionAmount : unreal.ETextureLossyCompressionAmount;
