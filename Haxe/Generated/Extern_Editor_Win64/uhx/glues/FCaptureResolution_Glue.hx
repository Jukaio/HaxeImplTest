...
package uhx.glues;
@:unrealGlue extern class FCaptureResolution_Glue {
public static function get_ResY(self:unreal.VariantPtr):Int;
public static function set_ResY(self:unreal.VariantPtr, value:Int):Void;
public static function get_ResX(self:unreal.VariantPtr):Int;
public static function set_ResX(self:unreal.VariantPtr, value:Int):Void;
