...
@:noCopy @:noEquals @:uextern @:ustruct extern class FKeyPosition {
  
  /**
    The key's output (t-axis) position (i.e. it's value)
  **/
  @:uproperty public var OutputValue : unreal.Float64;
  
  /**
    The key's input (x-axis) position (i.e. it's time)
  **/
  @:uproperty public var InputValue : unreal.Float64;
