...
package uhx.glues;
@:unrealGlue extern class FOnCanvasRenderTargetUpdate_Glue {
public static function create():unreal.VariantPtr;
public static function createNew():unreal.VariantPtr;
public static function Broadcast(self:unreal.VariantPtr, arg_0:unreal.UIntPtr, arg_1:Int, arg_2:Int):Void;
