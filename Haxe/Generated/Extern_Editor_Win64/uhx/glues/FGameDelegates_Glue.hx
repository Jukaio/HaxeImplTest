...
package uhx.glues;
@:unrealGlue extern class FGameDelegates_Glue {
public static function Get():unreal.VariantPtr;
public static function GetExitCommandDelegate(self:unreal.VariantPtr):unreal.VariantPtr;
public static function GetEndPlayMapDelegate(self:unreal.VariantPtr):unreal.VariantPtr;
