...
package uhx.glues;
@:unrealGlue extern class FOnLoginStatusChanged_Glue {
...
public static function Broadcast(self:unreal.VariantPtr, arg_0:Int, arg_1:Int, arg_2:Int, arg_3:unreal.VariantPtr):Void;
