...
public:
  ...
  void touchClass(UClass *inClass, const FString &inHeader, const FString &inModule) {
    ...
    TFieldIterator<FProperty> props(inClass, EFieldIteratorFlags::ExcludeSuper);
    for (; props; ++props) {
  ...
  void touchStruct(UScriptStruct *inStruct, ClassDescriptor *inClass) {
    ...
    TFieldIterator<FProperty> props(inStruct, EFieldIteratorFlags::ExcludeSuper);
    for (; props; ++props) {
      FProperty *prop = *props;
  ...
  void touchDelegate(UFunction *inDelegate, ClassDescriptor *inClass) {
    ...
    TFieldIterator<FProperty> props(inDelegate, EFieldIteratorFlags::ExcludeSuper);
    for (; props; ++props) {
      FProperty *prop = *props;
      touchProperty(prop, inClass, false);
    }
