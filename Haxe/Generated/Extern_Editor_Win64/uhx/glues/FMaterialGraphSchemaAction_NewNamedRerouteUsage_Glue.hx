...
package uhx.glues;
@:unrealGlue extern class FMaterialGraphSchemaAction_NewNamedRerouteUsage_Glue {
public static function get_Declaration(self:unreal.VariantPtr):unreal.UIntPtr;
public static function set_Declaration(self:unreal.VariantPtr, value:unreal.UIntPtr):Void;
