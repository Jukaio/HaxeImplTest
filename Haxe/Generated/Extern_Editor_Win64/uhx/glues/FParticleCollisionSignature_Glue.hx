...
package uhx.glues;
@:unrealGlue extern class FParticleCollisionSignature_Glue {
public static function create():unreal.VariantPtr;
public static function createNew():unreal.VariantPtr;
public static function Broadcast(self:unreal.VariantPtr, arg_0:unreal.VariantPtr, arg_1:cpp.Float32, arg_2:Int, arg_3:unreal.VariantPtr, arg_4:unreal.VariantPtr, arg_5:unreal.VariantPtr, arg_6:unreal.VariantPtr, arg_7:unreal.VariantPtr, arg_8:unreal.UIntPtr):Void;
