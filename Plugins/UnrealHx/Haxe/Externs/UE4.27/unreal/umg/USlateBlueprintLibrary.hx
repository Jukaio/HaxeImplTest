...
@:uextern @:uclass extern class USlateBlueprintLibrary extends unreal.UBlueprintFunctionLibrary {
  ...
  **/
  @:ufunction(BlueprintCallable) static public function GetLocalTopLeft(Geometry : unreal.Const<unreal.PRef<unreal.slatecore.FGeometry>>) : unreal.FVector2D;
  ...
  **/
  @:ufunction static public function ScreenToWidgetLocal(WorldContextObject : unreal.UObject, Geometry : unreal.Const<unreal.PRef<unreal.slatecore.FGeometry>>, ScreenPosition : unreal.FVector2D, LocalCoordinate : unreal.PRef<unreal.FVector2D>, bIncludeWindowPosition : Bool) : Void;
  
  /**
    Translates a screen position in pixels into absolute application coordinates.
    If bIncludeWindowPosition is true, then this method will also remove the game window's position (useful when in windowed mode).
  **/
  @:ufunction static public function ScreenToWidgetAbsolute(WorldContextObject : unreal.UObject, ScreenPosition : unreal.FVector2D, AbsoluteCoordinate : unreal.PRef<unreal.FVector2D>, bIncludeWindowPosition : Bool) : Void;
