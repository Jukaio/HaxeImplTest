...
package uhx.glues;
@:unrealGlue extern class FInputModeGameOnly_Glue {
public static function create():unreal.VariantPtr;
public static function SetConsumeCaptureMouseDown(self:unreal.VariantPtr, InConsumeCaptureMouseDown:Bool):unreal.VariantPtr;
}