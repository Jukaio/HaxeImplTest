...
package uhx.glues;
@:unrealGlue extern class FNiagaraCurveTemplate_Glue {
public static function get_CurveAsset(self:unreal.VariantPtr):unreal.VariantPtr;
public static function set_CurveAsset(self:unreal.VariantPtr, value:unreal.VariantPtr):Void;
public static function get_DisplayNameOverride(self:unreal.VariantPtr):unreal.VariantPtr;
public static function set_DisplayNameOverride(self:unreal.VariantPtr, value:unreal.VariantPtr):Void;
