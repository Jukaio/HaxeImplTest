...
@:uextern @:uclass extern class USkyLightComponent extends unreal.ULightComponentBase {
  ...
  **/
  @:uproperty public var CloudAmbientOcclusionApertureScale : unreal.Float32;
  ...
  **/
  @:uproperty public var CloudAmbientOcclusionMapResolutionScale : unreal.Float32;
  
  /**
    The world space radius of the cloud ambient occlusion map around the camera in kilometers.
  **/
  @:uproperty public var CloudAmbientOcclusionExtent : unreal.Float32;
  
  /**
    The strength of the ambient occlusion, higher value will block more light.
  **/
  @:uproperty public var CloudAmbientOcclusionStrength : unreal.Float32;
  ...
  **/
  @:uproperty public var bCloudAmbientOcclusion : Bool;
  ...
  **/
  @:uproperty public var bRealTimeCapture : Bool;
