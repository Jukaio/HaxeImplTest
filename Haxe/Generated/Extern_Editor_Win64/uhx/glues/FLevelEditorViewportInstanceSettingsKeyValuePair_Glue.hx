...
package uhx.glues;
@:unrealGlue extern class FLevelEditorViewportInstanceSettingsKeyValuePair_Glue {
public static function get_ConfigSettings(self:unreal.VariantPtr):unreal.VariantPtr;
public static function set_ConfigSettings(self:unreal.VariantPtr, value:unreal.VariantPtr):Void;
