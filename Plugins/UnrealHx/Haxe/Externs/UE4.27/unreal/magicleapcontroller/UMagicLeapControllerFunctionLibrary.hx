...
@:uextern @:uclass extern class UMagicLeapControllerFunctionLibrary extends unreal.UBlueprintFunctionLibrary {
  ...
  **/
  @:ufunction(BlueprintCallable) static public function PlayLEDPattern(MotionSource : unreal.FName, LEDPattern : unreal.magicleapcontroller.EMagicLeapControllerLEDPattern, LEDColor : unreal.magicleapcontroller.EMagicLeapControllerLEDColor, DurationInSec : unreal.Float32) : Bool;
  ...
  **/
  @:ufunction(BlueprintCallable) static public function PlayLEDEffect(MotionSource : unreal.FName, LEDEffect : unreal.magicleapcontroller.EMagicLeapControllerLEDEffect, LEDSpeed : unreal.magicleapcontroller.EMagicLeapControllerLEDSpeed, LEDPattern : unreal.magicleapcontroller.EMagicLeapControllerLEDPattern, LEDColor : unreal.magicleapcontroller.EMagicLeapControllerLEDColor, DurationInSec : unreal.Float32) : Bool;
  ...
  **/
  @:ufunction(BlueprintCallable) static public function PlayHapticPattern(MotionSource : unreal.FName, HapticPattern : unreal.magicleapcontroller.EMagicLeapControllerHapticPattern, Intensity : unreal.magicleapcontroller.EMagicLeapControllerHapticIntensity) : Bool;
  ...
  **/
  @:ufunction(BlueprintCallable) static public function SetControllerTrackingMode(TrackingMode : unreal.magicleapcontroller.EMagicLeapControllerTrackingMode) : Bool;
  
  /**
    Get controller tracking mode.
    @return Controller tracking mode.
  **/
  @:ufunction(BlueprintCallable) static public function GetControllerTrackingMode() : unreal.magicleapcontroller.EMagicLeapControllerTrackingMode;
  ...
  **/
  @:ufunction(BlueprintCallable) static public function GetControllerType(MotionSource : unreal.FName) : unreal.magicleapcontroller.EMagicLeapControllerType;
  ...
  **/
  @:ufunction(BlueprintCallable) static public function IsMLControllerConnected(MotionSource : unreal.FName) : Bool;
  ...
  **/
  ...
  /**
    ...
    @return Type of ML device which maps to given Unreal controller hand.
  **/
  @:ufunction(BlueprintCallable) static public function GetMLControllerType(Hand : unreal.inputcore.EControllerHand) : unreal.magicleapcontroller.EMagicLeapControllerType;
  ...
  **/
  ...
  /**
    ...
    @return True if the command to play the LED pattern was successfully sent to the controller, false otherwise.
  **/
  @:ufunction(BlueprintCallable) static public function PlayControllerLED(Hand : unreal.inputcore.EControllerHand, LEDPattern : unreal.magicleapcontroller.EMagicLeapControllerLEDPattern, LEDColor : unreal.magicleapcontroller.EMagicLeapControllerLEDColor, DurationInSec : unreal.Float32) : Bool;
  ...
  **/
  ...
  /**
    ...
    @return True if the command to play the haptic feedback was successfully sent to the controller, false otherwise.
  **/
  @:ufunction(BlueprintCallable) static public function PlayControllerHapticFeedback(Hand : unreal.inputcore.EControllerHand, HapticPattern : unreal.magicleapcontroller.EMagicLeapControllerHapticPattern, Intensity : unreal.magicleapcontroller.EMagicLeapControllerHapticIntensity) : Bool;
