...
package uhx.glues;
@:unrealGlue extern class FMagicLeapARPinObjectIdList_Glue {
public static function get_ObjectIdList(self:unreal.VariantPtr):unreal.VariantPtr;
public static function set_ObjectIdList(self:unreal.VariantPtr, value:unreal.VariantPtr):Void;
