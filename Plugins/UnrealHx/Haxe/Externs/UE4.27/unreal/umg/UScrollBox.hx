...
@:uextern @:uclass extern class UScrollBox extends unreal.umg.UPanelWidget {
  ...
  **/
  @:uproperty public var WheelScrollMultiplier : unreal.Float32;
  ...
  **/
  @:uproperty public var ScrollWhenFocusChanges : unreal.slate.EScrollWhenFocusChanges;
  ...
  **/
  @:uproperty public var bAnimateWheelScrolling : Bool;
  ...
  **/
  @:uproperty public var ScrollbarPadding : unreal.slatecore.FMargin;
  ...
  **/
  ...
  @:ufunction(BlueprintCallable) @:final public function SetScrollbarPadding(NewScrollbarPadding : unreal.Const<unreal.PRef<unreal.slatecore.FMargin>>) : Void;
  ...
  @:ufunction(BlueprintCallable) @:final public function SetAnimateWheelScrolling(bShouldAnimateWheelScrolling : Bool) : Void;
  @:ufunction(BlueprintCallable) @:final public function SetWheelScrollMultiplier(NewWheelScrollMultiplier : unreal.Float32) : Void;
  @:ufunction(BlueprintCallable) @:final public function SetScrollWhenFocusChanges(NewScrollWhenFocusChanges : unreal.slate.EScrollWhenFocusChanges) : Void;
  
  /**
    Instantly stops any inertial scrolling that is currently in progress
  **/
  @:ufunction(BlueprintCallable) @:final public function EndInertialScrolling() : Void;
  ...
  **/
  @:ufunction(BlueprintCallable) @:thisConst @:final public function GetScrollOffsetOfEnd() : unreal.Float32;
  ...
  **/
  @:ufunction(BlueprintCallable) @:final public function ScrollWidgetIntoView(WidgetToFind : unreal.umg.UWidget, AnimateScroll : Bool = true, @:opt("IntoView") ScrollDestination : unreal.slate.EDescendantScrollDestination, Padding : unreal.Float32 = 0.000000) : Void;
