...
package uhx.glues;
@:unrealGlue extern class FComponentBeginOverlapSignature_Glue {
public static function create():unreal.VariantPtr;
public static function createNew():unreal.VariantPtr;
public static function Broadcast(self:unreal.VariantPtr, arg_0:unreal.UIntPtr, arg_1:unreal.UIntPtr, arg_2:unreal.UIntPtr, arg_3:Int, arg_4:Bool, arg_5:unreal.VariantPtr):Void;
