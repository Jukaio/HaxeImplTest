...
package uhx.glues;
@:unrealGlue extern class FNiagaraMeshRendererMeshProperties_Glue {
public static function get_PivotOffsetSpace(self:unreal.VariantPtr):Int;
public static function set_PivotOffsetSpace(self:unreal.VariantPtr, value:Int):Void;
