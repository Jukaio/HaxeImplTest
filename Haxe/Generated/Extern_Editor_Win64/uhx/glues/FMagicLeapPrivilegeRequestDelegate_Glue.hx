...
package uhx.glues;
@:unrealGlue extern class FMagicLeapPrivilegeRequestDelegate_Glue {
public static function create():unreal.VariantPtr;
public static function createNew():unreal.VariantPtr;
public static function Execute(self:unreal.VariantPtr, arg_0:Int, arg_1:Bool):Void;
public static function ExecuteIfBound(self:unreal.VariantPtr, arg_0:Int, arg_1:Bool):Void;
