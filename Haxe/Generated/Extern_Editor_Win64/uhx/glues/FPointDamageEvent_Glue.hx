...
package uhx.glues;
@:unrealGlue extern class FPointDamageEvent_Glue {
...
public static function get_HitInfo(self:unreal.VariantPtr):unreal.VariantPtr;
public static function set_HitInfo(self:unreal.VariantPtr, value:unreal.VariantPtr):Void;
public static function get_ShotDirection(self:unreal.VariantPtr):unreal.VariantPtr;
public static function set_ShotDirection(self:unreal.VariantPtr, value:unreal.VariantPtr):Void;
public static function get_Damage(self:unreal.VariantPtr):cpp.Float32;
public static function set_Damage(self:unreal.VariantPtr, value:cpp.Float32):Void;
